...
<div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="taxrates-section">
            <a href="<c:url value="/admin/tax/taxrates/list.html"/>"><s:message
                    code="label.generic.back" text="Back"/></a><br/><br/>
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="taxRate" action="${saveTaxRate}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.storezone"
                                          text="Store state / province"/></label>
                        <div class="controls">
                            <form:select cssClass="zone-list " path="zone.id"/>
                            <input type="text" class="input-large" value="${taxRate.stateProvince}"
                                   id="stateProvince" name="stateProvince"/>
                            <span class="help-inline"><form:errors path="zone.code"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>

                    <c:forEach items="${taxRate.descriptions}" var="description"
                               varStatus="counter">

                        <div class="control-group">

                            <label class="required"><s:message code="menu.taxrates.name"
                                                               text="Tax name"/> (<c:out
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="menu.taxrates.code"
                                                           text="Code"/></label>
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="menu.taxrates.rate"
                                                           text="Rate"/></label>

                        <div class="controls">
                            <form:input id="rateText" cssClass="highlight" path="rateText"/>
                            <span id="help-rateText" class="help-inline"><form:errors
                                    path="rateText" cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="piggyback"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="taxPriority"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="required"><s:message code="label.tax.taxclass.name"
                                                           text="Tax class name"/></label>
                        <div class="controls">
                            <form:select path="taxClass.id" cssClass="highlight">
                                <form:options items="${taxClasses}" itemValue="id"
                                              itemLabel="code"/>
                            </form:select>
                        </div>
                    </div>
