...
{title:"<s:message code="label.generic.country.code"
                   text="Country dode"/>", name:"country", canFilter:false},
{title:"<s:message code="label.generic.stateprovince"
                   text="State / province"/>", name:"zone", canFilter:true},
...
{title:"<s:message code="label.tax.compound"
                   text="Compound"/>", name:"piggyback", type:"boolean", canFilter:false},
