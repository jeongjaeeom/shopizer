            ...
            <div class="sm-ui-component">
                <h3>
                    <c:choose>
                        <c:when test="${category.category.id!=null && category.category.id>0}">
                            ...
                            <c:out value="${category.category.code}"/>
                        </c:when>
                        <c:otherwise>
                ...
                <form:form method="POST" modelAttribute="category" action="${categorySave}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.category.parentcategory"
                        ...
                        <div class="controls">
                            <div class="controls">
                                ...
                                <form:select path="category.parent.id">
                                    ...
                                    <form:options items="${categories}" itemValue="category.id"
                                                  itemLabel="descriptions[0].name"/>
                                </form:select>
                                <span class="help-inline"><form:errors path="category.parent.id"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.entity.featured"
                                          text="Featured category"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input cssClass="input-large highlight" id="code"
                                        path="category.code" onblur="validateCode(this)"/>
                            <span class="help-inline"><div id="checkCodeStatus"
                                                           style="display:none;"></div><form:errors
                                    path="category.code" cssClass="error"/></span>
                        </div>
                    </div>
                    <c:forEach items="${category.descriptions}" var="description"
                               varStatus="counter">
                        <div class="control-group">
                            <label><s:message code="label.productedit.categoryname"
                                              text="Category name"/> (<c:out
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.highlight"
                                              text="Category highlight"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="input-large"
                                            id="categoryHighlight${counter.index}"
                                            path="descriptions[${counter.index}].categoryHighlight"/>
                                <span class="help-inline"><form:errors
                                        path="descriptions[${counter.index}].categoryHighlight"
                                        cssClass="error"/></span>
                            </div>
                        ...
                        <div class="control-group">
                            <label><s:message code="label.sefurl" text="SEF Url"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="highlight" id="seUrl${counter.index}"
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.categorydescription"
                                              text="Category description"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.title" text="Metatag title"/>
                        ...
                        <div class="control-group">
                            <label><s:message code="label.metatags.keywords"
                                              text="Metatag keywords"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label><s:message code="label.metatags.description"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="category.sortOrder"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="pull-right">
                            <button type="submit" class="btn btn-success"><s:message
                                    code="button.label.submit" text="Submit"/></button>
                        </div>
                    </div>
                </form:form>
            </div>
