...
<form action="<c:url value="/admin/shipping/addCustomRegion.html"/>" method="POST"
      class="form-inline">
    <form:errors path="*" cssClass="alert alert-error" element="div"/>
    1- <label class="required"><s:message code="label.shipping.addregion"
                                          text="Add region"/></label>
...
<form:form method="POST" modelAttribute="customRegion" action="${addShipping}"
    ...
    <form:select path="customRegionName">
        <form:options items="${customConfiguration.regions}" itemValue="customRegionName"
                      itemLabel="customRegionName"/>
    </form:select>
...
<form:form method="GET" modelAttribute="customRegion" action="${addPrice}" cssClass="form-inline">
    ...
    <button type="submit" class="btn btn-success"><s:message code="label.entity.details"
                                                             text="Details"/></button>
