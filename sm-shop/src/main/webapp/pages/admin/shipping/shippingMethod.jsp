    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="shipping-method">
            ...
            <div class="sm-ui-component">
                <h3><s:message code="label.shipping.title" text="Shipping configuration"/> -
                    <s:message code="module.shipping.${configuration.moduleCode}"
                ...
                <c:if test="${customConfiguration!=null}">
                    <c:url var="saveShippingMethod"
                           value="/admin/shipping/save${configuration.moduleCode}ShippingMethod.html"/>
                ...
                <form:form method="POST" modelAttribute="configuration"
                    ...
                    <c:if test="${customConfiguration==null}">
                        <jsp:include
                                page="/pages/admin/shipping/${configuration.moduleCode}.jsp"></jsp:include>
                    </c:if>
