    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="shipping-section">
            ...
            <div class="sm-ui-component">
                <a href="<c:url value="/admin/shipping/weightBased.html"/>"><s:message
                        code="label.generic.back" text="Back"/></a><br/><br/>
                <h3><s:message code="module.shipping.weightBased"
                               text="module.shipping.weightBased"/> - <c:out
                ...
                <form:form method="POST" modelAttribute="customQuote" action="${addPrice}">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.shipping.maximumWeight"
                                          text="Maximum weight"/></label>
                        <div class="controls">
                            <input type="text" class="span3" name="maximumWeight" id="maximumWeight"
                                   value="0">
                        </div>
                        <span class="help-inline"><form:errors path="maximumWeight"
                                                               cssClass="error"/></span>
                    </div>
                ...
                <c:set var="gridHeader"
                       value="/pages/admin/shipping/weightBasedDetails-gridHeader.jsp"
                       scope="request"/>
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="region"
                           action="${removeRegion}">
                    <input type="hidden" name="customRegionName"
                           value="${customRegion.customRegionName}"/>
                    <div class="form-actions">
                        <div class="pull-right">
