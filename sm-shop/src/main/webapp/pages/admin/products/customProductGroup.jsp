    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="group" action="${saveProductGrop}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span id="help-price" class="help-inline"><form:errors path="code"
                                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                ...
                <c:set value="/admin/products/groups/list.html" var="afterRemoveUrl"
                       scope="request"/>
                <c:set var="entityId" value="code" scope="request"/>
                <c:set var="componentTitleKey" value="menu.catalogue-products-custom-group"
                       scope="request"/>
                <c:set var="gridHeader"
                       value="/pages/admin/products/customProductGroup-gridHeader.jsp"
                       scope="request"/>
