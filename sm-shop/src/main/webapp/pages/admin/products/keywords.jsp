        ...
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data"
                           modelAttribute="productKeyword" action="${addKeyword}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select path="languageCode">
                                <form:options items="${store.languages}" itemValue="code"
                                              itemLabel="code"/>
                            </form:select>
                            <span class="help-inline"><form:errors path="languageCode"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="keyword"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="pull-right">
                            <button type="submit" class="btn btn-success"><s:message
                                    code="label.generic.add" text="Add"/></button>
                        </div>
                    </div>
                ...
                <c:set value="/admin/products/product/keywords/paging.html?id=${product.id}"
                       var="pagingUrl" scope="request"/>
                <c:set value="/admin/products/product/removeKeyword.html?id=${product.id}"
                       var="removeUrl" scope="request"/>
                <c:set value="/admin/products/product/keywords.html?id=${product.id}"
                       var="afterRemoveUrl" scope="request"/>
                <c:set var="entityId" value="code" scope="request"/>
                <c:set var="componentTitleKey" value="label.product.searchkeywords"
                       scope="request"/>
                <c:set var="groupByEntity" value="language" scope="request"/>
                <c:set var="gridHeader" value="/pages/admin/products/keywords-gridHeader.jsp"
                       scope="request"/>
