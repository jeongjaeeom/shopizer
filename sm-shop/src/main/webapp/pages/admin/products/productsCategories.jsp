    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <h3>
                    <s:message code="label.product.category.association"
                               text="Associate to categories"/>
                </h3>
                ...
                <c:set value="/admin/product-categories/paging.html?productId=${product.id}"
                       var="pagingUrl" scope="request"/>
                <c:set value="/admin/product-categories/remove.html?productId=${product.id}"
                       var="removeUrl" scope="request"/>
                <c:set value="/admin/products/displayProductToCategories.html?id=${product.id}"
                ...
                <c:set var="gridHeader"
                       value="/pages/admin/products/product-categories-gridHeader.jsp"
                       scope="request"/>
