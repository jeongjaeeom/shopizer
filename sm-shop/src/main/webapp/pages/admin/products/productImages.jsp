        ...
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data"
                           modelAttribute="contentImages" action="${saveProductImages}">
                    ...
                    <div class="form-actions">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-success"><s:message
                                    code="button.label.upload" text="Upload Images"/></button>
                ...
                <c:set value="/admin/products/images/page.html?productId=${product.id}"
                       var="pagingUrl" scope="request"/>
                <c:set value="/admin/products/images/remove.html" var="removeUrl" scope="request"/>
                <c:set value="/admin/products/images/list.html?id=${product.id}" var="refreshUrl"
                       scope="request"/>
                <c:set var="componentTitleKey" value="menu.catalogue-products-images"
                       scope="request"/>
                <c:set value="/admin/products/images/defaultImage.html" var="defaultImageUrl"
                       scope="request"/>
