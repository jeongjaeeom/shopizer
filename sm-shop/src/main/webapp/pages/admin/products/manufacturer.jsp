    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <form:form method="POST" modelAttribute="manufacturer" action="${manufacturerSave}">
                ...
                <c:forEach items="${manufacturer.descriptions}" var="description"
                           varStatus="counter">

                    <div class="control-group">
                        <label class="required"><s:message
                                code="label.manufactureredit.manufacturername"
                    ...
                    <div class="control-group">
                        <label><s:message code="label.manufactureredit.manufacturertitle"
                                          text="Manufacturer Title"/> (<c:out
                                value="${description.language.code}"/>)</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.manufactureredit.manufacturerurl" text="URL"/>
                    ...
                    <div class="control-group">
                        <label class="required"><s:message
                                code="label.manufactureredit.manufacturerdescription"
              ...
              --%>
                <div class="control-group">
                    <label><s:message code="label.manufactureredit.manufacturerorder"
                                      text="Order"/></label>
                    <div class="controls">
