            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="attribute" action="${attributeSave}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="controls">
                                <form:select cssClass="highlight" id="productOption"
                                             path="productOption.id">
                                    <form:options items="${options}" itemValue="id"
                                                  itemLabel="descriptionsSettoList[0].name"/>
                                </form:select>
                                <span class="help-inline"><form:errors path="productOption.id"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.product.attribute.display"
                                          text="Display only"/></label>
                        <div class="controls">
                            <form:checkbox id="displayOnly" path="attributeDisplayOnly"/>
                            <span class="help-inline"><form:errors path="attributeDisplayOnly"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <c:when test="${attribute.productOption.productOptionType=='text'}">none;</c:when>
                        ...
                        <div class="controls">
                            <div class="controls">
                                ...
                                <span class="help-inline"><form:errors path="productOptionValue.id"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <c:when test="${attribute.productOption.productOptionType=='text'}">block;</c:when>
                        ...
                        <c:forEach items="${attribute.productOptionValue.descriptionsSettoList}"
                                   var="description" varStatus="counter">
                            ...
                            <form:hidden
                                    path="productOptionValue.descriptionsList[${counter.index}].language.code"/>
                            <form:hidden
                                    path="productOptionValue.descriptionsList[${counter.index}].language.id"/>
                            <form:hidden
                                    path="productOptionValue.descriptionsList[${counter.index}].id"/>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.product.productoptions.price"
                                          text="Price"/></label>
                        <div class="controls">
                            <form:input id="productPriceAmount" cssClass="highlight"
                                        path="attributePrice"/>
                            <span id="help-price" class="help-inline"><form:errors
                                    path="attributePrice" cssClass="error"/></span>
                        </div>
                    </div>


                    <div class="control-group">
                        <label class="required"><s:message code="label.entity.order"
                                                           text="Order"/></label>
                        <div class="controls">
                            <form:input id="order" cssClass="highlight" path="attributeSortOrder"/>
                            <span class="help-inline"><form:errors path="attributeSortOrder"
                                                                   cssClass="error"/></span>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.product.attribute.default"
                                          text="Default"/></label>
                        <div class="controls">
                            <form:checkbox path="attributeDefault"/>
                            <span class="help-inline"><form:errors path="attributeDefault"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>

                    <div class="control-group">
                        <label><s:message code="label.product.attribute.required"
                                          text="Required"/></label>
                        <div class="controls">
                            <form:checkbox path="attributeRequired"/>
                            <span class="help-inline"><form:errors path="attributeRequired"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="required"><s:message
                                code="label.product.attribute.otherweight"
                                text="Additional weight"/></label>
                        <div class="controls">
                            <form:input id="weight" cssClass="highlight"
                                        path="attributeAdditionalWeight"/>
