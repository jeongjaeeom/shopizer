    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <br/>
                <a href="<c:url value="/admin/products/price/create.html?productId=${product.id}&availabilityId=${availability.id}"/>"><s:message
                        code="label.product.price.create" text="Create price"/></a>
                <br/><br/>

                <!-- Listing grid include -->

                <c:set value="/admin/products/prices/paging.html?productId=${product.id}"
                       var="pagingUrl" scope="request"/>
                <c:set value="/admin/products/price/remove.html?productId=${product.id}"
                       var="removeUrl" scope="request"/>
                <c:set value="/admin/products/price/edit.html" var="editUrl" scope="request"/>
                <c:set value="/admin/products/prices.html?id=${product.id}" var="afterRemoveUrl"
                       scope="request"/>
                ...
                <c:set var="gridHeader" value="/pages/admin/products/prices-gridHeader.jsp"
                       scope="request"/>
