...
<div class="control-group">
    <label class="required"><s:message code="module.payment.paypal.clientId"
                                       text="Paypal client id"/></label>
    <div class="controls">
    ...
    <span class="help-inline">
	                        	<c:if test="${client!=null}">
                                    <span id="identifiererrors" class="error"><s:message
                                            code="module.payment.paypal.message.clientId"
...
<div class="control-group">
    <label class="required"><s:message code="module.payment.paypal.secret"
                                       text="PayPal Secret"/></label>
    <div class="controls">
    ...
    <span class="help-inline">
	                        	<c:if test="${secret!=null}">
                                    <span id="apikeyerrors" class="error"><s:message
                                            code="module.payment.paypal.message.secret"
                                            text="Field in error"/></span>
                                </c:if>
	                        </span>
</div>
