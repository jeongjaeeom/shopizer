...
<div class="control-group">
    <label class="required"><s:message code="module.payment.stripe.secretKey"
                                       text="Secret key"/></label>
    <div class="controls">
...
<div class="control-group">
    <label class="required"><s:message code="module.payment.stripe.publishableKey"
                                       text="Publishable key"/></label>
    <div class="controls">
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <form:radiobutton cssClass="input-large highlight" path="integrationKeys['transaction']"
            ...
            code="module.payment.transactiontype.sale"
            text="Sale"/></br>
    </div>
</div>
