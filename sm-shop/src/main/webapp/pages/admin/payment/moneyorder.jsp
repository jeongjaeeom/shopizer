...
<div class="control-group">
    <label class="required"><strong><s:message code="module.payment.moneyorder.adress"
                                               text="Cheque must be made to this address"/></strong></label>
    <div class="controls">
	                        <span class="help-inline">
	                        	<c:if test="${address!=null}">
                                    <span id="identifiererrors" class="error"><s:message
                                            code="module.payment.moneyorder.message.address"
