                                        ...
                                        <label>
                                            <c:choose>
                                                <c:when test="${module.customModule==true}">
                                                    <a href="<c:url value="/admin/payments/${module.code}.html"/>"><s:message
                                                            code="module.payment.${module.code}"
                                                            text="No label found - ${module.code}"/></a>
                                                </c:when>
                                                <c:otherwise>
                                                    <a href="<c:url value="/admin/payments/paymentMethod.html?code="/><c:out value="${module.code}"/>"><s:message
                                                            code="module.payment.${module.code}"
                                                            text="No label found - ${module.code}"/></a>
                                                </c:otherwise>
                                            </c:choose>
