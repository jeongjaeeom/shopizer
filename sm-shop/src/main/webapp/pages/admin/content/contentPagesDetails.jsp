    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="content"
                           action="${saveContent}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input id="code" cssClass="input-large highlight" path="code"
                                        onblur="validateCode()"/>
                    ...
                    <c:if test="${positions!=null}">
                        <div class="control-group">
                            <label><s:message code="label.content.boxes.position"
                                              text="Box position"/></label>
                            <div class="controls">

                                <form:select cssClass="list" path="contentPosition">
                                    <form:options items="${boxPositions}" itemValue="value"
                                                  itemLabel="key"/>
                                </form:select>
                                <span class="help-inline"><form:errors path="contentPosition"
                                                                       cssClass="error"/></span>
                            </div>
                        </div>
                    </c:if>
                    ...
                    <c:forEach items="${content.descriptions}" var="description"
                               varStatus="counter">
                        ...
                        <div class="control-group">
                            ...
                            <c:choose>
                                <c:when test="${boxes!=null}">
                                    <label><s:message code="label.content.boxes.name"
                                                      text="Box name"/> (<c:out
                                            value="${description.language.code}"/>)</label>
                                </c:when>
                                <c:otherwise>
                                    <label><s:message code="label.content.pages.page.name"
                                                      text="Page name"/> (<c:out
                                            value="${description.language.code}"/>)</label>
                                </c:otherwise>
                            </c:choose>
                        ...
                        <c:if test="${boxes==null}">
                            <div class="control-group">
                                <label><s:message code="label.sefurl" text="SEF Url"/> (<c:out
                                        value="${description.language.code}"/>)</label>
                                <div class="controls">
                                    <form:input id="seUrl${counter.index}"
                        ...
                        <div class="control-group">
                            <label><s:message code="label.content.pages.page.content"
                                              text="Page content"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                        ...
                        <c:if test="${boxes==null}">
                            <div class="control-group">
                                <label><s:message code="label.generic.title" text="Metatag title"/>
                            ...
                            <div class="control-group">
                                <label><s:message code="label.generic.keywords" text="Keywords"/>
                                    (<c:out value="${description.language.code}"/>)</label>
                                <div class="controls">
                                    <form:input
                            ...
                            <c:if test="${productGroups!=null}">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <form:select cssClass="productGrouplist"
                                                     path="productGroup">
                                            <form:option value="">&nbsp;</form:option>
                                            <form:options items="${productGroups}" itemValue="code"
                                                          itemLabel="code"/>
                                        </form:select>
                            ...
                            <div class="control-group">
                                <label><s:message code="label.content.metatag.description"
