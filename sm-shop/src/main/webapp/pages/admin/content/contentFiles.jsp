    ...
    <div class="tab-content">
        <div class="tab-pane active" id="catalogue-section">
            <div class="sm-ui-component">
                    ...
                    <div class="form-actions">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" class="btn btn-success"><s:message
                                    code="button.label.upload.files" text="Upload files"/></button>
                ...
                <c:set value="/admin/content/static/removeFile.html" var="removeUrl"
                       scope="request"/>
                <c:set value="/admin/content/static/contentFiles.html" var="refreshUrl"
                       scope="request"/>
                <c:set var="componentTitleKey" value="menu.content-files" scope="request"/>
                <c:set var="canRemoveEntry" value="true" scope="request"/>
                <c:set var="canEdit" value="false" scope="request"/>
                <c:set var="gridHeader" value="/pages/admin/content/contentFiles-gridHeader.jsp"
                       scope="request"/>
