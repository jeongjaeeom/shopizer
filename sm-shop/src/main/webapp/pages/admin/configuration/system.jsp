        ...
        <div class="tab-pane active" id="admin-cache">
            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="configuration"
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.displaystoreaddress"
                                          text="Display store address"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.displaysearchbox"
                                          text="Display search box"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.displaypagesmenu"
                                          text="Display pages menu"/></label>
                        <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <form:input cssClass="input-large"
                                            path="defaultSearchConfigPath['${language.code}']"/>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.store.allowPurchaseItems"
                                          text="Allow purchase items"/></label>
                        <div class="controls">
