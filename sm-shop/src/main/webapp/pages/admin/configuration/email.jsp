    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="accounts-conf">
            ...
            <div class="sm-ui-component">
                <h3><s:message code="label.emailconfig.options"
                               text="Email Configuration Options"/></h3>
                <br/>


                <c:url var="saveEmailConfiguration"
                ...
                <form:form method="POST" modelAttribute="configuration"
                    ...
                    <div class="control-group">
                        <label><s:message code="label.emailconfig.protocol"
                                          text="Protocol"/></label>
                        <div class="controls">
                            <form:input cssClass="input-large" path="protocol"/>
                        </div>
                        <span class="help-inline"><form:errors path="protocol"
                                                               cssClass="error"/></span>
                    </div>
                    ...
                    <div class="control-group">
                        <label><s:message code="label.emailconfig.username"
                                          text="Username"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label><s:message code="label.emailconfig.password"
                                          text="Password"/></label>
                        <div class="controls">
