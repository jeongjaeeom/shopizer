    ...
    <form:form method="POST" modelAttribute="store" action="${merchant}">
            ...
            <div class="controls">
                <c:choose>
                    <c:when test="${store.code=='DEFAULT'}">
                        <span class="input-large uneditable-input">${store.code}</span><form:hidden
                            path="code"/>
                    </c:when>
                    <c:otherwise>
                ...
                <span class="help-inline"><div id="checkCodeStatus"
                                               style="display:none;"></div><form:errors path="code"
                                                                                        cssClass="error"/></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <span class="help-inline"><form:errors path="storeEmailAddress"
                                                       cssClass="error"/></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input type="text" class="input-large highlight" id="storestateprovince"
                       name="storestateprovince" value="${store.storestateprovince}"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <span class="help-inline"><form:errors path="storepostalcode"
                                                       cssClass="error"/></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:checkboxes cssClass="highlight" items="${languages}" itemValue="id"
                                 itemLabel="code" path="languages"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select items="${languages}" itemValue="id" itemLabel="code"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select items="${currencies}" itemValue="id" itemLabel="code"
                             path="currency.id"/>
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            <label><s:message code="label.store.currency.format"
                              text="National currency format"/></label>
            <div class="controls">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select items="${weights}" path="weightunitcode" itemValue="code"
                             itemLabel="name"/>
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select items="${sizes}" path="seizeunitcode" itemValue="code"
                             itemLabel="name"/>
                <span class="help-inline"></span>
            </div>
        </div>
        ...
        <div class="control-group">
            <label><s:message code="label.store.inbusinesssince"
                              text="Web site operating since"/></label>
            <div class="controls">
                <input id="dateBusinessSince" name="dateBusinessSince"
                       value="${store.dateBusinessSince}" class="small" type="text"
                       data-date-format="<%=com.salesmanager.core.business.constants.Constants.DEFAULT_DATE_FORMAT%>"
                       data-datepicker="datepicker">
                <span class="help-inline"><form:errors path="dateBusinessSince"
                                                       cssClass="error"/></span>
            </div>
        </div>
