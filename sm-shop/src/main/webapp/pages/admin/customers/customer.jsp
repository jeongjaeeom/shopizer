    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (status == 0 || status == 9999) {
          ...
          $('#customerSuccess').html(
              '<s:message code="message.password.reset" text="Password has been reset" />');
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (status == 0 || status == 9999) {
          ...
          $('#customerSuccess').html(
              '<s:message code="message.credentials.reset" text="Credentials have been changed" />');
          $('#customerSuccess').show();
...
<div id="tabbable" class="tabbable">
    ...
    <h3>
        ...
        <c:choose>
            <c:when test="${customer.id!=null && customer.id>0}">
                <s:message code="label.customer.editcustomer" text="Edit Customer"/> <c:out
                    value="${category.code}"/>
            </c:when>
            <c:otherwise>
    ...
    <c:if test="${customer.id!=null && customer.id>0}">
        <div class="btn-group" style="z-index:400000;">
            ...
            <ul class="dropdown-menu">
                <li><a id="${customer.id}" href="#resetPassword"><s:message
                        code="button.label.resetpassword" text="Reset password"/></a></li>
                <li><a id="${customer.id}" href="#setCredentials"><s:message
                        code="button.label.setcredentials" text="Set credentials"/></a></li>
            </ul>
        </div>
        <!-- /btn-group -->
        <br/>
    ...
    <form:form method="POST" modelAttribute="customer" action="${saveCustomer}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input cssClass="input-large highlight" maxlength="64"
                            path="billing.firstName"/>
                <span class="help-inline"><form:errors path="billing.FirstName"
                                                       cssClass="error"/></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <form:input cssClass="input-large highlight" maxlength="64"
                            path="billing.lastName"/>
                <span class="help-inline"><form:errors path="billing.lastName"
                                                       cssClass="error"/></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <span class="input-large uneditable-input">${customer.nick}</span><form:hidden
                    path="nick"/>
            </div>
        </div>
        ...
        <address>
            ...
            <div class="controls">
                ...
                <form:input cssClass="input-large highlight" maxlength="256"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><form:errors path="billing.country.isoCode"
                                                           cssClass="error"/></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <form:input class="input-large highlight" id="bilstateOther" maxlength="100"
                                name="bilstateOther" path="billing.state"/>
                    <span class="help-inline"><form:errors path="billing.zone.code"
                                                           cssClass="error"/></span>
                </div>
            </div>
            ...
            <div class="controls">
                ...
                <span class="help-inline"><form:errors path="billing.postalCode"
                                                       cssClass="error"/></span>
            </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input cssClass="input-large highlight" maxlength="32"
                            path="billing.telephone"/>
                <span class="help-inline"><form:errors path="billing.telephone"
                                                       cssClass="error"/></span>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select class="input-large" items="${languages}" itemValue="id"
                             itemLabel="code" path="defaultLanguage.id"/>
        ...
        <address>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><form:errors path="delivery.country.isoCode"
                                                           cssClass="error"/></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <form:input class="input-large" id="delstateOther" maxlength="100"
                                name="delstateOther" path="delivery.state"/>
            ...
            <div class="controls">
                <label><s:message code="label.customer.shipping.postalcode"
                                  text="Postal code"/></label>
                <form:input id="deliveryPostalCode" cssClass="input-large" maxlength="20"
                            path="delivery.postalCode"/>
                <span class="help-inline"><form:errors path="delivery.postalCode"
                                                       cssClass="error"/></span>
            </div>
        </address>
        ...
        <c:if test="${fn:length(groups)>0}">
            <div class="control-group">
                ...
                <div class="controls">
                    <form:checkboxes cssClass="highlight" items="${groups}" itemValue="id"
    ...
    <c:if test="${customerAttr.id!=null && customerAttr.id>0}">
        ...
        <c:if test="${options!=null && fn:length(options)>0}">
            ...
            <div id="attributesError" class="alert alert-error" style="display:none;"><s:message
                    code="message.error" text="An error occured"/></div>
            <div id="attributesBox" class="box">
						<span class="box-title">
						<p><s:message code="label.customer.attributes"
                                      text="Customer attributes"/></p>
						</span>


                <form id="attributes">
                    <input id="customer" type="hidden" value="<c:out value="${customerAttr.id}"/>"
                           name="customer">
                            ...
                            <div class="controls">
                                <c:choose>
                                    <c:when test="${option.type=='Select'}">
                                        <select id="<c:out value="${option.id}"/>"
                                                name="<c:out value="${option.id}"/>">
                                            <c:forEach items="${option.availableValues}"
                                                       var="optionValue">
...
<div id="confirmModal" class="modal hide" style="z-index:600000" tabindex="-1" role="dialog"
  ...
  <div class="modal-footer">
           ...
           <button class="btn btn-success close-modal" id="closeModal" data-dismiss="modal"
                   aria-hidden="true" style="display:none;"><s:message code="button.label.close"
                                                                       text="Close"/></button>
  </div>
  </span>
</div>
...
<div id="credentialsModal" class="modal hide" style="z-index:650000" tabindex="-1" role="dialog"
  ...
  <div class="modal-header">
          <button type="button" class="close close-modal" data-dismiss="modal"
                  aria-hidden="true">X</button>
          <h3 id="modalTitle"><s:message code="button.label.setcredentials"
                                         text="Set credentials"/></h3>
  </div>
  <div class="modal-body">
           ...
           <p id="modalMessage">
           		    ...
           		    </label>&nbsp;<input type="text" id="crUserName" name="crUserName"
                                         class="input-small">
           </p>
           <p id="modalMessage">
                    <label>
           		    	<s:message code="label.generic.password" text="Password"/>
           		    </label>&nbsp;<input type="text" id="crPassword" name="crPassworde"
                                         class="input-small">
           </p>
  </div>  
  <div class="modal-footer">
