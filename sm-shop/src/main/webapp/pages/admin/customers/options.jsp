    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="customer-section">
            ...
            <div class="sm-ui-component">
                ...
                <c:set value="/admin/customers/options/paging.html" var="pagingUrl"
                       scope="request"/>
                <c:set value="/admin/customers/options/remove.html" var="removeUrl"
                       scope="request"/>
                <c:set value="/admin/customers/options/edit.html" var="editUrl" scope="request"/>
                <c:set value="/admin/customers/options/list.html" var="afterRemoveUrl"
                       scope="request"/>
                <c:set var="entityId" value="id" scope="request"/>
                <c:set var="componentTitleKey" value="menu.catalogue-options-list" scope="request"/>
                <c:set var="gridHeader" value="/pages/admin/customers/options-gridHeader.jsp"
                       scope="request"/>
