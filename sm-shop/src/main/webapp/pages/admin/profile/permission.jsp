            ...
            <div class="sm-ui-component">
                ...
                <h3>
                    <c:choose>
                        <c:when test="${permission.id!=null && permission.id>0}">
                            <s:message code="label.permission.editpermission"
                                       text="Edit permission"/> <c:out value="${category.code}"/>
                        </c:when>
                        <c:otherwise>
                            <s:message code="label.permission.createpermission"
                ...
                <form:form method="POST" modelAttribute="permission" action="${permissionSave}">
                    ...
                    <div class="control-group">
                        <label class="required"><s:message code="label.permission.name"
                                                           text="Permission name"/></label>
                        <div class="controls">
