    ...
    <div class="span12 common-row">
        ...
        <div class="span8 col-md-8 no-padding">
            ...
            <div class="checkout-box">
						...
						<p class="p-title">
							  ...
							  <c:choose>
                                  <c:when test="${address.billingAddress eq true}">
                                      <s:message code="label.customer.edit.billingaddress"
                ...
                <form:form method="POST" id="changeAddressForm" modelAttribute="address"
                           action="${updateAddress}">
                    <!-- TODO REMOVE -->
                    <input type="hidden" name="customerId" value="${customerId}">
                    <input type="hidden" name="billingAddress" value="${address.billingAddress}">

                    <form:errors id="address.error" path="*" cssClass="alert alert-error"
                                 element="div"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large required form-control form-control-md"
                                        maxlength="64" path="firstName" title="${msgFirstName}"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large required form-control form-control-md"
                                        maxlength="64" path="lastName" title="${msgLastName}"/>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input cssClass="input-large form-control form-control-md"
                                        maxlength="100" path="company"/>
                        </div>
                    </div>

                    <div class="control-group form-group">
                        <label><s:message code="label.customer.streetaddress"
                                          text="Street Address"/></label>
                        <div class="controls">

                            <s:message code="NotEmpty.customer.address2" text="Address is required"
                                       var="msgAddress"/>
                            <form:input cssClass="input-large required form-control form-control-md"
                                        maxlength="256" path="address" title="${msgAddress}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <s:message code="NotEmpty.customer.city" text="City is required"
                                       var="msgCity"/>
                            <form:input cssClass="input-large required form-control form-control-md"
                                        maxlength="100" path="city" title="${msgCity}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <form:select
                                    ...
                                    path="country" id="customer_country">
                                <form:options items="${countries}" itemValue="isoCode"
                                              itemLabel="name"/>
                            </form:select>
                            <span class="help-inline"><form:errors path="country"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>

                    <div class="control-group form-group">
                        <label><s:message code="label.customer.zone"
                                          text="State / Province"/></label>
                        <div class="controls">
                            <form:select cssClass="billing-zone-list form-control form-control-lg"
                                         path="zone" id="customer_zones"/>
                            <s:message code="NotEmpty.customer.stateProvince"
                                       text="State / Province is required" var="msgStateProvince"/>
                            <form:input class="input-large required form-control form-control-md"
                                        id="hidden_zones" maxlength="100" name="stateProvince"
                                        path="stateProvince" title="${msgStateProvince}"/>
                            <span class="help-inline"><form:errors path="zone"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><form:errors path="postalCode"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            ...
                            <form:input
                                    cssClass="input-large required customer-phone form-control form-control-md"
                                    maxlength="32" path="phone" title="${msgPhone}"/>
                            <span class="help-inline"><form:errors path="phone"
                                                                   cssClass="error"/></span>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <input id="submitAddress" class="btn btn-large btn-disabled template-btn"
                               type="submit" name="submitAddress"
                               value="<s:message code="menu.editaddress" text="Change address"/>"
                               disabled="">
                    </div>
