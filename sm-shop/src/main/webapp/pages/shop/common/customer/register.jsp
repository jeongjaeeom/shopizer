        ...
        <form:form method="post" action="${register_url}" id="registrationForm"
            ...
            <fieldset>
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <form:select path="gender" class="form-control form-control-lg">
                            <form:option value="M"><s:message code="label.generic.male"
                                                              text="Male"/></form:option>
                            <form:option value="F"><s:message code="label.generic.female"
                                                              text="Female"/></form:option>
                        </form:select>
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <s:message code="NotEmpty.customer.userName" text="User name is required"
                                   var="msgUserName"/>
                ...
                <div class="form-actions">
                    <input id="submitRegistration" type="submit"
                           ...
                           name="register" class="btn btn-large template-btn">
                </div>
            </fieldset>
        </form:form>
