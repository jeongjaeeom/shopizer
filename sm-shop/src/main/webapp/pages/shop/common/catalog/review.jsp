...
<div id="review" class="row-fluid container">
    ...
    <c:when test="${success!=null}">display:block;</c:when>
        ...
        <s:message code="message.productreview.created"
                   text="You have successfully created a product review"/>
    </div>
    ...
    <div class="span12 no_margin main col-md-12">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <form:form method="POST" modelAttribute="review" action="${submitReview}">
                            <form:errors path="*" cssClass="alert alert-error alert-danger"
                                         element="div"/>
                            <fieldset>
                                ...
                                <div class="control-group form-group">
                                    <label><s:message code="label.generic.youropinion"
                                                      text="Your opinion"/></label>
                                    <div class="controls">
                                        <form:textarea name="" rows="6"
                                                       class="span8 input form-control form-control-md"
                                                       path="description"/>
                                        <label>&nbsp;</label>
                                        <span class="help-block"><s:message
                                                code="label.product.clickrate"
        ...
        <div class="span6 col-md-4">
            <c:if test="${requestScope.CONTENT['customerCare']!=null}">
                <c:out value="${requestScope.CONTENT['customerCare'].description}"
                       escapeXml="false"/>
            </c:if>
        </div>
    </div>
