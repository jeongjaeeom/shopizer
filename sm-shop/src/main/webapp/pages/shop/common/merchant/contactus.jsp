...
<div id="main-content" class="container clearfix">
    ...
    <div id="mainContactUsRow" class="row-fluid common-row">
        ...
        <div class="span6 col-md-7">
            ...
            <form:form action="#" method="POST" id="contactForm" class="form-horizontal"
                       name="contactForm" modelAttribute="contact">
                ...
                <fieldset>
                    <div class="control-group form-group">
                        <label for="inputName" class="control-label"><s:message
                                code="label.entity.name" text="Name"/></label>
                        <div class="controls">
                            <s:message code="NotEmpty.customer.name" text="Name is required"
                                       var="msgName"/>
                            <form:input path="name" cssClass="required form-control form-control-md"
                                        id="name" title="${msgName}"/>
                            <form:errors path="name" cssClass="error"/>
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <label for="inputEmail" class="control-label"><s:message
                                code="label.generic.email" text="Email address"/></label>
                        <div class="controls">
                            <form:input path="email"
                                        cssClass="required form-control form-control-md"
                                        id="email"/>
                    ...
                    <div class="control-group form-group">
                        <label for="inputEmail" class="control-label"><s:message
                                code="label.generic.subject" text="Subject"/></label>
                        <div class="controls">
                    ...
                    <div class="control-group form-group">
                        <label class="control-label" for="textarea"><s:message
                                code="label.generic.comments" text="Comments"/></label>
                        <div class="controls">
                    ...
                    <div class="form-actions">
                        <input id="submitContact" type="button"
                               value="<s:message code="label.generic.send" text="Send"/>"
                               name="register" class="btn btn-default login-btn btn-large">
                    </div>
                </fieldset>
            </form:form>
            ...
            <div class="row-fluid common-row" style="margin-top:30px;">
                <div class="contactMapCanvas" id="map_canvas"
