...
<script type="text/javascript">
  ...
  var stripe3 = Stripe(
      '<c:out value="${requestScope.paymentMethod.informations.integrationKeys[\'publishableKey\']}" escapeXml="false"/>');
  ...
  function stripeResponseHandler3(response) {
    ...
    if (response.error) {
      ...
      var tokenField = '<input type="hidden" name="payment[\'stripe_token\']" value="'
          + paymentItentId
