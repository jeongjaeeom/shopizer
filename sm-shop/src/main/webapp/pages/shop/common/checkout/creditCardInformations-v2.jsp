                    ...
                    <div class="checkout-form-list">
                        <label class="control-label"><s:message
                            ...
                            <c:if test="${requestScope.CONFIGS['testMode']==true}">
                                <p><strong>For testing payment use card number 5555555555554444 and
                                    any cvv 3 digits</strong></p>
                            </c:if>
                        </label>
                        <div class="input-group">
                            ...
                            <input id="creditcard_card_number" type="text"
                                   ...
                                   title="${msgCardNumber}" autocomplete="off" data-stripe="number"
                                   required/>
                ...
                <div class="col-md-12">
                    <div class="checkout-form-list">
                        <label class="control-label"><s:message
                                ...
                                text="Card validation number"/><span
                                class="required">*</span></label>
                        <s:message code="NotEmpty.order.creditcard.cvv"
                                   text="Credit card validation digit is required"
                                   var="msgCardCvv"/>
