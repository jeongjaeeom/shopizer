...
<script type="text/html" id="subTotalsTemplate">
    ...
    <tr class="subt">
        ...
        <td><strong>{{#discounted}}<font color="red">-{{total}}</font>{{/discounted}}{{^discounted}}{{total}}{{/discounted}}</strong>
        </td>
    </tr>
    {{/subTotals}}
</script>
    ...
    <div id="shippingOptions" class="controls">
        ...
        <label class="radio">
            <input type="radio" name="selectedShippingOption.optionId" code="{{shippingModuleCode}}"
                   class="shippingOption" id="{{optionId}}" value="{{optionId}}" {{#checked}}
...
<script>
  ...
  function isFormValid() {
    ...
    if (valid == false) {//disable submit button
      if (firstErrorMessage != null) {
        ...
        $(formErrorMessageId).html(
            '<!--<img src="<c:url value="/resources/img/icon_error.png"/>" width="40"/>&nbsp;--><strong><font color="red">'
            + firstErrorMessage + '</font></strong>');
      ...
      $(formErrorMessageId).html(
          '<!--<img src="<c:url value="/resources/img/icon_success.png"/>" width="40"/>&nbsp;--><strong><s:message code="message.order.canprocess" text="The order can be completed"/></strong>');
      $(formErrorMessageId).show();
  ...
  function shippingQuotes() {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('#totalRow').html('');
        var subTotalsTemplate = Hogan.compile(
            document.getElementById("subTotalsTemplate").innerHTML);
      ...
      success: function (response) {
        ...
        if (status == 0 || status == 9999) {
          ...
          showResponseErrorMessage(
              '<s:message code="error.code.99" text="An error message occured while trying to process the payment (99)"/>');
  ...
  function displayConfirmShipping(delivery, shippingMethod) {
    ...
    if (useDistanceWindow) {
       ...
       **/
      if (delivery != null && delivery.latitude != null && delivery.longitude && delivery.postalCode
          != null && shippingMethod != null) {
        if (shippingMethod != 'storePickUp') {
          ...
          var map = new google.maps.Map(document.getElementById("confirmShippingAddress"),
              mapOptions);
  ...
  $(document).ready(function () {
    ...
    getZones('#billingStateList', '#billingStateProvince',
        '<c:out value="${order.customer.billing.country}" />',
        '<c:out value="${order.customer.billing.zone}" />', null);
    </c:if>
    ...
    getZones('#deliveryStateList', '#deliveryStateProvince',
        '<c:out value="${order.customer.delivery.country}" />',
        '<c:out value="${order.customer.billing.zone}" />', null);
    </c:if>

    $(".billing-country-list").change(function () {
      getZones('#billingStateList', '#billingStateProvince', $(this).val(),
          '<c:out value="${order.customer.billing.zone}" />', shippingQuotes);
      setCountrySettings('billing', $(this).val());
    })

    $(".shipping-country-list").change(function () {
      getZones('#deliveryStateList', '#deliveryStateProvince', $(this).val(),
          '<c:out value="${order.customer.delivery.zone}" />', shippingQuotes);
    ...
    address = {
      address: '<c:out value="${deliveryAddress.address}"/>',
      postalCode: '<c:out value="${deliveryAddress.postalCode}"/>',
      province: '<c:out value="${deliveryAddress.provinceName}"/>',
      country: '<c:out value="${deliveryAddress.countryName}"/>'
    };
    </c:if>
                    ...
                    <div class="span8 col-md-8 no-padding-left">
                        ...
                        <div id="shippingBox" class="checkout-box">
											<span class="box-title">
												<p class="p-title"><s:message
                                                        code="label.customer.billinginformation"
                                                        text="Billing information"/></p>
											</span>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.firstName"
                                                        ...
                                                        path="customer.billing.firstName"
                                                        autofocus="autofocus"
                                                        title="${msgFirstName}"/>
                                            <form:errors path="customer.billing.firstName"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.firstName"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.lastName"
                                                        cssClass="input-large required form-control form-control-lg"
                                                        maxlength="32"
                                                        path="customer.billing.lastName"
                                                        title="${msgLastName}"/>
                                            <form:errors path="customer.billing.lastName"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.lastName"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.emailAddress"
                                                        ...
                                                        title="${msgEmail}"/>
                                            <form:errors path="customer.emailAddress"
                                                         cssClass="error"/>
                                            <span id="error-customer.emailAddress"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4 col-md-4">
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:errors path="customer.billing.company"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.company"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.billing.address"
                                                        ...
                                                        title="${msgAddress}"/>
                                            <form:errors path="customer.billing.address"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.address"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.billing.city"
                                                        cssClass="input-large required form-control form-control-lg"
                                                        path="customer.billing.city"
                                                        title="${msgCity}"/>
                                            <form:errors path="customer.billing.city"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.city"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="billingPostalCode"
                                                        ...
                                                        path="customer.billing.postalCode"
                                                        title="${msgPostalCode}"/>
                                            <form:errors path="customer.billing.postalCode"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.postalCode"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="span8 col-md-8">
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <s:message
                                                    code="NotEmpty.customer.billing.stateProvince"
                                            ...
                                            <form:errors path="customer.billing.stateProvince"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.stateProvince"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <form:input id="customer.billing.phone"
                                                        ...
                                                        path="customer.billing.phone"
                                                        title="${msgPhone}"/>
                                            <form:errors path="customer.billing.phone"
                                                         cssClass="error"/>
                                            <span id="error-customer.billing.phone"
                                                  class="error"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span8 col-md-8">
                                        <label id="useAddress" class="checkbox">
                                            <form:checkbox path="shipToBillingAdress"
                                                           id="shipToBillingAdress"/>
                        ...
                        <c:if test="${shippingQuote!=null}">
                            ...
                            <div id="deliveryBox" class="checkout-box">
											<span class="box-title">
												<p class="p-title"><s:message
                                                        code="label.customer.shippinginformation"
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span4 col-md-4">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                <s:message
                                                        code="NotEmpty.customer.shipping.firstName"
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span4 col-md-4">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                <s:message
                                                        code="NotEmpty.customer.shipping.lastName"
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span4 col-md-4">
                                        <div class="control-group form-group">
                                            <label><s:message code="label.customer.shipping.company"
                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <form:input id="customer.delivery.city"
                                                            cssClass="input-large required form-control form-control-lg"
                                                            path="customer.delivery.city"
                                                            title="${msgShippingCity}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span4 col-md-4">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                <s:message
                                                        code="NotEmpty.customer.shipping.postalCode"
                                    ...
                                    <div class="span8 col-md-8">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <s:message
                                                        code="NotEmpty.customer.shipping.stateProvince"
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span8 col-md-8">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                <form:select
                                                        cssClass="shipping-country-list form-control"
                                            ...
                                            <div id="shippingOptions" class="controls">
                                                ...
                                                <c:forEach items="${shippingQuote.shippingOptions}"
                                                    ...
                                                    <label class="radio">
                                                        ...
                                                        - ${option.optionPriceText}
                                                        <c:if test="${option.note!=null}">
                                                            <br/><small><c:out
                                                                value="${option.note}"/></small>
                                                        </c:if>
                                                    </label>
                                                </c:forEach>
                                            </div>
                        ...
                        <c:if test="${fn:length(paymentMethods)>0}">
                            ...
                            <div class="checkout-box">
										<span class="box-title">
											<p class="p-title"><s:message
                                                    code="label.payment.module.title"
                                                    text="Payment method"/></p>
										</span>
                                ...
                                <div class="tabbable">
                                        ...
                                        <c:forEach items="${paymentMethods}" var="paymentMethod">
                                            <li class="<c:choose><c:when test="${order.paymentMethodType!=null && order.paymentMethodType==paymentMethod.paymentType}">active</c:when><c:otherwise><c:if test="${order.paymentMethodType==null && paymentMethod.defaultSelected==true}">active</c:if></c:otherwise></c:choose>">
                                                <a href="#${paymentMethod.paymentType}"
                                                   data-toggle="tab" class="paymentTab"
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${paymentMethod.paymentType=='CREDITCARD' || paymentMethod.paymentType=='PAYPAL'}">
                                                            <c:if test="${paymentMethod.paymentType=='CREDITCARD'}">
                                                                <p id="cc-img-container">
                                                                    <img src="<c:url value="/resources/img/payment/icons/visa-straight-64px.png"/>"
                                                                         width="40"
                                                                         style="display:inline-block;">
                                                                    <img src="<c:url value="/resources/img/payment/icons/mastercard-straight-64px.png"/>"
                                                                         width="40"
                                                                         style="display:inline-block;">
                                                                    <img src="<c:url value="/resources/img/payment/icons/american-express-straight-64px.png"/>"
                                                                         width="40"
                                                                         style="display:inline-block;">
                                                                </p>
                                                            </c:if>
                                                            <c:if test="${paymentMethod.paymentType=='PAYPAL'}"><img
                                                        ...
                                                        <c:otherwise>
                                                            <h4><s:message
                                                                    ...
                                                                    text="Payment method type [payment.type.${paymentMethod.paymentType}] not defined in payment.properties"/></h4>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        <c:forEach items="${paymentMethods}" var="paymentMethod">
                                            <div class="payment-tab tab-pane <c:choose><c:when test="${order.paymentMethodType!=null && order.paymentMethodType==paymentMethod.paymentType}">active</c:when><c:otherwise><c:if test="${order.paymentMethodType==null && paymentMethod.defaultSelected==true}">active</c:if></c:otherwise></c:choose>"
                    ...
                    <div class="span4 col-md-4 no-padding">
                        ...
                        <div class="checkout-box">
											<span id="summaryBox" class="box-title">
												<p class="p-title"><s:message
                                                        code="label.order.summary"
                                                        text="Order summary"/></p>
											</span>
                            ...
                            <table id="summary-table" class="table table-condensed table-hover">
                                ...
                                <c:forEach items="${cart.shoppingCartItems}" var="shoppingCartItem">
                                    <tr class="item">
                                        ...
                                        <td width="31%"><strong>${shoppingCartItem.price}</strong>
                                        </td>
                                        <td width="31%">
                                    ...
                                    <c:if test="${total.orderTotalCode!='order.total.total'}">
                                        ...
                                        <tr class="subt">
                                            <td colspan="2">
                                                <c:choose>
                                                    <c:when test="${total.orderTotalCode=='order.total.discount'}">
                                                        <s:message code="label.generic.rebate"
                                                                   text="Rebate"/>&nbsp;-&nbsp;<s:message
                                                            code="${total.text}"
                                                            text="${total.text}"/>
                                                    </c:when>
                                                    <c:otherwise>
                                            ...
                                            <td><strong><c:choose><c:when
                                                    ...
                                                    value="${total.value}"/></c:otherwise></c:choose></strong>
                                            </td>
                                        </tr>
                            ...
                            <div id="totalRow" class="total-box">
												<span class="total-box-grand-total">
													<font class="total-box-label">
													<s:message code="order.total.total"
                                                               text="Total"/>
                            ...
                            <div class="checkout-box" id="customerAgreementSection" class="">
                                <label id="customerAgreement" class="checkbox">
                                    <s:message code="NotEmpty.customer.agreement"
                                               ...
                                               var="msgAgreement"/>
                                    <form:checkbox path="customerAgreed" id="customerAgreed"
                                                   cssClass="required" title="${msgAgreement}"/>
                        ...
                        <div class="form-actions">
                            <div class="pull-right">
                                ...
                                ><s:message code="button.label.submitorder"
                                            text="Submit order"/></button>
