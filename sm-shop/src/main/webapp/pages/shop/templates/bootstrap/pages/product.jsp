    ...
    <div itemscope class="span12" itemtype="http://data-vocabulary.org/Product">
        ...
        <div id="img" class="span4 productMainImage">
            <c:if test="${product.image!=null}">
                <span id="mainImg"><img id="im-<c:out value="${product.image.id}"/>"
        ...
        <div class="span8">
            ...
            <address>
                <strong><s:message code="label.product.brand" text="Brand"/></strong> <span
                    itemprop="brand"><c:out
                    value="${product.manufacturer.description.name}"/></span><br>
                <strong><s:message code="label.product.code" text="Product code"/></strong> <span
...
<div class="row-fluid">
    <div class="span12">
        ...
        <ul class="nav nav-tabs" id="productTabs">
            ...
            <li><a href="#reviews"><s:message code="label.product.customer.reviews"
