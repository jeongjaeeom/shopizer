                    ...
                    <ul role="tablist" class="nav nav-pills white space-top">
                        <li class="active">
                            <a title="images" data-toggle="tab" role="tab" href="#product-images">
                                <i class="fa fa-camera pr-5"></i> <s:message
                        ...
                        <c:if test="${requestScope.VIDEO_URL!=null}">
                            <li>
                                <a title="video" data-toggle="tab" role="tab" href="#product-video">
                                    <i class="fa fa-video-camera pr-5"></i> <s:message
                                        code="label.generic.videos" text="Videos"/>
                                </a>
                            </li>
                        </c:if>
                    </ul>
                                                ...
                                                <div class="col-xs-6 col-md-3">
                                                    <c:choose>
                                                        <c:when test="${thumbnail.externalUrl==null}">
                                                            <a href="javascript:;"" class="detailsThumbImg thumbImg thumbnail" imgId="im-<c:out
                                                                value="${thumbnail.id}"/>" title="<c:out
                                                        ...
                                                        <c:otherwise>
                                                            <a href="javascript:;"" class="detailsThumbImg thumbImg thumbnail" imgId="im-<c:out
                                                                ...
                                                                value="${thumbnail.externalUrl}"/>"><img height="100" src="${thumbnail.externalUrl}" alt="<c:url
                        ...
                        <span itemprop="offerDetails" itemscope
                              itemtype="http://data-vocabulary.org/Offer">
                                   ...
                                   <c:when test="${product.quantity>0}"><span
                                       ...
                                       <c:otherwise><span itemprop="availability"
                                                          content="out_of_stock"><s:message
                                ...
                                <div class="tab-content padding-top-clear padding-bottom-clear">
                                    <div id="h2tab1" class="tab-pane fade  active in">
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt><s:message code="label.product.height"
                                                           text="Height"/>:
                                            </dt>
                                            <dd><fmt:formatNumber
                                                    value="${product.productSpecifications.height}"
                                            ...
                                            <dd><fmt:formatNumber
                                                    value="${product.productSpecifications.width}"
                                                    maxFractionDigits="2"/>&nbsp;<s:message
                                                    code="label.generic.sizeunit.${requestScope.MERCHANT_STORE.seizeunitcode}"
                                                    text="Inches"/></dd>
                                            <dt><s:message code="label.product.length"
                                                           text="Length"/>:
                                            </dt>
                                            <dd><fmt:formatNumber
                                                    value="${product.productSpecifications.length}"
                                                    maxFractionDigits="2"/>&nbsp;<s:message
                                                    code="label.generic.sizeunit.${requestScope.MERCHANT_STORE.seizeunitcode}"
                                                    text="Inches"/></dd>
                                        </dl>
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <c:if test="${attributes!=null}">
                                                <c:forEach items="${attributes}" var="attribute"
                                                    ...
                                                    <dd><c:out
                                                            value="${attribute.readOnlyValue.description}"/></dd>
                                                </c:forEach>
                                            </c:if>
                                        </dl>
    ...
    <c:if test="${relatedProducts!=null}">
        <div class="section clearfix main-container">
            <div class="container no-left-padding no-right-padding">
                <div class="row">
                    <div class="col-md-12">
                        <h2><s:message code="label.product.related.title"
                                       text="Related items"/></h2>
...
<script>
  ...
  $(function () {
    ...
    $('.thumbImg').click(function () {
      ...
      $("#largeImg").html("<img src='" + url + "' /><a href='" + url + "' data-mfp-src='" + url
          + "' class='popup-img overlay' title='" + name
