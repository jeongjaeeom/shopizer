...
<div class="row-exoticamobilia row">
    <c:forEach items="${requestScope.ITEMS}" var="product">
        <div class="col-sm-4" data-id="${product.id}" item-price="${product.price}"
            ...
            <div class="box-style-1 white-bg object-non-visible animated object-visible">
                ...
                <c:if test="${!product.canBePurchased }">
                    <div class="sold-out-box">
                        <span class="sold-out-text"><s:message code="label.soldout"
                                                               text="Sold out"/></span>
                    </div>
                </c:if>
                <div class="product-image"><c:if test="${product.image!=null}"><a
                ...
                <div class="caption">
                    <div class="product-details">
                        <div class="clearfix">
                            ...
                            <h3 class="product-heading product-name" itemprop="name"><c:out
                                    value="${product.description.name}"/></h3>
                            <!--</a>-->
                            <h4 class="price">
                                <h4>
                                    <c:choose>
                                        <c:when test="${product.discounted}">
                                            ...
                                            &nbsp;<span class="specialPrice" itemprop="price"><c:out
                        ...
                        <div class="clearfix">
                            ...
                            <c:choose>
                                <c:when test="${requestScope.FEATURED==true}">
                                    <c:if test="${requestScope.CONFIGS['displayAddToCartOnFeaturedItems']==true && requestScope.CONFIGS['allowPurchaseItems']==true && product.canBePurchased}"><a
                                ...
                                <c:otherwise>
                                    <c:if test="${requestScope.CONFIGS['allowPurchaseItems']==true  && product.canBePurchased}">
                                        <a class="btn btn-buy pull-right addToCart"
                                           href="javascript:void(0);"
                                           productId="${product.id}"><s:message
