...
<head>
    ...
    <script type="text/html" id="productBoxTemplate">
        ...
        <div itemscope itemtype="http://schema.org/Enumeration"
             class="col-md-COLUMN-SIZE col-sm-6 col-xs-12 product" item-order="{{sortOrder}}"
             item-name="{{description.name}}" item-price="{{price}}" data-id="{{id}}">
            ...
            <div class="product-content text-center">
                <a class="listing-product-name"
                   href="<c:url value="/shop/product/" />{{description.friendlyUrl}}.html/ref=<c:out value="${requestScope.ref}"/>">
                    <h3 itemprop="name">{{description.name}}</h3></a>
                ...
                <c:if test="${requestScope.CONFIGS['allowPurchaseItems'] == true}">
                    <div class="store-btn">
                        <div class="store-btn-addtocart"><a class="addToCart"
                                                            href="javascript:void(0)"
                                                            productId="{{id}}"><s:message
    ...
    <c:if test="${requestScope.PAGE_INFORMATION.pageImageUrl!=null}">
        ...
        <meta name="twitter:description"
              content="${requestScope.PAGE_INFORMATION.pageDescription}"/>
