        ...
        <div class="row">
            <div class=" col-lg-6 col-md-6 col-sm-8  col-xs-12">
                <div class="login-title">
                    <h3><s:message code="label.register.personal.information"
                                   text="Personal information"/></h3>
                </div>
                <div class="login-form">
                    <form:form method="post" action="${register_url}" id="registrationForm"
                               modelAttribute="customer">
                        <form:errors path="*" cssClass="alert alert-error alert-danger form-group"
                                     element="div"/>
                        <div class="form-group login-page">
                            <label for="firstName"><s:message code="label.generic.firstname"
                                                              text="First Name"/>
                                <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="lastName"><s:message code="label.generic.lastname"
                                                             text="Last Name"/>
                                <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="country"><s:message code="label.generic.country"
                                                            text="Country"/> <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="stateProvince"><s:message code="label.generic.stateprovince"
                                                                  text="State / Province"/>
                                <span>*</span></label>
                        ...
                        -->
                        <div class="login-title">
                            <h3><s:message code="label.register.signin.information"
                                           text="Sign-in information"/></h3>
                        </div>
                        <div class="form-group login-page">
                            <label for="email"><s:message code="label.generic.email"
                                                          text="Email address"/>
                                <span>*</span></label>
                            ...
                            <form:input path="emailAddress"
                                        ...
                                        id="emailAddress" title="${msgEmail}"/>
                            <form:errors path="emailAddress" cssClass="error"/>
                            <form:hidden path="userName"/>
                        </div>
                        <div class="form-group login-page">
                            <label for="password"><s:message code="label.generic.password"
                                                             text="Password"/>
                                <span>*</span></label>
                            <s:message code="message.password.required" text="Password is required"
                                       var="msgPassword"/>
                        ...
                        <div class="form-group login-page">
                            <label for="repeatPassword"><s:message
                                    code="label.generic.repeatpassword" text="Repeat password"/>
                                <span>*</span></label>
                        ...
                        <button type="submit" class="btn btn-default login-btn"><s:message
                                code="label.register.createaccount"
                                text="Create an account"/></button>
                    </form:form>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-4 hidden-xs">
                <h3 class="short_headline"><span><s:message code="label.register.whyregister"
                                                            text="Why register?"/></span></h3>
                <p>
