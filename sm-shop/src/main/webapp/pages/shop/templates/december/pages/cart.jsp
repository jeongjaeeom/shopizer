                                ...
                                <tr>
                                    ...
                                    <td style="border-left: none;">
                                        ...
                                        <c:if test="${fn:length(unavailable.shoppingCartAttributes)>0}">
                                            ...
                                            <ul>
                                                <c:forEach
                                                        items="${unavailable.shoppingCartAttributes}"
                                                        var="option">
                                                    <li>${option.optionName}-${option.optionValue}</li>
                                                </c:forEach>
                                            </ul>
                                        </c:if> <br/> <s:message code="label.quantity"
                                                                 text="Quantity"/>:
                                    ...
                                    <td>
                                        ...
                                        <div class="cart-del">
                                            ...
                                            </a> <input type="hidden" name="lineItemId"
                                                        id="lineItemId"
                                            ...
                                            <table id="mainCartTable"
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <strong>${shoppingCartItem.price}</strong>
                                                    </td>
                                                    <td
                                                            data-th="<s:message code="label.order.total" text="Total"/>"
                                                            class="">
                                                        <strong>${shoppingCartItem.subTotal}</strong>
                                                    </td>

                                                    <td width="10%" class="actions" data-th="">
                                                        <div class="cart-del">
                                                            <a href="#"
                                                               class="cart-close removeProductIcon"
                                                               style="clear: both !important;"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="buttons-cart">
                                                    <a href="#"
                                                       onClick="javascript:updateCart('#mainCartTable');"><s:message
                                                            code="label.order.recalculate"
                                                            text="Racalculate"/></a> <a
                                                        href="<c:url value="/shop"/>"><s:message
                                                        code="button.label.continue"
                                                        text="Continue shopping"/></a>
                                                </div>
                                                <div class="coupon">
                                                    <h3>
                                                        <s:message
                                                                code="label.order.promocode.title"
                                                                text="Promotion code"/></h3>
                                                    <p>
                                                        <s:message
                                                                code="label.order.promocode.text"
                                                                text="Enter your promotion code if you have one."/>
                                                    </p>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                                                <div class="cart_totals">
                                                    ...
                                                    <h2>
                                                        <s:message code="label.order.totals"
                                                                   text="Totals"/>
                                                    </h2>
                                                    <div class="cart-totals-table">
                                                        <table>
                                                            <tbody>
                                                            <c:forEach items="${cart.totals}"
                                                                       var="total">
                                                ...
                                                <div class="wc-proceed-to-checkout">
                                                    <a href="<c:url value="/shop/order/checkout.html"/>"><s:message
                                                            code="label.proceed.checkout"
                                                            text="Proceed to checkout"/></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
