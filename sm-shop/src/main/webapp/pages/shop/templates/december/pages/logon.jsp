        ...
        <div class="row">
            <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="login-title">
                    <h3><s:message code="label.customer.registered"
                                   text="Registered customer"/></h3>
                    ...
                    <form>
                        <div class="form-group login-page">
                            <label for="inputEmail"><s:message code="label.customer.email"
                                ...
                                <span>*</span></label>
                            <input type="text" class="form-control" id="signin_userName"
                        ...
                        <button type="submit" id="genericLogin-button"
                                class="btn btn-default login-btn"><s:message
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <a class="btn btn-default login-btn"
                   href="<s:url value="/shop/customer/registration.html"/>"><s:message
