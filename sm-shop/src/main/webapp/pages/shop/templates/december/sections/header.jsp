...
<script type="text/html" id="customerLoggedInAccountTemplate">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
       data-close-others="false"> <i class="fa fa-user mr-5"></i><span class="hidden-xs"><s:message
            code="label.generic.welcome" text="Welcome"/>&nbsp;<span>{{firstName}}</span><i
            class="fa fa-angle-down ml-5"></i></span> </a>
    <ul class="dropdown-menu w-150" role="menu">
        <li><a href="#"
               onClick="javascript:location.href='<c:url value="/shop/customer/dashboard.html" />';"
               href="#"><s:message code="label.customer.myaccount" text="My account"/></a></a>
        </li>
        <li><a href="#"
               onClick="javascript:location.href='<c:url value="/shop/customer/logout" />';"
               href="#"><s:message code="button.label.logout" text="Logout"/></a>
        </li>
    </ul>
...
<script type="text/html" id="customerNotLoggedInAccountTemplate">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
       data-close-others="false"> <i class="fa fa-user mr-5"></i><span class="hidden-xs"><s:message
            code="label.customer.myaccount" text="My Account"/><i class="fa fa-angle-down ml-5"></i></span>
    </a>
    <ul class="dropdown-menu w-150" role="menu">
        <li><a href="#" id="registerLink"
               onClick="javascript:location.href='<c:url value="/shop/customer/registration.html" />';"><s:message
                code="label.generic.register" text="Register"/></a></li>
        <li><a href="#" id="registerLink"
               onClick="javascript:location.href='<c:url value="/shop/customer/customLogon.html" />';"><s:message
                code="button.label.signin" text="Signin"/></a></li>
    </ul>
    <script type="text/javascript">
      (function ($) {
        $('[data-hover="dropdown"]').dropdownHover()
...
<script type="text/html" id="miniCartTemplate">
                    ...
                    <div class="cart-img">
                        ...
                        <a href="#" class="product-image">
                            <img class="img-responsive"
                                 src="<c:out value="${pageContext.servletContext.contextPath}" />{{image}}">
                        </a>
                        {{/image}}
                        {{^image}}
                        &nbsp
                    ...
                    <div class="product-details">
                        <div class="close-icon">
                            <button productid="{{productId}}" class="close removeProductIcon"
                                    onclick="removeItemFromMinicart('{{id}}')"><i
                                    class="fa fa-times-circle"></i></a>
                        </div>
                        <p class="product-name"><a href="#">{{name}}</a></p>
                        <strong>{{quantity}}</strong> x <span
                            class="price text-primary">{{price}}</span></div>
                    <!-- end product-details -->
                </li>
                <!-- end item -->
    ...
    <li>
        <div class="cart-footer">
            ...
            <a href="#" onclick="viewShoppingCartPage();" class="pull-right"><i
                    class="fa fa-shopping-basket mr-5"></i><s:message code="label.checkout"
                                                                      text="Checkout"/></a>
        </div>
    </li>
    {{/code}}
    ...
    <li>
        <div class="cart-items">
            <ol class="items">
                ...
                <h5 style="text-align: center;color:#666666;margin-top:10px;margin-bottom:10px;">
                    <s:message code="label.emptycart" text="Your Shopping cart is empty"/></h5>
  ...
  !function ($, n, e) {
    ...
    $.fn.dropdownHover = function (e) {
      return "ontouchstart" in document ? this : (o = o.add(this.parent()), this.each(function () {
        function t(e) {
          o.find(":focus").blur(), h.instantlyCloseOthers === !0 && o.removeClass(
              "open"), n.clearTimeout(c), i.addClass("open"), r.trigger(a)
        }
        ...
        i.hover(function (n) {
          ...
          var e = $(this),
              o;
          e.hover(function () {
            n.clearTimeout(o), e.children(".dropdown-menu").show(), e.siblings().children(
                ".dropdown-menu").hide()
          }, function () {
    ...
    <div class="container">
        <c:if test="${requestScope.CONFIGS['displayContactUs']==true}">
            <ul class="list-inline pull-left hidden-sm hidden-xs">
                <li><span class="text-primary"><s:message code="label.store.question"
                                                          text="Have a question?"/></span>&nbsp;&nbsp;&nbsp;<abbr
                        title="Email"><s:message code="label.generic.email" text="Email"/></abbr>:
                    <span itemprop="email"><a class="store-name" style="color:#000;"
                                              href="mailto:<c:out value="${requestScope.MERCHANT_STORE.storeEmailAddress}"/>"><strong><c:out
                            value="${requestScope.MERCHANT_STORE.storeEmailAddress}"/></strong></a></span>&nbsp;&nbsp;&nbsp;<abbr
                            title="Phone"><s:message code="label.generic.phone"
                                                     text="Phone"/></abbr>: <span
                            itemprop="telephone"><a class="store-name" style="color:#000;"
                                                    href="tel:<c:out value="${requestScope.MERCHANT_STORE.storephone}"/>"><strong><c:out
                            value="${requestScope.MERCHANT_STORE.storephone}"/></strong></a></span>
                </li>
                <c:if test="${requestScope.CONFIGS['testMode']==true}">
                    <li><h4>[TEST MODE]</h4></li>
                </c:if>
            </ul>
        </c:if>
        <ul class="topBarNav pull-right">
            ...
            <c:if test="${fn:length(requestScope.MERCHANT_STORE.languages) > 1}">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"> <img src="" class="mr-5" alt=""> <span
                            class="hidden-xs"> <s:message code="lang.${requestScope.LANGUAGE.code}"
                                                          text="${requestScope.LANGUAGE.code}"/> <i
                            class="fa fa-angle-down ml-5"></i></span> </a>
                    <ul class="dropdown-menu w-100" role="menu">
                        <c:forEach items="${requestScope.MERCHANT_STORE.languages}" var="language">
                            <c:if test="${requestScope.LANGUAGE.code ne language.code}">
                                <a href="<c:url value="${requestScope['javax.servlet.forward.request_uri']}?locale=${language.code}"/>"><s:message
                                        code="lang.${language.code}" text="${language.code}"/></a>
                            </c:if>
                        </c:forEach>
                    </ul>
                </li>
            ...
            <c:if test="${requestScope.CONFIGS['allowPurchaseItems'] == true}">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"> <i class="fa fa-shopping-basket mr-5"></i> <span
                            class="hidden-xs">
                                <s:message code="label.cart" text="Shopping cart"/><sup
                            class="text-primary">(<span id="miniCartSummary"></span>)</sup>
                            ...
                            <c:choose>
                                <c:when test="${not empty requestScope.MERCHANT_STORE.storeLogo}">
                                    ...
                                    <a class="grey store-name" href="<c:url value="/shop/"/>">
                                        <img class="logoImage" style="max-width:140px;"
                                             src="<sm:storeLogo/>"/>
                                    </a>
                                </c:when>
                                <c:otherwise>
                        ...
                        <div class="row grid-space-1">
                            <div class="col-sm-9">
                                <input type="text" name="q" id="searchField"
                                       ...
                                       placeholder="<s:message code="label.generic.search" text="Search"/>"
                                       value="">
                            </div>
                            <!-- end col -->
                            <div class="col-sm-3">
                                <input type="submit"
                                       class="btn btn-default btn-block btn-lg searchButton"
                                       value="<s:message code="label.generic.search" text="Search"/>">
                            </div>
                            <!-- end col -->
                        </div>
                        <!-- end row -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-1" style="margin-top: 5px;">
            <ul class="nav navbar-nav">
                <li><a href="<c:url value="/shop/"/>" class="dropdown-toggle"><s:message
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"><s:message code="menu.catalogue-products"
                                                            text="Products"/> <i
                    ...
                    <ul class="dropdown-menu row">
                        ...
                        <c:forEach items="${requestScope.TOP_CATEGORIES}" var="category">
                            <c:if test="${category.visible}">
                                <li>
                                <li class="<c:if test="${fn:length(category.children)>0}">dropdown-submenu</c:if> <sm:activeLink linkCode="${category.description.friendlyUrl}" activeReturnCode="active"/>">
                                    <a href="<c:url value="/shop/category/${category.description.friendlyUrl}.html"/><sm:breadcrumbParam categoryId="${category.id}"/>"><c:out
                                        ...
                                        <ul class="dropdown-menu">
                                            <c:forEach items="${category.children}" var="child">
                                                <c:if test="${child.visible}">
                                                    <li>
                                                        <a href="<c:url value="/shop/category/${child.description.friendlyUrl}.html"/><sm:breadcrumbParam categoryId="${child.id}"/>"><c:out
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                           data-hover="dropdown" data-close-others="false">
                            <s:message code="label.page" text="Page"/> <i
                                class="fa fa-angle-down ml-5"></i></a>
