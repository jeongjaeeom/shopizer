                        ...
                        <div class="row">
                                                ...
                                                <div class="tab-pane"
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            ...
                                                            rel="<c:url
                                                                value="${thumbnail.externalUrl}"/>"><img
                                                            src="${thumbnail.externalUrl}"
                                                            alt="<c:url
                                                                value="${product.description.name}"/>" style="border:0 !important;"></a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </c:if>
                            ...
                            <div class="col-lg-7 col-md-5 col-sm-5 col-xs-12">
                                <div class="product-simple-content">
										...
										<span><i class="fa fa-check-square" aria-hidden="true"></i>
											<c:if test="${not product.productVirtual}">
												<div class="checkbox">
													<!-- availability -->
													<strong><s:message
                                                            code="label.product.available"
                                                            text="Availability"/></strong>:&nbsp;<span><c:choose>
															<c:when test="${product.quantity>0}">
																<span itemprop="availability"
                                                                      content="in_stock">${product.quantity}</span>
															</c:when>
															<c:otherwise>
																<span itemprop="availability"
                                    ...
                                    <c:if test="${product.productPrice.description!=null}"><strong><c:out
                                            value="${product.productPrice.description.priceAppender}"/></strong></c:if>
                                    <jsp:include
                                        ...
                                        <div class="tab-pane active" id="details">
                                            <div class="product-info-tab-content">
                                                ...
                                                <dl class="dl-horizontal">
                                                    <dt>
                                                        <s:message code="label.product.weight"
                                                                   text="Weight"/>
                                                        :
                                                    </dt>
                                                    <dd>
                                                        <fmt:formatNumber
                                                                value="${product.productSpecifications.weight}"
                                                                maxFractionDigits="2"/>
                                                        &nbsp;
                                                        <s:message
                                                    ...
                                                    <dt>
                                                        <s:message code="label.product.height"
                                                                   text="Height"/>
                                                        :
                                                    </dt>
                                                    <dd>
                                                    ...
                                                    <dt>
                                                        <s:message code="label.product.width"
                                                                   text="Width"/>
                                                        :
                                                    </dt>
                                                    <dd>
                                                    ...
                                                    <dt>
                                                        <s:message code="label.product.length"
                                                                   text="Length"/>
                                                        :
                                                    </dt>
                                                    <dd>
                                    ...
                                    <div>
                                        <div class="tab-pane" id="reviews">
                                            <div class="customer-review-top">
                                                ...
                                                <!-- reviews -->
                                                <jsp:include
                                                        page="/pages/shop/common/catalog/reviews.jsp"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div>
                                            <div>
                                                ...
                                                <c:set var="ITEMS" value="${relatedProducts}"
                                                       scope="request"/>
                                                <jsp:include
