...
<script type="text/html" id="subTotalsTemplate">
    ...
    <tr id="cart-subtotal-{{code}}" class="cart-subtotal subt">
        <td class="order-total-label">{{#discounted}}<s:message code="label.generic.rebate"
                                                                text="Rebate"/>&nbsp;-&nbsp;{{text}}{{/discounted}}{{^discounted}}{{title}}{{/discounted}}
        </td>
        <td class="order-total-label"><strong>{{#discounted}}<font color="red">-{{total}}</font>{{/discounted}}{{^discounted}}{{total}}{{/discounted}}</strong>
        </td>
    </tr>
    {{/subTotals}}
</script>
    ...
    <table id="shippingOptions">
        ...
        <tr>
            <td style="border: none !important;">
                <input type="radio" name="selectedShippingOption.optionId"
                       code="{{shippingModuleCode}}" class="shippingOption" id="{{optionId}}"
                       value="{{optionId}}" {{#checked}} checked="checked" {{/checked}}>
            </td>
            <td style="border: none !important;">
                <label>
...
<script>
  ...
  $(document).ready(function () {
    ...
    getZones('#billingStateList', '#billingStateProvince',
        ...
        '<c:out value="${order.customer.billing.zone}" />',
        '<c:out value="${order.customer.billing.zone}" />', '${requestScope.LANGUAGE.code}',
        validateForm);
    </c:if>
    ...
    $(".shipping-country-list").change(function () {
      getZones('#deliveryStateList', '#deliveryStateProvince', $(this).val(),
          '<c:out value="${order.customer.delivery.zone}" />',
          '<c:out value="${order.customer.delivery.zone}" />', '${requestScope.LANGUAGE.code}',
          countryListChanged);
            ...
            <div class="col-md-12">
                <div class="coupon-accordion">
                    ...
                    <sec:authorize access="!hasRole('AUTH_CUSTOMER') and !fullyAuthenticated">
                        <p class="muted common-row"><a
                                href="<c:url value="/shop/customer/customLogon.html"/>"><s:message
...
<div class="checkout-area pb-50">
    <div class="container">
        <div class="row">
            ...
            <form:form autocomplete="off" id="checkoutForm" method="POST"
                       enctype="multipart/form-data" modelAttribute="order" action="${commitUrl}">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="checkbox-form">
                        <h3><s:message code="label.customer.billinginformation"
                                       text="Billing information"/></h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.firstname"
                                                      text="First Name"/><span
                                    ...
                                    <form:input id="customer.firstName" cssClass="required"
                                                ...
                                                autofocus="autofocus" title="${msgFirstName}"/>
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.city" text="City"/> <span
                                            class="required">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="country-select">
                                    <label><s:message code="label.generic.country" text="Country"/>
                            ...
                            <sec:authorize
                                ...
                                <div class="col-md-12">
                                    <div class="checkout-form-list create-acc">
                                        ...
                                        <label><s:message code="label.customer.createaccount"
                                                          text="Create an account?"/></label>
                                    </div>
                                    <div id="cbox_info" class="checkout-form-list create-account">
                                        <p><s:message code="label.customer.createaccount.text"
                                                      text="Create an account by entering the information below. If you are a returning customer please login using the link at the top of the page."/></p>
                                        <s:message code="message.password.required"
                                                   text="Password is required" var="msgPassword"/>
                                        <label><s:message code="label.customer.accountpassword"
                                                          text="Account password"/> <span
                                                class="required">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            <label><s:message
                                                    ...
                                                    text="Shipping street address"/> <span
                                                    class="required">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                            <label><s:message
                                                    ...
                                                    text="Shipping postal code"/> <span
                                                    class="required">*</span></label>
                                ...
                                <div class="order-notes">
                                    <div class="checkout-form-list">
                                        ...
                                        <s:message code="label.order.notes.eg"
                                                   text="Notes for the order or delivery"
                                                   var="msgNotes"/>
                    ...
                    <div class="your-order">
                        ...
                        <div class="your-order-table table-responsive">
                            <table id="summary-table"><!-- requires summary-table -->
                                <thead>
                                <tr>
                                    <th class="product-name"><s:message code="label.order.item"
                                                                        text="Item"/></th>
                                    <th class="product-total"><s:message code="label.order.total"
                                                                         text="Total"/></th>
                                </tr>
                                </thead>
                                ...
                                <c:forEach items="${cart.shoppingCartItems}" var="shoppingCartItem">
                                    <tr class="cart_item">
                                        <td class="product-name">
                                                ${shoppingCartItem.name} <strong
                                                class="product-quantity">
                                            x ${shoppingCartItem.quantity}</strong>
                                    ...
                                    <c:if test="${total.orderTotalCode!='order.total.total'}">
                                        <tr id="cart-subtotal-${total.orderTotalCode}"
                                            ...
                                            <td><strong><c:choose><c:when
                                                    ...
                                                    value="${total.value}"/></span></c:when><c:otherwise><sm:monetary
                                ...
                                <c:if test="${shippingQuote!=null}">
                                    <tr class="shipping">
                                        <td class="order-total-label"
                                            ...
                                            <s:message code="label.shipping.fees"
                                                       text="Shipping fees"/>
                                        ...
                                        <td id="shippingSection" style="border:none !important;">
                                            <c:choose>
                                                <c:when test="${fn:length(shippingQuote.shippingOptions)>0}">
                                                    ...
                                                    <table id="shippingOptions">
                                                        <c:forEach
                                                                items="${shippingQuote.shippingOptions}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="border: none !important;">
                                                                    <label>
                                                                        ...
                                                                        <span class="amount">${option.optionPriceText}</span>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                ...
                                                <c:otherwise>
                                                    <c:choose>
                                                        <c:when test="${shippingQuote.freeShipping==true && shippingQuote.freeShippingAmount!=null}">
                                                            <s:message
                                                                    code="label.shipping.freeshipping.over"
                                    ...
                                    <c:forEach items="${paymentMethods}" var="paymentMethod">
                                        ...
                                        <li role="presentation"
                                            ...
                                            <a href="#${paymentMethod.paymentType}"
                                               ...
                                               aria-controls="#${paymentMethod.paymentType}"
                                               role="tab"
                                               data-toggle="tab">
                                ...
                                <c:if
                                    ...
                                    <div class="checkout-box" id="customerAgreementSection"
                                        ...
                                        <label id="customerAgreement" class="checkbox"> <s:message
                                                ...
                                                var="msgAgreement"/> <form:checkbox
                                                path="customerAgreed"
                                        ...
                                        <div id="customer-agreement-area">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <s:message
                                                            code="message.content.missing.agreement"
