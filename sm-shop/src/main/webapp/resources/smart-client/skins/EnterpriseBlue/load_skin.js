...
isc.loadSkin = function (theWindow) {
  ...
  with (theWindow) {
    ...
    if (useCSS3) {
      ...
      isc.ClassFactory.defineClass("IAutoFitButton",
          "AutoFitButton").addProperties({
        baseStyle: "buttonRounded"
      });

      if (isc.IButton.markAsFrameworkClass
          != null) {
        isc.IButton.markAsFrameworkClass();
      }
      if (isc.IAutoFitButton.markAsFrameworkClass
          != null) {
      ...
      if (isc.MenuButton) {
        ...
        if (isc.IMenuButton.markAsFrameworkClass
            != null) {
