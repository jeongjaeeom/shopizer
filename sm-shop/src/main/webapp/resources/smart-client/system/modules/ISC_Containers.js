...
if (window.isc && window.isc.module_Core && !window.isc.module_Containers) {
  ...
  isc._moduleStart = isc._Containers_start = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled(
      'loadTime')))) {
    isc._pTM = {
      message: 'Containers load/parse time: ' + (isc._moduleStart
  ...
  isc.B.push(isc.A.setPane = function isc_ImgTab_setPane(_1) {
      ...
      , isc.A.initWidget = function isc_ImgTab_initWidget(_1, _2, _3, _4, _5,
          _6) {
  ...
  isc.B.push(isc.A.initWidget = function isc_TabBar_initWidget() {
        ...
        _3.vertical = (this.tabBarPosition == isc.Canvas.LEFT || this.tabBarPosition
            == isc.Canvas.RIGHT);
      ...
      , isc.A.isShowingMoreTab = function isc_TabBar_isShowingMoreTab() {
        return (this.showMoreTab && this.moreTab && this.$79t >= 0
            && this.getMembers(this.$79t).isVisible && this.getMembers(
                this.$79t).isVisible())
      }
      ...
      ,
      isc.A.getCloseIconProperties = function isc_TabBar_getCloseIconProperties(_1,
          _2) {
        var _3 = {};
        if (_1.canClose == true || (_1.canClose == null && _2)) {
          _3.icon = (_1.closeIcon || this.parentElement.closeTabIcon);
          _3.iconSize = (_1.closeIconSize
              || this.parentElement.closeTabIconSize);
      ...
      , isc.A.fixLayout = function isc_TabBar_fixLayout() {
        ...
        if (this.tabBarPosition == isc.Canvas.TOP) {
          _1.setRect(this.getScrollLeft(),
              this.getHeight() - this.baseLineThickness,
              this.parentElement.getWidth() - _3, this.baseLineThickness)
        } else if (this.tabBarPosition == isc.Canvas.BOTTOM) {
          _1.setRect(this.getScrollLeft(), 0,
              this.parentElement.getWidth() - _3, this.baseLineThickness)
        } else if (this.tabBarPosition == isc.Canvas.LEFT) {
          _1.setRect(this.getWidth() - this.baseLineThickness,
              this.getScrollTop(), this.baseLineThickness,
              this.parentElement.getHeight() - _3)
        } else if (this.tabBarPosition == isc.Canvas.RIGHT) {
          _1.setRect(0, this.getScrollTop(), this.baseLineThickness,
              this.parentElement.getHeight() - _3)
        }
      }
      , isc.A.layoutChildren = function isc_TabBar_layoutChildren(_1, _2, _3,
          _4) {
      ...
      , isc.A.$7b = function isc_TabBar__scrollForward(_1, _2) {
        if (this.overflow == isc.Canvas.VISIBLE || !this.members
        ...
        if (this.$7c != null) {
          ...
          _4 = (_1 ? (this.vertical ? _3.getTop() : _3.getLeft())
              : (this.vertical ? _3.getBottom() : _3.getRight()))
        } else {
          var _5 = (this.vertical ? this.getScrollHeight()
              : this.getScrollWidth());
          if (_5 <= (this.vertical ? this.getViewportHeight()
              : this.getViewportWidth())) {
            return;
          }
          var _6 = (this.vertical ? this.getScrollTop() : this.getScrollLeft()),
              _7 = (this.vertical ? this.getViewportHeight()
                  : this.getViewportWidth());
          var _8 = 5;
          for (var i = 0; i < this.members.length; i++) {
            _3 = (_1 ? this.members[this.members.length - (i + 1)]
                : this.members[i]);
            _4 = (_1 ? (this.vertical ? _3.getTop() : _3.getLeft())
                : (this.vertical ? _3.getBottom() : _3.getRight()));
      ...
      , isc.A.scrollTabIntoView = function isc_TabBar_scrollTabIntoView(_1, _2,
          _3, _4) {
        var _5;
        ...
        if (_2 == null) {
          if (_5 == 0) {
            _2 = true;
          } else if (_5 == (this.members.getLength()
              - 1)) {
            _2 = false;
          } else {
            if (_9) {
        ...
        this.scrollIntoView(_6[0], _6[1], _6[2], _6[3], _7, _8, _3,
            {target: this, methodName: "scrolledTabIntoView", args: [_1, _4]})
      }
      , isc.A.scrolledTabIntoView = function isc_TabBar_scrolledTabIntoView(_1,
          _2) {
        if (_2 != null) {
  ...
  isc.A.minWidth = 100;
  isc.A.minHeight = 100;
  isc.A.useBackMask = isc.Browser.isIE && isc.Browser.minorVersion >= 5.5
  ...
  isc.A.showHeaderBackground = !(isc.Browser.isIE && !isc.Browser.isStrict
      && isc.Browser.minorVersion >= 5.5);
  isc.A.headerBackgroundConstructor = "Img";
  isc.A.headerBackgroundDefaults = {
    width: "100%",
    height: "100%",
    addAsChild: true,
    vertical: false,
  ...
  isc.A.headerSrc = (!(isc.Browser.isIE && !isc.Browser.isStrict
      && isc.Browser.minorVersion >= 5.5) ? "[SKIN]Window/headerGradient.gif"
      : null);
  ...
  isc.A.headerControls = ["headerIcon", "headerLabel", "minimizeButton",
    "maximizeButton", "closeButton"];
  isc.A.hiliteHeaderStyle = "windowHeaderHilite";
  isc.A.hiliteHeaderSrc = (!(isc.Browser.isIE && isc.Browser.minorVersion
      >= 5.5) ? "[SKIN]Window/headerGradient_hilite.gif" : null);
  ...
  isc.A.minimizeButtonDefaults = {
    ...
    click: function () {
      if (!this.creator.onMinimizeClick || (this.creator.onMinimizeClick()
          != false)) {
  ...
  isc.A.restoreButtonDefaults = {
    ...
    layoutAlign: "center",
    click: function () {
      if (!this.creator.onRestoreClick || (this.creator.onRestoreClick()
          != false)) {
  ...
  isc.A.maximizeButtonDefaults = {
    ...
    layoutAlign: "center",
    click: function () {
      if (!this.creator.onMaximizeClick || (this.creator.onMaximizeClick()
          != false)) {
  ...
  isc.B.push(isc.A.initWidget = function isc_Window_initWidget() {
        if (this.minimized && this.maximized) {
          this.logWarn(
              "Window initialized with maximized and minimized both set to true. "
        ...
        if (!this.$7f && this.items != null) {
          for (var i = 0; i < this.items.length; i++) {
            if (isc.isA.Canvas(this.items[i])
                && this.items[i].isDrawn()) {
              this.items[i].clear()
            }
          }
        }
      ...
      ,
      isc.A.setShowHeaderControl = function isc_Window_setShowHeaderControl(_1,
          _2, _3) {
        var _4 = this.headerControls;
        if (!_4.contains(_1)) {
          this.logWarn("request to show/hide header control with name:" + _1
      ...
      , isc.A.makeFooter = function isc_Window_makeFooter() {
        ...
        for (var i = 0; i < this.footerControls.length; i++) {
          ...
          _4.visibility = this.minimized ? isc.Canvas.HIDDEN
              : isc.Canvas.INHERIT;
      ...
      , isc.A.setStatus = function isc_Window_setStatus(_1) {
        ...
        var _2 = (this.statusBar.leftPadding ? isc.Canvas.spacerHTML(
            this.statusBar.leftPadding, 1) : "");
      ...
      , isc.A.layoutChildren = function isc_Window_layoutChildren(_1, _2, _3,
          _4) {
        if (this.body == null) {
          return;
        }
      ...
      , isc.A.$7h = function isc_Window__matchBodyWidth() {
        ...
        this.logInfo("edgeWidth is: " + _2 + ", setting window width to: " + _3,
            "layout");
        if (this.getWidth() != _3) {
          this.setWidth(_3);
        }
      ...
      , isc.A.show = function isc_Window_show(_1, _2, _3, _4) {
        ...
        if (this.isModal) {
          if (this.modalTarget) {
            if (!isc.isA.Canvas(this.modalTarget) || this.modalTarget.contains(
                this)) {
            ...
            this.logWarn(
                "Window specified with 'isModal' set to true, but this window has a "
                + "parentElement. Only top level Windows can be shown modally.");
            this.isModal = false
          } else {
            this.showClickMask(this.getID() + (this.dismissOnOutsideClick
      ...
      , isc.A.makeModalMask = function isc_Window_makeModalMask() {
        ...
        if (!this.modalMask) {
          this.modalMask = this.createAutoChild("modalMask",
      ...
      isc.A.shouldDismissOnEscape = function isc_Window_shouldDismissOnEscape() {
        ...
        return this.showHeader && this.headerControls && this.showCloseButton
            && this.headerControls.contains("closeButton")
      }
      ...
      , isc.A.minimize = function isc_Window_minimize() {
        ...
        if (this.animateMinimize && this.isDrawn() && this.isVisible()) {
          ...
          this.$7w();
          this.$7k = isc.Animation.registerAnimation(this.animateMinimizeStep,
              (this.minimizeTime || this.animateTime),
              this.minimizeAcceleration || this.animateAcceleration, this)
        } else {
      ...
      , isc.A.$7w = function isc_Window__storeContentRestoreStats() {
        if (this.body) {
          ...
          if (this.$7y == isc.Canvas.VISIBLE) {
            this.body.resizeTo(this.body.getVisibleWidth(),
      ...
      , isc.A.animateMinimizeStep = function isc_Window_animateMinimizeStep(_1,
          _2, _3, _4, _5) {
        var _6 = (!_4 && !_5);
        if (this.maximized && !this.$42u) {
          this.$42v = (this.parentElement ? this.parentElement.getInnerHeight()
              : isc.Page.getHeight());
          this.$42w = (this.parentElement ? this.parentElement.getInnerWidth()
              : isc.Page.getWidth());
          this.$42u = true
        }
        var _7 = this.minimized ? this.$7v : this.maximized ? this.$42v
            : this.$7r, _8 = _4 ? this.$7r : _5 ? this.$42v : this.$7v,
            _9 = this.maximized ? this.$42w : this.$42x,
            _10 = _5 ? this.$42w : this.$42x;
        var _11 = Math.round(_7 + (_1 * (_8 - _7))),
            _12 = (_10 == _9 ? _10 : Math.round(_9 + (_1 * (_10 - _9))));
        var _13 = _11 - this.getVMarginBorder() - (2 * this.layoutMargin) -
            (this.showHeader ? this.header.getHeight() + this.membersMargin
                : 0), _14 = (this.showBody ? this.body : null),
            _15 = (this.showFooter ? this.footer : null), _16 = 0, _17 = 0,
            _18 = (_15 ? this.footerHeight : 0), _19 = this.membersMargin || 0;
        if (_15 != null) {
          if (_13 <= _18) {
            _16 = _13
          } else {
        ...
        if (_15) {
          if (_16 > 0) {
            if (_15.getHeight() != _16) {
              ...
              _15.scrollTo(null, _21 - _15.getViewportHeight(),
                  "animateMinimize")
            }
            if (!_15.isVisible()) {
              _15.show()
        ...
        if (_14) {
          if (_17 > 0) {
            if (_14.getHeight() != _17) {
              ...
              _14.scrollTo(null, _21 - _14.getViewportHeight(),
                  "animateMinimize")
            }
            if (!_14.isVisible()) {
              _14.show()
        ...
        if (_5 || this.maximized) {
          var _22 = (_5 ? this.$42y : 0), _23 = (_5 ? this.$42z : 0),
              _24 = (_5 ? 0 : this.$42y), _25 = (_5 ? 0 : this.$42z);
          this.moveTo(Math.round(_22 + (_1 * (_24 - _22))),
              Math.round(_23 + (_1 * (_25 - _23))), true)
        }
        this.resizeBy((_12 - this.getWidth()), (_11 - this.getHeight()), null,
            null, true);
        if (_1 == 1) {
          delete this.$42u;
          this.$74();
      ...
      ,
      isc.A.animateRestoreStep = function isc_Window_animateRestoreStep(_1, _2,
          _3) {
        this.animateMinimizeStep(_1, _2, _3, true)
      }
      , isc.A.animateMaximizeStep = function isc_Window_animateMaximizeStep(_1,
          _2, _3) {
        this.animateMinimizeStep(_1, _2, _3, null, true)
      }
      ,
      isc.A.isAnimating = function isc_Window_isAnimating(_1, _2, _3, _4, _5) {
        if (this.invokeSuper(isc.Window, "isAnimating", _1, _2, _3, _4,
            _5)) {
          return true;
        }
        ...
        if (this.$7k && ((_1 == null) || (_1.contains("minimize"))
            || (_1.contains("rect")))) {
          return true;
        }
        return false
      ...
      , isc.A.restore = function isc_Window_restore() {
        ...
        if (_1) {
          _1.addProperties(this.minimized ? this.minimizeButtonDefaults
        ...
        if (this.animateMinimize && this.isDrawn() && this.isVisible()) {
          ...
          this.$7w();
          this.$7k = isc.Animation.registerAnimation(this.animateRestoreStep,
              (this.minimizeTime || this.animateTime),
              this.minimizeAcceleration || this.animateAcceleration, this)
        } else {
          this.completeRestore()
      ...
      , isc.A.maximize = function isc_Window_maximize() {
        ...
        if (this.animateMinimize && this.isDrawn() && this.isVisible()) {
          ...
          this.$42w = (this.parentElement ? this.parentElement.getInnerWidth()
              : isc.Page.getWidth());
          this.$7w();
          this.$7k = isc.Animation.registerAnimation(this.animateMaximizeStep,
              (this.minimizeTime || this.animateTime),
              this.minimizeAcceleration || this.animateAcceleration, this)
        } else {
          this.completeMaximize()
  ...
  isc.A.headerControls = ["headerLabel", "minimizeButton", "maximizeButton",
    "closeButton"];
  ...
  isc.B.push(isc.A.setMinHeight = function isc_Portlet_setMinHeight(_1) {
      ...
      , isc.A.maximize = function isc_Portlet_maximize() {
        var _1 = this.getVisibleWidth(), _2 = this.getVisibleHeight(),
            _3 = this.getPageLeft(), _4 = this.getPageTop();
  ...
  isc.B.push(isc.A.initWidget = function isc_PortalColumnHeader_initWidget() {
        ...
        this.addMember(isc.MenuButton.create(
            {title: "Column Properties", width: 150, menu: this.menu}));
        this.addMember(isc.LayoutSpacer.create())
      }
  );
  ...
  isc.B.push(isc.A.initWidget = function isc_PortalRow_initWidget() {
      ...
      , isc.A.prepareForDragging = function isc_PortalRow_prepareForDragging() {
        var _1 = this.ns.EH;
        if (this.hasMember(_1.dragTarget) && _1.dragOperation
            == _1.DRAG_RESIZE) {
          switch (_1.resizeEdge) {
            ...
            case"L":
              ...
              if (_2 > 0) {
                ...
                var _3 = this.portalLayout.getPortalColumnNumber(
                    this.portalColumn);
                if (_3 == 0) {
                  _1.dragTarget = null
                }
      ...
      , isc.A.isHDrop = function isc_PortalRow_isHDrop() {
        ...
        if (_3 < this.hDropOffset || _3 > _2.getVisibleWidth()
            - this.hDropOffset) {
          return true
        } else {
          return false
      ...
      , isc.A.isPortalColumnDrop = function isc_PortalRow_isPortalColumnDrop() {
        ...
        if (_1.isA("Palette")) {
          ...
          if (_4.className == "PortalColumn" || _4.type
              == "PortalColumn") {
            return true
          }
        }
      ...
      isc.A.getDropComponent = function isc_PortalRow_getDropComponent(_1, _2) {
        var _3 = this.portalLayout.getDropPortlet(_1,
            this.portalLayout.getPortalColumnNumber(this.portalColumn),
            this.portalColumn.getPortalRowNumber(this), _2);
        if (this.handleDroppedEditNode) {
          _3 = this.handleDroppedEditNode(_3, _2);
        }
        if (_3) {
          if (!isc.isA.Portlet(_3)) {
            _3 = isc.Portlet.create(
                {autoDraw: false, title: "", items: _3, destroyOnClose: true})
          }
        }
        return _3
      }
      ...
      , isc.A.$87w = function isc_PortalRow__checkPortletMinHeight() {
        this.setMinHeight(
            this.getMembers().map("getMinHeight").max() + this.$2u()
      ...
      , isc.A.addMembers = function isc_PortalRow_addMembers(_1, _2) {
        ...
        if (this.editContext && !this.$86r && !this.portletMaximizing) {
          for (var i = 0; i < _1.length; i++) {
            var _6 = _1[i];
            if (_6.editNode) {
              this.editContext.addNode(_6.editNode, this.editNode, _2 + i, null,
                  true)
            }
          }
        }
  ...
  isc.D[isc.C] = isc.A.Class;
  isc.B.push(
      isc.A.applyStretchResizePolicy = function isc_c_PortalRow_applyStretchResizePolicy(_1,
          _2, _3, _4, _5) {
  ...
  isc.A.respectSizeLimits = true;
  isc.B.push(
      isc.A.getTotalMemberSpace = function isc_PortalColumnBody_getTotalMemberSpace() {
        var _1 = this.Super("getTotalMemberSpace", arguments);
      ...
      ,
      isc.A.getDropComponent = function isc_PortalColumnBody_getDropComponent(_1,
          _2) {
        var _3 = this.creator.portalLayout.getDropPortlet(_1,
            this.creator.portalLayout.getPortalColumnNumber(this.creator), _2,
            null);
        if (this.handleDroppedEditNode) {
          _3 = this.handleDroppedEditNode(_3, _2);
        }
  ...
  isc.D[isc.C] = isc.A.Class;
  isc.B.push(
      isc.A.applyStretchResizePolicy = function isc_c_PortalColumnBody_applyStretchResizePolicy(_1,
          _2, _3, _4, _5) {
  ...
  isc.B.push(
      isc.A.setShowColumnHeader = function isc_PortalColumn_setShowColumnHeader(_1) {
        if (_1) {
      ...
      , isc.A.$87y = function isc_PortalColumn__getDesiredWidth() {
        ...
        if (_1.length == 0) {
          ...
          _2 += this.$2u() + this.getHMarginBorder() + this.rowLayout.$2u()
      ...
      ,
      isc.A.addPortletToExistingRow = function isc_PortalColumn_addPortletToExistingRow(_1,
          _2, _3) {
  ...
  isc.A.rowLayoutDefaults = isc.PortalColumn.getInstanceProperty(
      "rowLayoutDefaults");
  isc.A.columnConstructor = "PortalColumn";
  isc.B.push(
      isc.A.setColumnOverflow = function isc_PortalLayout_setColumnOverflow(_1) {
      ...
      , isc.A.getDropPortlet = function isc_PortalLayout_getDropPortlet(_1, _2,
          _3, _4) {
        return _1
      }
      ,
      ...
      , isc.A.addMembers = function isc_PortalLayout_addMembers(_1, _2) {
        ...
        if (this.editContext && !this.$86t) {
          for (var i = 0; i < _1.length; i++) {
            var _5 = _1[i];
            if (_5.editNode) {
              this.editContext.addNode(_5.editNode, this.editNode, _2 + i, null,
                  true)
            }
          }
        }
      }
      , isc.A.addPortalColumns = function isc_PortalLayout_addPortalColumns(_1,
          _2) {
        this.$86t = true;
        this.addMembers(_1, _2);
        delete this.$86t
      }
      , isc.A.addPortalColumn = function isc_PortalLayout_addPortalColumn(_1,
          _2) {
      ...
      , isc.A.addColumn = function isc_PortalLayout_addColumn(_1) {
        if (this.editContext) {
          var _2 = this.editContext.makeEditNode(
  ...
  isc.D[isc.C] = isc.A.Class;
  isc.B.push(
      isc.A.applyStretchResizePolicy = function isc_c_PortalLayout_applyStretchResizePolicy(_1,
          _2, _3, _4, _5) {
  ...
  isc.A.bodyDefaults = isc.addProperties({},
      isc.Window.getInstanceProperty("bodyDefaults"), {
        layoutTopMargin: 15,
        layoutLeftMargin: 15,
  ...
  isc.A.messageStackDefaults = {
    height: 1,
    layoutMargin: 10,
    layoutBottomMargin: 5,
    membersMargin: 10
  };
  isc.A.autoChildParentMap = isc.addProperties({},
  ...
  isc.A.headerLabelDefaults = isc.addProperties({},
  ...
  isc.A.toolbarDefaults = isc.addProperties({},
      isc.Window.getInstanceProperty("toolbarDefaults"), {
        layoutAlign: "center", width: 20, click: function (_1, _2) {
  ...
  isc.D = isc._funcClasses;
  isc.D[isc.C] = isc.A.Class;
  isc.A.namedLocatorChildren = ["okButton", "applyButton", "yesButton",
    "noButton", "cancelButton", "doneButton"];
  isc.B.push(isc.A.initWidget = function isc_Dialog_initWidget() {
      ...
      , isc.A.createChildren = function isc_Dialog_createChildren() {
        ...
        if (this.message != null) {
          ...
          if (this.icon != null) {
            this.addAutoChild("messageIcon", {src: this.getImgURL(this.icon)},
                isc.Img)
          }
          var _2 = this.message.evalDynamicString(this, {
          ...
          this.addAutoChild("messageLabel",
              {contents: _2, baseStyle: this.messageStyle}, isc.Label)
        }
        if (this.showToolbar) {
          this.makeToolbar()
        }
  ...
  isc.Dialog.Prompt = {
    ...
    bodyDefaults: isc.addProperties({},
        isc.Dialog.getInstanceProperty("bodyDefaults"), {height: "100%"}),
    message: "Loading...&nbsp;${loadingImage}",
    messageStackDefaults: isc.addProperties({},
        isc.Dialog.getInstanceProperty("messageStackDefaults"),
        {height: "100%", width: "100%", layoutAlign: "center"}),
    messageLabelDefaults: isc.addProperties({},
        isc.Dialog.getInstanceProperty("messageLabelDefaults"),
    ...
    showMessage: function (_1, _2) {
      ...
      this.message = _1.evalDynamicString(this, {
        loadingImage: this.imgHTML(isc.Canvas.loadingImageSrc,
            isc.Canvas.loadingImageSize, isc.Canvas.loadingImageSize)
      });
      if (!this.$7f) {
  ...
  isc.addGlobal("showMessage", function (_1, _2, _3, _4) {
    if ((isc.isA.String(_4) || isc.isA.Function(_4)) || (_4 == null
        && isc.isAn.Object(_3) && _3.methodName == null && _3.action == null
        && _3.method == null)) {
      var _5 = _4;
      _4 = _3;
      _3 = _5
    }
    if (!isc.isA.Dialog(isc.Dialog.Warn) || (isc.isA.Function(
        isc.Dialog.Warn.initialized) && !isc.Dialog.Warn.initialized())) {
  ...
  isc.$78 = function (_1) {
    var _2 = this.$79 = this.$79 || ["okClick", "yesClick", "noClick",
  ...
  isc.askForValue = function (_1, _2, _3) {
    ...
    isc.$78(_3);
    _4.setProperties(_3);
    _4.askForm.setValues(
        {message: _1 || "Please enter a value:", value: _3.defaultValue || ""});
    _4.show();
    _4.askForm.focusInItem("value")
  }
  isc.ClassFactory.defineClass("LoginDialog", "Window");
  isc.LoginDialog.registerStringMethods(
      {register: "values, form", lostPassword: "values, form"});
  ...
  isc.A.loginFormDefaults = {
    ...
    submit: function () {
      ...
      this.fireCallback(this.loginDialog.loginFunc,
          "credentials,dialogCallback", _2)
    },
  ...
  isc.B.push(
      isc.A.getDynamicDefaults = function isc_LoginDialog_getDynamicDefaults(_1) {
        switch (_1) {
          case"loginForm":
            var _2 = {
              loginDialog: this,
            ...
            for (var j = 0; j < _3.length; j++) {
              ...
              isc.addProperties(_5, this[_6 + "Defaults"],
                  this[_6 + "Properties"]);
              ...
              var _7 = this["show" + _6.substr(0, 1).toUpperCase() + _6.substr(
                  1)];
              if (null != _7) {
                _5.visible = _7;
              }
            ...
            _2.dataSource = isc.DataSource.create(this.formDSDefaults,
                {fields: _3});
            return _2
        }
        return null
      ...
      , isc.A.init = function isc_LoginDialog_init() {
        ...
        if (this.username) {
          this.loginForm.setValue("usernameItem",
              this.username);
        }
        if (this.password) {
          this.loginForm.setValue("passwordItem",
              this.password)
        }
      }
  );
  ...
  isc.showLoginDialog = function (_1, _2) {
    return isc.LoginDialog.create(
        isc.addProperties({}, _2, {autoDraw: true, loginFunc: _1}))
  }
  ...
  isc.A.optionsGridDefaults = {
    ...
    fields: [{
      ...
      formatCellValue: function (_1, _2, _3, _4, _5) {
        return _3 == 0 ? _5.creator.firstSortLevelTitle
            : _5.creator.otherSortLevelTitle
      }
    }, {
      name: "property",
      title: " ",
    ...
    bodyKeyPress: function (_1) {
      if (_1.keyName == "Delete"
          && this.anySelected()) {
        this.removeSelectedData();
      } else {
        this.Super(
            "bodyKeyPress", arguments)
      }
    },
    extraSpace: 5
  };
  ...
  isc.A.topAutoChildren = ["topLayout", "addLevelButton", "deleteLevelButton",
    "copyLevelButton"];
  isc.A = isc.MultiSortPanel.getPrototype();
  isc.B = isc._allFuncs;
  isc.C = isc.B._maxIndex;
  ...
  isc.B.push(isc.A.getNumLevels = function isc_MultiSortPanel_getNumLevels() {
      ...
      , isc.A.getSort = function isc_MultiSortPanel_getSort() {
        var _1 = this.optionsGrid, _2 = _1.data.duplicate(),
            _3 = _1.getEditRow(),
      ...
      , isc.A.validate = function isc_MultiSortPanel_validate() {
        ...
        for (var i = 0; i < _2.length; i++) {
          ...
          if (_3.contains(_5.property)) {
            var _6 = this, _7 = this.optionsGrid.getField(
                "property").valueMap[_5.property],
                _8 = this.invalidListPrompt.evalDynamicString(this,
                    {title: _7});
      ...
      isc.A.recordFailedValidation = function isc_MultiSortPanel_recordFailedValidation(_1) {
        var _2 = this.optionsGrid,
            _3 = (isc.isA.Number(_1) ? _1 : _2.getRecordIndex(_1)),
      ...
      , isc.A.initWidget = function isc_MultiSortPanel_initWidget() {
        ...
        this.addAutoChild("levelDownButton",
            {prompt: this.levelDownButtonTitle});
      ...
      isc.A.setButtonTitles = function isc_MultiSortPanel_setButtonTitles(_1) {
        if (this.addLevelButton) {
          this.addLevelButton.setTitle(
              this.addLevelButtonTitle);
        }
        if (this.deleteLevelButton) {
          this.deleteLevelButton.setTitle(
              this.deleteLevelButtonTitle);
        }
        if (this.copyLevelButton) {
          this.copyLevelButton.setTitle(
              this.copyLevelButtonTitle)
        }
      }
      , isc.A.setButtonStates = function isc_MultiSortPanel_setButtonStates() {
        var _1 = this.getNumLevels(), _2 = this.maxLevels,
            _3 = this.optionsGrid, _4 = _3.anySelected(),
        ...
        if (this.copyLevelButton) {
          this.copyLevelButton.setDisabled(
              !_4 || _1 >= _2);
        }
        ...
        if (this.levelDownButton) {
          this.levelDownButton.setDisabled(
              !_4 || _5 == _1 - 1)
        }
      }
      ...
      , isc.A.setSortFields = function isc_MultiSortPanel_setSortFields() {
        ...
        var _4 = this.optionsGrid,
            _5 = this.fields ? this.fields.getValueMap(_4.fieldIdProperty,
                "title") : {none: "No fields"}, _6 = isc.getKeys(_5).length;
        for (var _7 in _5) {
      ...
      , isc.A.addLevel = function isc_MultiSortPanel_addLevel() {
        var _1 = this.optionsGrid,
            _2 = _1.getRecordIndex(_1.getSelectedRecord()),
            _3 = _1.getField("property"), _4 = _1.getField("direction"),
            _5 = _2 >= 0 ? _2 + 1 : _1.data.length, _6 = {
              property: isc.firstKey(_3.valueMap),
              direction: isc.firstKey(_4.valueMap)
            };
        _1.data.addAt(_6, _5);
        this.editRecord(_5);
        this.setButtonStates();
  ...
  isc.D[isc.C] = isc.A.Class;
  isc.B.push(
      isc.A.askForSort = function isc_c_MultiSortDialog_askForSort(_1, _2, _3) {
        var _4 = isc.isAn.Array(_1) ? _1 : isc.DataSource && isc.isA.DataSource(
            _1) ? isc.getValues(_1.getFields()) : isc.isA.DataBoundComponent(_1)
            ? _1.getFields() : null;
        if (!_4) {
          return;
        }
        isc.MultiSortDialog.create(
            {autoDraw: true, fields: _4, initialSort: _2, callback: _3})
      }
  );
  isc.B._maxIndex = isc.C + 1;
  ...
  isc.D = isc._funcClasses;
  isc.D[isc.C] = isc.A.Class;
  isc.A.$783 = ["fields", "initialSort", "maxLevels", "invalidListPrompt",
    "addLevelButtonTitle", "addLevelButtonDefaults", "addLevelButtonProperties",
    "deleteLevelButtonTitle", "deleteLevelButtonDefaults",
    "deleteLevelButtonProperties", "levelUpButtonTitle", "levelDownButtonTitle",
    "copyLevelButtonTitle", "copyLevelButtonDefaults",
    "copyLevelButtonProperties", "optionsGridDefaults", "optionsGridProperties",
  ...
  isc.B.push(isc.A.initWidget = function isc_MultiSortDialog_initWidget() {
      ...
      , isc.A.apply = function isc_MultiSortDialog_apply() {
        if (this.optionsGrid.getEditRow()
            != null) {
  ...
  isc.B.push(
      isc.A.setPaneContainerOverflow = function isc_TabSet_setPaneContainerOverflow(_1) {
  ...
  isc.A.$537 = {
    top: "topEdgeSizes",
    bottom: "bottomEdgeSizes",
    left: "leftEdgeSizes",
    right: "rightEdgeSizes"
  };
  isc.A.$538 = {
    top: "topEdgeOffsets",
  ...
  isc.B.push(isc.A.initWidget = function isc_TabSet_initWidget() {
        ...
        if (this.useSimpleTabs) {
          ...
          this.tabProperties.baseStyle = this.simpleTabBaseStyle + _1.substring(0,
              1).toUpperCase() + _1.substring(1);
          var _2 = (this.tabBarPosition == isc.Canvas.LEFT || this.tabBarPosition
              == isc.Canvas.RIGHT);
          if (!_2) {
      ...
      , isc.A.makeTabBar = function isc_TabSet_makeTabBar() {
        ...
        var _1 = (this.tabBarPosition == isc.Canvas.LEFT || this.tabBarPosition
            == isc.Canvas.RIGHT), _2 = this.tabBarAlign;
      ...
      , isc.A.createMoreTab = function isc_TabSet_createMoreTab() {
        ...
        this.moreTabPane = this.createAutoChild("moreTabPane",
            this.moreTabPaneProperties);
      ...
      , isc.A.makePaneContainer = function isc_TabSet_makePaneContainer() {
        ...
        if (this.showPaneContainerEdges
            != null) {
          _1.showEdges = this.showPaneContainerEdges;
        }
        if (this.getPaneContainerEdges && this.getPaneContainerEdges()
            != null) {
      ...
      , isc.A.setTabProperties = function isc_TabSet_setTabProperties(_1, _2) {
        ...
        if (_2.ID != null) {
          this.logWarn(
              "setTabProperties(): Unable to modify ID for an existing tab - ignoring "
              + "this property");
          delete _2.ID
        }
        if (_2.pane != null) {
      ...
      , isc.A.addTabs = function isc_TabSet_addTabs(_1, _2) {
        ...
        var _3 = this.getTabObject(this.getSelectedTabNumber()),
            _4 = (this.getSelectedTabNumber() == -1);
      ...
      , isc.A.tabIconClick = function isc_TabSet_tabIconClick(_1) {
        var _2 = _1.icon;
        if (_2 && _2.click) {
          return this.fireCallback(_2.click, 'tab,tabSet',
              [_1, this])
        }
      }
      ...
      , isc.A.updateTab = function isc_TabSet_updateTab(_1, _2) {
        if (isc.isAn.Object(_1) && !isc.isA.Canvas(_1) && this.tabs.indexOf(_1)
            == -1) {
          if (_2 != null) {
            _1.pane = _2;
          }
      ...
      , isc.A.fixLayout = function isc_TabSet_fixLayout() {
        ...
        var _3 = this.$du(this.tabBarOverlap, _1.borderThickness,
            _1.baseLineThickness);
        var _4;
        switch (this.tabBarPosition) {
          case isc.Canvas.TOP:
            _4 = false;
            _2.setRect(0, _1.getHeight() - _3, this.getWidth(),
                this.getHeight() - _1.getHeight() + _3);
            break;
          case isc.Canvas.BOTTOM:
            _4 = false;
            _1.setTop(this.getHeight() - _1.getHeight());
            _2.setRect(0, 0, this.getWidth(),
                this.getHeight() - _1.getHeight() + _3);
            break;
          case isc.Canvas.LEFT:
            _4 = true;
            _2.setRect(_1.getWidth() - _3, 0,
                this.getWidth() - _1.getWidth() + _3, this.getHeight());
            break;
          case isc.Canvas.RIGHT:
            _4 = true;
            _1.setLeft(this.getWidth() - _1.getWidth());
            _2.setRect(0, 0, this.getWidth() - _1.getWidth() + _3,
                this.getHeight());
            break
        }
        ...
        if (_5) {
          if (_4) {
            _1.setHeight(this.getViewportHeight()
                - this.tabBarControlLayout.getHeight());
          } else {
            _1.setWidth(
                this.getViewportWidth() - this.tabBarControlLayout.getWidth());
          }
        ...
        var _6 = this.$8f();
        if (_4) {
          if (_1.getScrollTop() > 0 && _6
              <= _1.getViewportHeight()) {
            _1.scrollTo(null, 0, "descrollTabs")
          }
        } else {
          if (_1.getScrollLeft() > 0 && _6
              <= _1.getViewportWidth()) {
      ...
      , isc.A.shouldShowControl = function isc_TabSet_shouldShowControl(_1) {
        if ((_1 == "tabScroller") || (_1 == "tabPicker")) {
          ...
          var _6 = (this._tabBar.orientation == isc.Layout.VERTICAL),
              _7 = (_2 > (_6 ? (this.getViewportHeight() - _3)
                  : (this.getViewportWidth() - _3)));
          return _7
        }
        var _1 = this.getControl(_1);
        if (isc.isA.Canvas(_1)) {
          if (_1.showIf) {
            return _1.fireCallback(_1.showIf,
                [_1]);
          } else {
            return true
          }
      ...
      , isc.A.$8f = function isc_TabSet__getTabSizes() {
        ...
        _1 = _1.sum();
        var _3 = (_2 ? (this._tabBar.$td || 0) + (this._tabBar.$te || 0)
            : (this._tabBar.$tb || 0) + (this._tabBar.$tc || 0));
        return _1 + _3
      }
      , isc.A.getControl = function isc_TabSet_getControl(_1) {
        ...
        if (_1 == "tabScroller") {
          if (!this.scroller) {
            ...
            var _5 = this.symmetricScroller ? "back" : this.tabBarPosition
                + "_back",
                _6 = this.symmetricScroller ? "forward" : this.tabBarPosition
                    + "_forward";
            this.scroller = isc.StretchImgButton.create({
              noDoubleClicks: true,
              tabSet: this,
              vertical: _2,
              width: _2 ? (this.tabBarThickness
                  - this._tabBar.baseLineThickness) : (2 * _3),
              height: _2 ? (2 * _3) : (this.tabBarThickness
                  - this._tabBar.baseLineThickness),
              ...
              mouseMove: function () {
                ...
                var _8 = _7 == this.backPartName ? this.forwardPartName
                    : this.backPartName;
          ...
          if (!this.tabPicker) {
            ...
            this.tabPicker = isc.ImgButton.create({
              customState: this.symmetricPickerButton ? null
                  : this.tabBarPosition,
              tabSet: this,
              showRollOver: false,
              skinImgDir: this.skinImgDir,
              src: _11,
              height: (_2 ? _10 : (this.tabBarThickness
                  - this._tabBar.baseLineThickness)),
              width: (_2 ? (this.tabBarThickness
                  - this._tabBar.baseLineThickness) : _10),
              click: function () {
        ...
        this.logWarn(
            "Unable to resolve specified tabBarControl:" + isc.Log.echo(_1)
      ...
      , isc.A.showControls = function isc_TabSet_showControls() {
        ...
        for (var i = 0; i < _1.length; i++) {
          ...
          if (!_8) {
            this.tabBarControlLayout = _8 = this.createAutoChild(
                "tabBarControlLayout", {
        ...
        var _10 = this._tabBar,
            _11 = (this.tabBarThickness - _10.baseLineThickness);
        if (_3 == isc.Canvas.LEFT) {
          this.$8g.setRect(_11, 0, _10.baseLineThickness, this.getHeight())
        } else if (_3 == isc.Canvas.RIGHT) {
          this.$8g.setRect(this.getWidth() - this.tabBarThickness, 0,
              _10.baseLineThickness, this.getHeight())
        } else if (_3 == isc.Canvas.TOP) {
          this.$8g.setRect(0, _11, this.getWidth(), _10.baseLineThickness)
        } else if (_3 == isc.Canvas.BOTTOM) {
          this.$8g.setRect(0, this.getHeight() - this.tabBarThickness,
              this.getWidth(), _10.baseLineThickness)
        }
        if (!_8.isVisible()) {
          _8.show();
        }
      ...
      , isc.A.placeControlLayout = function isc_TabSet_placeControlLayout(_1) {
        var _2, _3, _4, _5, _6 = this._tabBar,
            _7 = _6.getBreadth() - _6.baseLineThickness,
      ...
      , isc.A.$510 = function isc_TabSet__controlLayoutChildResized() {
        ...
        var _4 = this.tabBar;
        if (_4) {
          var _5 = (this.tabBarPosition == isc.Canvas.LEFT
              || this.tabBarPosition == isc.Canvas.RIGHT);
          if (_5) {
            _4.setHeight(this.getViewportHeight()
                - this.tabBarControlLayout.getVisibleHeight())
          } else {
            _4.setWidth(this.getViewportWidth()
                - this.tabBarControlLayout.getVisibleWidth())
          }
        }
      }
      , isc.A.hideControls = function isc_TabSet_hideControls() {
        if (this.tabBarControlLayout
            && this.tabBarControlLayout.isVisible()) {
      ...
      , isc.A.showTabPickerMenu = function isc_TabSet_showTabPickerMenu() {
        ...
        this.$8d.$8h();
        this.$8d.placeNear(this.tabPicker.getPageLeft(),
            this.tabPicker.getPageBottom())
        this.$8d.show()
      }
      ...
      , isc.A.layoutChildren = function isc_TabSet_layoutChildren(_1, _2, _3,
          _4) {
      ...
      , isc.A.$8i = function isc_TabSet__showTab(_1) {
        ...
        if (_1 && _1.pane) {
          if (!this.paneContainer.hasMember(
              _1.pane)) {
      ...
      , isc.A.$8c = function isc_TabSet__tabSelected(_1) {
        var _2;
        var _3 = this.getSelectedTab(), _4 = this.getSelectedTabNumber(),
            _5 = this._tabBar.getButtonNumber(_1), _6 = this.getTabObject(_5),
            _7 = (_3 != null) && (_6 != _3);
        var _8 = this.showMoreTab && this.tabBar.isShowingMoreTab() && _6
            == this.moreTab;
        if (!_8) {
          if (_6 == this.$80n) {
            return;
        ...
        if (_7 && !this.$767) {
          if (_3.tabDeselected != null) {
            if (this.fireCallback(_3.tabDeselected,
                "tabSet,tabNum, tabPane, ID, tab, newTab",
                [this, this.selectedTab, _3.pane, _3.ID, _3, _6]) == false) {
              _2 = true
            }
          }
          if (!_2 && this.tabDeselected != null) {
            _2 = (this.tabDeselected(this.selectedTab, _3.pane, _3.ID, _3, _6)
                == false)
          }
          if (!_2 && _3.pane) {
            _3.pane.hide()
        ...
        if (!this.$767) {
          ...
          if (_6.tabSelected != null) {
            this.fireCallback(_6.tabSelected, "tabSet,tabNum,tabPane,ID,tab",
                [this, _5, _6.pane, _6.ID, _6]);
      ...
      isc.A.getSelectedTabNumber = function isc_TabSet_getSelectedTabNumber() {
        if (!isc.isA.Number(
            this.selectedTab)) {
          this.selectedTab = this.getTabNumber(
              this.selectedTab);
        }
      ...
      , isc.A.editTabTitle = function isc_TabSet_editTabTitle(_1) {
        ...
        if (!isc.isA.DynamicForm(this.titleEditorForm)) {
          var _2 = isc.addProperties({}, this.titleEditorDefaults,
      ...
      , isc.A.saveTabTitle = function isc_TabSet_saveTabTitle() {
        if (this.titleEditorForm != null && this.titleEditorForm.isVisible()
          ...
          var _1 = false, _2 = this.titleEditorForm, _3 = _2.targetTab,
              _4 = _2.getValue("title");
          if (_4 != _3.title && (this.titleChanged != null)) {
            if (this.fireCallback(this.titleChanged, "newTitle, oldTitle, tab",
                [_4, _3.title, _3]) == false) {
              _1 = true
            }
          }
          if (!_1) {
      ...
      , isc.A.showTitleEditor = function isc_TabSet_showTitleEditor() {
        ...
        var _3 = this.tabBar.getLeft() + this.tabBar.getLeftMargin()
            - this.tabBar.getScrollLeft() + this.tabBar.getLeftBorderSize()
            + _2.getLeft() + _2.capSize,
        ...
        _5.setWidth(_4);
        var _6 = this.getTop() + this.tabBar.getTop()
            + this.tabBar.getTopMargin() - this.tabBar.getScrollTop()
            + this.tabBar.getTopBorderSize() + _2.getTop();
      ...
      , isc.A.setVisibility = function isc_TabSet_setVisibility(_1, _2, _3, _4,
          _5) {
        this.invokeSuper("TabSet", "setVisibility", _1, _2, _3, _4, _5);
        if (!this.isVisible() && this.titleEditorForm != null
            && this.titleEditorForm.isDrawn()) {
          this.cancelTitleEditing()
        }
      }
      ,
      isc.A.parentVisibilityChanged = function isc_TabSet_parentVisibilityChanged(_1,
          _2, _3, _4, _5) {
        this.invokeSuper("TabSet", "parentVisibilityChanged", _1, _2, _3, _4,
            _5);
        if (!this.isVisible() && this.titleEditorForm != null
            && this.titleEditorForm.isDrawn()) {
          this.cancelTitleEditing()
  ...
  isc.D[isc.C] = isc.A.Class;
  isc.B.push(
      isc.A.handleKeyPress = function isc_PaneContainer_handleKeyPress(_1, _2) {
        if (_1.keyName == "Tab" && _1.ctrlKey) {
          var _3 = this.parentElement, _4 = _3.tabs.length - 1,
              _5 = _3.getSelectedTabNumber();
          if (_1.shiftKey) {
            if (_5 > 0) {
              _5 -= 1;
            } else {
  ...
  isc._moduleEnd = isc._Containers_end = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) {
    isc.Log.logInfo(
        'Containers module init time: ' + (isc._moduleEnd - isc._moduleStart)
        + 'ms', 'loadTime');
  }
  ...
  if (window.isc && isc.Log && isc.Log.logWarn) {
    isc.Log.logWarn(
        "Duplicate load of module 'Containers'.");
  }
}
/*
 * Isomorphic SmartClient
