...
if (window.isc && window.isc.module_Core && !window.isc.module_SQLBrowser) {
      ...
      , isc.A.execSQL = function isc_SQLEditor_execSQL() {
        ...
        if (_1) {
          ...
          _2.performCustomOperation("dsFromSQL",
              {dbName: this.config.name, sql: _1},
  ...
  isc.A.previewGridStripDefaults = {
    ...
    members: ["autoChild:removeButton", "autoChild:addButton",
      "autoChild:exportButton", "autoChild:generateDSButton", "starSpacer",
  ...
  isc.B.push(isc.A.initWidget = function isc_SQLTableBrowser_initWidget() {
        ...
        _1.performCustomOperation("dsFromTable",
            {schema: this.schema, dbName: this.dbName, tableName: this.config.name},
            this.getID() + ".dsLoaded(data)")
      }
      ...
      , isc.A.showDS = function isc_SQLTableBrowser_showDS() {
        isc.say(this.dataSourceXML.asHTML(), null,
            {blurbProperties: {canSelectText: true, wrap: false}})
      }
  );
  isc.B._maxIndex = isc.C + 3;
  ...
  isc.B.push(isc.A.initWidget = function isc_DBPane_initWidget() {
      ...
      , isc.A.showPane = function isc_DBPane_showPane(_1, _2) {
        ...
        isc.addProperties(_3, _1, {
          canClose: true,
          pane: this.createAutoChild(_1.paneClass,
              {config: _2, dbName: this.config.name})
        });
        this.addTab(_3);
        this.selectTab(_3);
  ...
  isc.B.push(isc.A.initWidget = function isc_DBSchemaTree_initWidget() {
      ...
      , isc.A.selectionChanged = function isc_DBSchemaTree_selectionChanged(_1,
          _2) {
      ...
      isc.A.getExpansionComponent = function isc_DBSchemaTree_getExpansionComponent(_1) {
        ...
        isc.DMI.call("isc_builtin", "com.isomorphic.tools.BuiltinRPC",
            "getFieldsFromTable", _1.name, this.schema, this.serverType,
            this.db.name, function (_3, _4) {
              _2.setData(_4)
            });
        return _2
      }
      ...
      , isc.A.loadSchema = function isc_DBSchemaTree_loadSchema(_1) {
        ...
        isc.DMI.call("isc_builtin", "com.isomorphic.tools.BuiltinRPC",
            "getTables", this.serverType, _1.name, true, true, this.catalog,
            this.schema, this.includeList, this.excludeList,
      ...
      , isc.A.loadSchemaReply = function isc_DBSchemaTree_loadSchemaReply(_1) {
        ...
        this.setData(
            isc.ResultSet.create({dataSource: this.dataSource, allRows: _1}));
        this.sort("name");
      ...
      , isc.A.cellHoverHTML = function isc_DBList_cellHoverHTML(_1) {
        if (!this.hoverDV) {
          this.hoverDV = isc.DetailViewer.create(
              {dataSource: this.dataSource, width: 200, autoDraw: false});
        }
  ...
  isc.B.push(isc.A.initWidget = function isc_SQLBrowser_initWidget() {
      ...
      , isc.A.showDBPane = function isc_SQLBrowser_showDBPane() {
        var _1 = this.db;
        this.showPane({
          ID: this.escapeForId("db_" + _1.name),
          title: _1.name,
          paneClass: "dbPane"
        }, _1)
      }
