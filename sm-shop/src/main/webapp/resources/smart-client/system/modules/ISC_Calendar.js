...
if (window.isc && window.isc.module_Core && !window.isc.module_Calendar) {
  ...
  isc._moduleStart = isc._Calendar_start = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled(
      'loadTime')))) {
    isc._pTM = {
      message: 'Calendar load/parse time: ' + (isc._moduleStart
  ...
  isc.B.push(isc.A.initWidget = function isc_Calendar_initWidget() {
      ...
      isc.A.autoDetectFieldNames = function isc_Calendar_autoDetectFieldNames() {
        ...
        var _1 = this.dataSource, _2 = isc.getValues(_1.getFields()),
            _3 = 1024000, _4;
        ...
        if (this.fieldIsMissing(this.startDateField, _1)) {
          ...
          for (var i = 0; i < _2.length; i++) {
            ...
            if ((_6.type == "date" || _6.type == "datetime")) {
              if (_6.name.toLowerCase().indexOf("start") >= 0
                  || _6.name.toLowerCase().indexOf("begin") >= 0) {
        ...
        if (this.fieldIsMissing(this.endDateField, _1)) {
          ...
          for (var i = 0; i < _2.length; i++) {
            var _6 = _2.get(i);
            if ((_6.type == "date" || _6.type == "datetime")) {
              if (_6.name.toLowerCase().indexOf("end") >= 0
                  || _6.name.toLowerCase().indexOf("stop") >= 0) {
      ...
      , isc.A.hasData = function isc_Calendar_hasData() {
        if (!this.data || (isc.ResultSet && isc.isA.ResultSet(this.data)
      ...
      , isc.A.getDayDiff = function isc_Calendar_getDayDiff(_1, _2, _3) {
        ...
        var _6 = Date.UTC(_5.getFullYear(), _5.getMonth(), _5.getDate(), 0, 0,
            0);
        var _7 = Date.UTC(_4.getFullYear(), _4.getMonth(), _4.getDate(), 0, 0,
            0);
        var _8 = _6 - _7;
        if (_3) {
      ...
      , isc.A.getEventLeft = function isc_Calendar_getEventLeft(_1, _2) {
        ...
        if (_3.$53i) {
          var _7 = this.getDayDiff(_1[this.startDateField],
              this.chosenWeekStart, (this.showWeekends == false));
          _5 = (_7 * _6) + (_4 ? _3.labelColumnWidth : 0)
        }
        if (this.logIsDebugEnabled("calendar")) {
          this.logDebug(
              'calendar.getEventLeft() = ' + _5 + ' for:' + isc.Log.echoFull(
              _1), 'calendar')
        }
        return _5
      }
      ...
      isc.A.addEvent = function isc_Calendar_addEvent(_1, _2, _3, _4, _5, _6) {
        ...
        if (isc.isA.Date(_1)) {
          ...
          isc.logWarn(
              'addEvent error: startDate parameter must be either a Date or an event record (Object)');
          return
        }
        var _8 = this;
        ...
        if (this.dataSource) {
          isc.DataSource.get(this.dataSource).addData(_7, _9,
              {componentId: this.ID});
          return
        } else {
          this.$53e = true;
      ...
      , isc.A.removeEvent = function isc_Calendar_removeEvent(_1, _2) {
        ...
        if (this.dataSource) {
          isc.DataSource.get(this.dataSource).removeData(_1, _6,
              {componentId: this.ID, oldValues: _1});
          return
        } else {
          this.data.remove(_1);
          _6()
      ...
      ,
      isc.A.updateEvent = function isc_Calendar_updateEvent(_1, _2, _3, _4, _5,
          _6, _7) {
        if (_7 == null) {
          _7 = true;
        }
      ...
      , isc.A.eventsAreSame = function isc_Calendar_eventsAreSame(_1, _2) {
        if (this.dataSource) {
          var _3 = isc.DataSource.get(this.dataSource),
              _4 = _3.getPrimaryKeyFieldNames(), _5 = true;
      ...
      , isc.A.getEventHoverHTML = function isc_Calendar_getEventHoverHTML(_1,
          _2) {
        var _3 = this;
        var _4 = _1[_3.startDateField].toShortDate(this.dateFormatter);
        var _5 = isc.Time.toTime(_1[_3.startDateField], this.timeFormatter,
            true);
        var _6 = isc.Time.toTime(_1[_3.endDateField], this.timeFormatter, true);
        return _4 + "&nbsp;" + _5 + "&nbsp;-&nbsp;" + _6 + "</br></br>"
            + _1[_3.nameField] + "</br></br>" + _1[_3.descriptionField]
      }
      , isc.A.$53b = function isc_Calendar__shouldRefreshDay(_1, _2) {
        if (!this.dayView) {
          return false;
        }
        var _3 = new Date(this.year, this.month, this.chosenDate.getDate(), 0,
            0);
        var _4 = new Date(this.year, this.month, this.chosenDate.getDate(), 23,
            59);
        if (this.dayView.body && _3.getTime() <= _1.getTime() && _4.getTime()
            >= _1.getTime()) {
          return true
        } else {
          return false
      ...
      , isc.A.$53c = function isc_Calendar__shouldRefreshWeek(_1, _2) {
        ...
        if (this.weekView.body && this.chosenWeekStart.getTime() <= _1.getTime()
            && _3.getTime() >= _2.getTime()) {
          return true
        } else {
          return false
        }
      ...
      , isc.A.$53g = function isc_Calendar__getEventsInRange(_1, _2) {
        ...
        for (var i = 0; i < this.data.getLength(); i++) {
          ...
          if (_6[this.startDateField].getTime() >= _1.getTime()
              && _6[this.startDateField].getTime() <= _2.getTime()
              && (this.showWeekends || !_4.contains(
                  _6[this.startDateField].getDay()))) {
            _3.add(_6)
          }
        }
        return _3
      ...
      , isc.A.$64h = function isc_Calendar__getEventsTouchingRange(_1, _2, _3) {
        var _4 = [], _5 = Date.getWeekendDays(), _6 = _1.getTime(),
            _7 = this.getDayEnd(_1),
            _8 = _2.getHours() != 0 ? _2.getTime() : _7.getTime(), _9 = _6,
            _10 = _8, _11 = false;
        var _12 = (_2.getHours() == 0 || Date.compareDates(_1, _2) < 0) ? _7
            : _2;
        while (!_11) {
          for (var i = 0; i < this.data.getLength(); i++) {
      ...
      , isc.A.$64i = function isc_Calendar__findEventWindow(_1, _2) {
        ...
        if (this.dataSource) {
          this.$53s = isc.DataSource.get(
              this.dataSource).getLocalPrimaryKeyFields();
        }
        for (var i = 0; i < _4.length; i++) {
          if (isc.isAn.EventWindow(_4[i]) && _3.areSame(_4[i].event, _1)
              && _4[i].$53i == _2) {
            return _4[i]
          }
        }
      ...
      , isc.A.$64j = function isc_Calendar__prepareAutoArrangeOffsets(_1, _2) {
        var _3 = [], _4 = 60 / this.eventSnapGap, _5 = 24 * _4,
            _6 = [new Array(_5), new Array(_5), new Array(_5), new Array(_5),
              new Array(_5), new Array(_5), new Array(_5)];
        for (var i = 0; i < _5; i++) {
          _3.add({
        ...
        for (var i = 0; i < _1.getLength(); i++) {
          ...
          var _10 = _8[this.startDateField].getUTCHours(),
              _11 = _8[this.startDateField].getUTCMinutes(),
          ...
          var _13 = _8[this.endDateField].getDay(),
              _14 = _8[this.endDateField].getUTCHours(),
              _15 = _8[this.endDateField].getUTCMinutes(),
              _16 = _15 % this.eventSnapGap;
          if (_13 > _9) {
            _14 = 24;
            _15 = 0;
            _16 = 0
          ...
          var _17 = (_10 * _4) + (_11 / this.eventSnapGap),
              _18 = (_14 * _4) + (_15 / this.eventSnapGap);
          _8.$64k = 0;
          _8.$64l = 0;
          _8.$85h = _17;
          _8.$85i = _18;
      ...
      , isc.A.getDayEnd = function isc_Calendar_getDayEnd(_1) {
        return new Date(_1.getFullYear(), _1.getMonth(), _1.getDate(), 23, 59,
            59)
      }
      , isc.A.$64n = function isc_Calendar__renderEventRange(_1, _2, _3) {
        ...
        var _5 = _4.getRowHeight(1),
            _6 = _4.getColumnWidth(_4.isLabelCol(0) ? 1 : 0);
        var _7 = _2, _8 = _3;
        if (Date.compareDates(_7, _8) < 0 || (_8.getHours() == 0)) {
          _8 = this.getDayEnd(_7)
        }
        var _9 = this.$64h(_7, _8, true);
        _9.sortByProperties([this.startDateField, this.endDateField],
            [true, false]);
        ...
        for (var i = 0; i < _9.getLength(); i++) {
          var _13 = _9.get(i), _14 = _13[this.startDateField],
              _15 = _13[this.endDateField];
          var _16 = _14.getDay();
          var _17 = _10[_16];
      ...
      isc.A.getTimeSlotsTouchedByEventRange = function isc_Calendar_getTimeSlotsTouchedByEventRange(_1) {
        var _2 = this.$64h(_1[this.startDateField], _1[this.endDateField],
            true);
      ...
      , isc.A.$529 = function isc_Calendar__setChosenWeek() {
        var _1 = this.chosenWeekStart = new Date(this.year, this.month,
        ...
        this.chosenWeekEnd = new Date(_1.getFullYear(), _1.getMonth(),
            _1.getDate() + 6, 23, 59);
      ...
      , isc.A.setChosenDate = function isc_Calendar_setChosenDate(_1) {
        ...
        var _2 = new Date(this.$53h.getFullYear(), this.$53h.getMonth(),
            this.$53h.getDate() - this.$53h.getDay());
      ...
      , isc.A.previous = function isc_Calendar_previous() {
        if (this.dayViewSelected()) {
          var _1 = new Date(this.year, this.month,
      ...
      , isc.A.$653 = function isc_Calendar__getTabs() {
        ...
        if (this.showDayView != false) {
          ...
          _1.add(
              {title: this.dayViewTitle, pane: this.dayView, viewName: "day"})
        }
      ...
      , isc.A.createChildren = function isc_Calendar_createChildren() {
        ...
        if (this.showControlsBar != false) {
          ...
          this.addEventButton = this.createAutoChild("addEventButton", {
            click: function () {
              ...
              _3.eventDialog.setPageTop(
                  this.getPageTop() + this.getVisibleHeight());
              _3.eventDialog.show()
            }
          });
        ...
        this.eventDialog = this.createAutoChild("eventDialog", {
          items: [isc.DynamicForm.create({
            ...
            createFields: function (_37) {
              ...
              var _17 = isc.DataSource.create(
                  {addGlobalId: false, fields: _16});
              this.setDataSource(_17);
              this.setFields(isc.shallowClone(this.calendar.eventDialogFields))
            },
            submit: function () {
              var _3 = this.calendar, _18 = _3.eventDialog.event,
                  _19 = _3.eventDialog.currentStart,
                  _20 = _3.eventDialog.currentEnd;
              if (!this.validate()) {
                return;
              }
              if (_18) {
                _3.updateEvent(_18, _19, _20,
                    this.getItem(this.calendar.nameField).getValue(),
                    _18[_3.descriptionField], this.getCustomValues(), true);
                _3.eventDialog.hide()
              } else {
                _3.addEvent(_19, _20,
                    this.getItem(this.calendar.nameField).getValue(), "",
            ...
            if (!_38) {
              if (_37.getHours() == 23 && _37.getMinutes() == 30) {
                _38 = new Date(_37.getFullYear(), _37.getMonth(),
                    _37.getDate() + 1)
              } else {
                _38 = new Date(_37.getFullYear(), _37.getMonth(), _37.getDate(),
                    _37.getHours() + 1, _37.getMinutes())
              }
            }
            ...
            this.setDate(_37[this.creator.startDateField],
                _37[this.creator.endDateField]);
            _21.getItem(this.creator.nameField).setValue(
                _37[this.creator.nameField])
          }, closeClick: function () {
        ...
        this.eventEditor = this.createAutoChild("eventEditor", {
          ...
          $642: ["startHours", "startMinutes", "startAMPM", "endHours",
        ...
        this.eventEditorLayout = this.createAutoChild("eventEditorLayout", {
          items: [this.eventEditor, isc.HLayout.create({
            ...
            members: [isc.IButton.create({
              ...
              calendar: this,
              click: function () {
                var _3 = this.calendar, _18 = _3.eventEditorLayout.event,
                    _25 = _3.eventEditor,
                    _26 = _25.getItem("startHours").getValue(),
                    _27 = _25.getItem("endHours").getValue(),
                ...
                var _19 = _3.eventEditorLayout.currentStart,
                    _20 = _3.eventEditorLayout.currentEnd;
                ...
                _20.setMinutes(_29);
                if (_18) {
                  var _32 = _3.eventEditorLayout.originalStart,
                      _33 = _3.eventEditorLayout.originalEnd;
                  _3.updateEvent(_18, _19, _20, _25.getItem("name").getValue(),
                      _25.getItem("description").getValue(),
                      _25.getCustomValues(), true);
                  if (_3.eventAutoArrange) {
                    _3.$64n(_3.weekViewSelected(), _32, _33)
                  }
                  _3.eventEditorLayout.hide()
                } else {
                  _3.addEvent(_19, _20, _25.getItem("name").getValue(),
                      _25.getItem("description").getValue(),
                      _25.getCustomValues(), true);
                  _3.eventEditorLayout.hide()
                }
            ...
            this.currentStart = _37;
            this.currentEnd = _38;
            this.items[0].getItem("startHours").setValue(
                this.getHours(_37.getHours()));
            this.items[0].getItem("endHours").setValue(
                this.getHours(_38.getHours()));
            this.items[0].getItem("startMinutes").setValue(_37.getMinutes());
            this.items[0].getItem("endMinutes").setValue(_38.getMinutes());
            if (!_3.twentyFourHourTime) {
              this.items[0].getItem("startAMPM").setValue(
                  this.getAMPM(_37.getHours()));
              this.items[0].getItem("endAMPM").setValue(
                  this.getAMPM(_38.getHours()))
            }
            ...
            this.items[0].getItem("description").setValue(
                _37[this.creator.descriptionField]);
        ...
        if (this.mainView.isA("TabSet")) {
          ...
          if (this.showControlsBar != false) {
            ...
            _36.addMember(
                isc.LayoutSpacer.create({autoDraw: false, width: "*"}));
            _36.addMember(this.controlsBar);
            _36.addMember(
                isc.LayoutSpacer.create({autoDraw: false, width: "*"}));
            _34.add(isc.VLayout.create(
                {autoDraw: false, members: [_36, this.mainView]}))
          } else {
            _34.add(this.mainView)
          }
        }
        this.children.add(isc.HLayout.create(
            {autoDraw: false, width: "100%", height: "100%", members: _34}));
  ...
  isc.B.push(isc.A.setDateLabel = function isc_Calendar_setDateLabel() {
        ...
        if (this.dayViewSelected()) {
          this.dateDisplay.setContents(
              "<b>" + Date.getFormattedDateRangeString(this.chosenDate) + "</b>")
        } else if (this.weekViewSelected()) {
          var _1 = this.$656();
          var _2 = _1[0];
          var _3 = _1[1];
          this.dateDisplay.setContents(
              "<b>" + Date.getFormattedDateRangeString(_2, _3) + "</b>")
        } else if (this.monthViewSelected()) {
          this.dateDisplay.setContents(
              "<b>" + this.chosenDate.getShortMonthName() + " "
              + this.chosenDate.getFullYear() + "</b>")
        } else if (this.timelineViewSelected()) {
          var _4 = this.timelineView, _5 = _4.startDate, _6 = _4.endDate;
          var _7 = "<b>" + _4.formatDateForDisplay(_5) + "</b> through <b>"
              + _4.formatDateForDisplay(_6) + "</b>";
      ...
      , isc.A.dayViewSelected = function isc_Calendar_dayViewSelected() {
        if (this.mainView && !this.mainView.isA(
            "TabSet")) {
          return this.mainView.viewName
              == "day";
        } else {
          return this.$567 == "day"
        }
      ...
      , isc.A.$53j = function isc_Calendar__showEventEditor(_1) {
        ...
        if (_1) {
          ...
          if (this.eventEditorFields) {
            this.eventEditorLayout.items[0].setCustomValues(
                this.eventDialog.items[0].getCustomValues())
          }
          var _2 = this.eventDialog.items[0].getValue(this.nameField);
          this.eventEditorLayout.setDate(this.eventDialog.currentStart,
              this.eventDialog.currentEnd, _2)
        }
      ...
      , isc.A.$53k = function isc_Calendar__getEventDialogTitle(_1, _2) {
        ...
        var _5 = isc.Time.toTime(_1, this.timeFormatter, true),
            _6 = isc.Time.toTime(_2, this.timeFormatter, true);
        var _7 = _5 + " - " + _6;
        return _3[_1.getDay()] + ", " + _4[_1.getMonth()] + " " + _1.getDate()
            + ", " + _7
      }
      ...
      ,
      isc.A.monthViewEventClick = function isc_Calendar_monthViewEventClick(_1,
          _2, _3) {
      ...
      , isc.A.getDayBodyHTML = function isc_Calendar_getDayBodyHTML(_1, _2, _3,
          _4, _5) {
        var _6 = _1.getDay();
        var _7 = _2, _8 = 15,
        ...
        var _11 = "";
        for (var i = 0; i < _7.length; i++) {
          var _13 = isc.Time.toTime(_7[i][this.startDateField],
              this.timeFormatter, true) + " ";
          if (this.canEditEvent(_7[i])) {
            var _14 = "<a href='javascript:" + this.ID + ".monthViewEventClick("
                + _4 + "," + _5 + "," + i + ");' class='"
      ...
      , isc.A.getDayHeaderHTML = function isc_Calendar_getDayHeaderHTML(_1, _2,
          _3, _4, _5) {
        return _1.getDate()
      }
      , isc.A.dayBodyClick = function isc_Calendar_dayBodyClick(_1, _2, _3, _4,
          _5) {
        return true
      }
      , isc.A.dayHeaderClick = function isc_Calendar_dayHeaderClick(_1, _2, _3,
          _4, _5) {
        return true
      }
      ...
      , isc.A.selectTab = function isc_Calendar_selectTab(_1) {
        if (this.mainView && this.mainView.isA("TabSet")
            && this.mainView.tabs.getLength() > _1) {
      ...
      , isc.A.setTimelineRange = function isc_Calendar_setTimelineRange(_1, _2,
          _3, _4, _5) {
        if (this.timelineView) {
          this.timelineView.setTimelineRange(_1, _2, _3,
              _4);
        }
        if (_5) {
  ...
  isc.DaySchedule.changeDefaults("bodyProperties",
      {childrenSnapToGrid: true, snapToCells: true, redrawOnResize: true});
  ...
  isc.B.push(isc.A.initWidget = function isc_DaySchedule_initWidget() {
        ...
        if (this.$53i && !this.creator.showWeekends) {
          var _6 = this.showLabelColumn && this.labelColumnPosition == "left" ? 1
              : 0;
          var _7 = Date.getWeekendDays();
      ...
      , isc.A.isLabelCol = function isc_DaySchedule_isLabelCol(_1) {
        if (_1 == 0 && this.showLabelColumn && this.labelColumnPosition
            == "left") {
          return true
        } else if (_1 == this.fields.length - 1 && this.showLabelColumn
      ...
      , isc.A.colDisabled = function isc_DaySchedule_colDisabled(_1) {
        var _2 = this.$53i ? this.getDayFromCol(_1)
            : this.creator.chosenDate.getDay();
        if (this.creator.disableWeekends && Date.getWeekendDays().contains(
            _2)) {
          return true
        } else {
          return false
      ...
      isc.A.cellMouseDown = function isc_DaySchedule_cellMouseDown(_1, _2, _3) {
        ...
        if (this.creator.backgroundMouseDown
            && this.creator.backgroundMouseDown(_4) == false) {
          return;
        }
      ...
      , isc.A.getBaseStyle = function isc_DaySchedule_getBaseStyle(_1, _2, _3) {
        ...
        var _4 = this.$53i ? this.getDayFromCol(_3)
            : this.creator.chosenDate.getDay();
        var _5 = this.$53i ? this.getDateFromCol(_3)
            : this.creator.chosenDate.duplicate(), _6 = _5.duplicate(),
            _7 = _5.duplicate(),
            _8 = isc.Time.parseInput(this.creator.workdayStart),
        ...
        _7 = _7.getTime();
        if (this.creator.showWorkday && _5.getTime() <= _7 && _7 < _6.getTime()
            && _10) {
      ...
      , isc.A.sizeEventWindow = function isc_DaySchedule_sizeEventWindow(_1) {
        ...
        if (!_1.$53v) {
          if (_2.eventAutoArrange) {
            ...
            var _5 = _4.getRowHeight(1),
                _6 = _4.getColumnWidth(_4.isLabelCol(0) ? 1 : 0);
            var _7 = _3[_2.endDateField].getHours() == 0 ? 24
                : _3[_2.endDateField].getHours();
            var _8 = false;
            if (_3[_2.endDateField].getDate()
                > _3[_2.startDateField].getDate()) {
              _8 = true;
              _7 = 24
            }
            var _9 = (_7 - _3[_2.startDateField].getHours()) * (_5 * 2),
                _10 = _6;
  ...
  isc.MonthSchedule.changeDefaults("headerButtonProperties",
      {showRollOver: false, showDown: false, cursor: "default"});
  ...
  isc.B.push(isc.A.initWidget = function isc_MonthSchedule_initWidget() {
        ...
        this.fields = [{name: "day1", align: "center"},
          {name: "day2", align: "center"}, {name: "day3", align: "center"},
          {name: "day4", align: "center"}, {name: "day5", align: "center"},
          {name: "day6", align: "center"}, {name: "day7", align: "center"}];
      ...
      , isc.A.getDayArray = function isc_MonthSchedule_getDayArray() {
        var _1 = [], _2, _3,
            _4 = new Date(this.creator.year, this.creator.month, 1);
      ...
      isc.A.getEventRowObject = function isc_MonthSchedule_getEventRowObject(_1,
        ...
        for (var i = 0; i < 7; i++) {
          ...
          while (this.$53t < _2.length) {
            var _7 = _2[this.$53t];
            if (_7[this.creator.startDateField].getMonth() != _4.getMonth()
                || _7[this.creator.startDateField].getDate() != _4.getDate()) {
              break
            } else {
              _6.add(_7);
              this.$53t += 1
      ...
      , isc.A.rowIsHeader = function isc_MonthSchedule_rowIsHeader(_1) {
        var _2 = this.creator;
        if (!_2.showDayHeaders || (_2.showDayHeaders && _1 % 2
            == 1)) {
          return false;
        } else {
          return true
      ...
      ,
      isc.A.formatCellValue = function isc_MonthSchedule_formatCellValue(_1, _2,
          _3, _4) {
        var _5 = this.creator, _6 = this.fields.get(_4).$66b,
            _7 = _2["event" + _6], _8 = _2["date" + _6],
      ...
      , isc.A.getRowHeight = function isc_MonthSchedule_getRowHeight(_1, _2) {
        ...
        if (this.rowIsHeader(_2)) {
          ...
          var _4 = _3 ? this.data.length / 2 : this.data.length,
              _5 = _3 ? this.body.getViewportHeight()
                  - (this.dayHeaderHeight * _4) : this.body.getViewportHeight(),
              _6 = _3 ? this.mimimumDayHeight - this.dayHeaderHeight
      ...
      , isc.A.getCellVAlign = function isc_MonthSchedule_getCellVAlign(_1, _2,
          _3) {
        if (!this.rowIsHeader(_2)) {
          return "top";
        } else {
      ...
      , isc.A.cellHoverHTML = function isc_MonthSchedule_cellHoverHTML(_1, _2,
          _3) {
        ...
        if (!this.rowIsHeader(_2) && _1["event" + _4] != null) {
          ...
          for (var i = 0; i < _5.length; i++) {
            var _8 = isc.Time.toTime(_5[i][this.creator.startDateField],
                this.creator.timeFormatter, true);
      ...
      isc.A.getBaseStyle = function isc_MonthSchedule_getBaseStyle(_1, _2, _3) {
        ...
        var _6;
        if (this.rowIsHeader(_2)) {
          if ((_2 == 0 && _1["day" + _5] > 7) || (_2 == this.data.length - 2
              && _1["day" + _5] < 7)) {
            if (!_4.showOtherDays) {
          ...
          var _7 = this.colDisabled(_3), _8 = _4.showDayHeaders ? 1 : 0,
              _9 = this.data.length - 1;
          if ((_2 == _8 && this.data[_8]["day" + _5] > 7) || (_2 == _9
              && this.data[_9]["day" + _5] < 7)) {
            if (!_4.showOtherDays) {
              return _4.otherDayBlankStyle;
            } else {
              _6 = _7
                  ? _4.otherDayBodyBaseStyle + "Disabled"
                  : _4.otherDayBodyBaseStyle
            }
          } else {
            _6 = _7 ? _4.dayBodyBaseStyle + "Disabled"
                : _4.dayBodyBaseStyle
          }
        }
        return _6
      ...
      , isc.A.cellClick = function isc_MonthSchedule_cellClick(_1, _2, _3) {
        var _4 = this.creator, _5, _6, _7 = this.fields.get(_3).$66b,
            _8 = _1["date" + _7], _9 = _1["event" + _7],
  ...
  isc.EventWindow.changeDefaults("resizerDefaults",
      {overflow: "hidden", height: 3, snapTo: "B", canDragResize: true})
  ...
  isc.B.push(isc.A.initWidget = function isc_EventWindow_initWidget() {
      ...
      , isc.A.makeFooter = function isc_EventWindow_makeFooter() {
        ...
        var _1 = this.createAutoChild("resizer",
            {dragTarget: this, styleName: this.baseStyle + "Resizer"});
        this.addChild(_1);
        if (this.resizer) {
      ...
      isc.A.renderEvent = function isc_EventWindow_renderEvent(_1, _2, _3, _4) {
        ...
        var _7 = isc.Time.toTime(_6[_5.startDateField],
            this.calendar.timeFormatter, true);
      ...
      isc.A.dragRepositionStop = function isc_EventWindow_dragRepositionStop() {
        var _1 = this.calendar;
        var _2 = this.event[_1.startDateField],
            _3 = this.event[_1.endDateField];
        this.Super('dragRepositionStop', arguments);
        var _4 = this.ns.EH, _5 = this.parentElement.getEventColumn(),
            _6 = (_4.dragMoveTarget.getTop() - this.parentElement.getPageTop())
        ...
        var _12 = new Date(_10.getFullYear(), _10.getMonth(), _10.getDate(),
            _10.getHours(), _10.getMinutes());
        _12.setMinutes(_12.getMinutes() + this.getEventLength());
        _1.updateEvent(this.event, _10, _12, this.event[_1.nameField],
            this.event[_1.descriptionField], null, true);
      ...
      , isc.A.dragResizeStart = function isc_EventWindow_dragResizeStart() {
        var _1 = (this.getTop() + this.getVisibleHeight())
            % this.parentElement.snapVGap;
        this.parentElement.VSnapOrigin = _1
      }
      , isc.A.dragResizeStop = function isc_EventWindow_dragResizeStop() {
        ...
        var _4 = this.ns.EH, _5 = this.parentElement.getEventColumn(),
            _6 = (_4.dragMoveTarget.getTop() - this.parentElement.getPageTop())
                + this.parentElement.getScrollTop()
                + _4.dragMoveTarget.getVisibleHeight(),
            _7 = this.parentElement.getRowSize(1), _8 = Math.floor(_6 / _7);
        var _9 = _1.$53m(_8, _5);
        ...
        _1.updateEvent(this.event, this.event[_1.startDateField], _9,
            this.event[_1.nameField], this.event[_1.descriptionField], null,
            true);
        if (_1.eventAutoArrange) {
          _1.$64n(this.$53i, _2, _3);
          _4.dragMoveTarget.setPageRect(this.getPageLeft(), this.getPageTop())
  ...
  isc.B.push(isc.A.initWidget = function isc_TimelineWindow_initWidget() {
      ...
      isc.A.dragRepositionStop = function isc_TimelineWindow_dragRepositionStop() {
        ...
        var _6 = [_5[_4.startDateField].duplicate(),
          _5[_4.endDateField].duplicate()];
        ...
        _6[1] = _11;
        var _12 = Math.floor(
            (_10.getTime() - _5[_4.startDateField].getTime()) / (1000 * 60));
        ...
        this.calendar.updateEvent(_5, _6[0], _6[1], _5[_4.nameField],
            _5[_4.descriptionField], _13, true);
        return true
      }
      , isc.A.checkForOverlap = function isc_TimelineWindow_checkForOverlap(_1,
          _2, _3, _4) {
        ...
        if (_7.length == 0) {
          ...
          if (Date.compareDates(_2, _8[_9]) == 1 && Date.compareDates(_3,
              _8[_9]) == -1) {
            _3 = _8[_9].duplicate();
            _2 = _3.duplicate();
            ...
            return [_2, _3]
          } else if (Date.compareDates(_2, _8[_10]) == 1 && Date.compareDates(
              _3, _8[_10]) == -1) {
            _2 = _8[_10].duplicate();
            _3 = _2.duplicate();
      ...
      , isc.A.dragResizeStop = function isc_TimelineWindow_dragResizeStop() {
        var _1 = this.calendar, _2, _3, _4 = this.ns.EH, _5,
            _6 = this.getPageLeft() - this.getLeft(),
        ...
        _1.updateEvent(this.event, _2, _3, this.event[_1.nameField],
            this.event[_1.descriptionField], null, true)
      }
  ...
  isc.B.push(isc.A.initWidget = function isc_TimelineView_initWidget() {
      ...
      , isc.A.setTimelineRange = function isc_TimelineView_setTimelineRange(_1,
          _2, _3, _4) {
        ...
        isc.logWarn(
            'setTimelineRange:' + [_3, _4, this.creator.timelineGranularity,
              this.creator.timelineUnitsPerColumn]);
      ...
      , isc.A.getCellCSSText = function isc_TimelineView_getCellCSSText(_1, _2,
          _3) {
        var _4 = this.startDate.duplicate();
        _4.setDate(_4.getDate() + _3 - this.getLabelColCount());
        var _5 = new Date();
        if (_4.toShortDate() == _5.toShortDate()
            && this.creator.todayBackgroundColor) {
      ...
      isc.A.formatDateForDisplay = function isc_TimelineView_formatDateForDisplay(_1) {
        return _1.getShortMonthName() + " " + _1.getDate() + ", "
            + _1.getFullYear()
      }
      ...
      , isc.A.nextOrPrev = function isc_TimelineView_nextOrPrev(_1) {
        ...
        this.setFields(this.calcFields());
        if (this.creator.dataSource && isc.ResultSet && isc.isA.ResultSet(
            this.creator.data)) {
      ...
      , isc.A.getVisibleEvents = function isc_TimelineView_getVisibleEvents() {
        ...
        for (var i = 0; i < _4.getLength(); i++) {
          ...
          var _9 = this.data.findIndex(_3.eventTypeField,
              _7[_3.eventTypeField]);
      ...
      ,
      isc.A.findOverlappingEvents = function isc_TimelineView_findOverlappingEvents(_1,
          _2) {
        var _3 = this.creator;
        var _4 = _3.data;
        var _5 = [];
        for (var i = 0; i < _4.getLength(); i++) {
          ...
          if (_2[_3.eventTypeField] == _7[_3.eventTypeField]
              && this.eventsOverlap(_8, _7)) {
            _5.add(_7)
          }
        }
        return _5
      ...
      ,
      isc.A.tagDataForOverlap = function isc_TimelineView_tagDataForOverlap(_1,
          _2) {
        if (_1.getLength() == 0) {
          return;
        }
        var _3 = this.creator, _4 = [], _5 = 0, _6 = 0, _7 = 0,
            _8 = _1.get(0)[_3.eventTypeField];
        _1.sort(function (_19, _20) {
          var _9;
          if (_19[_3.leadingDateField]
              && _20[_3.leadingDateField]) {
            _9 = _3.leadingDateField;
          } else {
            _9 = _3.startDateField;
          }
          if (_19[_3.eventTypeField]
              < _20[_3.eventTypeField]) {
            return -1;
          } else if (_19[_3.eventTypeField]
              > _20[_3.eventTypeField]) {
            return 1;
          } else {
        ...
        for (var i = _10; i < _1.getLength(); i++) {
          ...
          for (var j = 0; j < _4.length; j++) {
            ...
            if (!_17.$646.visited) {
              ...
              if (_18 < 1) {
                isc.logWarn(
                    "Calendar.timelineView.tagDataForOverlap, no slot for event:"
                    + isc.Log.echoFull(_17))
              }
              _17.$646.slotNum = _18;
      ...
      , isc.A.eventsOverlap = function isc_TimelineView_eventsOverlap(_1, _2) {
        ...
        if (_1[_5.leadingDateField]
            && _2[_5.leadingDateField]) {
          _3 = _5.leadingDateField;
        } else {
          _3 = _5.startDateField;
        }
        if (_1[_5.trailingDateField]
            && _2[_5.trailingDateField]) {
      ...
      , isc.A.getDateFromPoint = function isc_TimelineView_getDateFromPoint(_1,
          _2) {
      ...
      , isc.A.$732 = function isc_TimelineView__getEventBreadth(_1) {
        var _2 = this.$731();
        var _3, _4;
        if (_1.event[this.creator.startDateField].getTime()
            < this.startDate.getTime()) {
          _3 = this.startDate.duplicate()
        } else {
          _3 = _1.event[this.creator.startDateField]
        }
        if (_1.event[this.creator.endDateField].getTime()
      ...
      , isc.A.getEventLeft = function isc_TimelineView_getEventLeft(_1) {
        var _2 = (_1[this.creator.startDateField].getTime()
            - this.startDate.getTime())
      ...
      , isc.A.sizeEventWindow = function isc_TimelineView_sizeEventWindow(_1,
          _2) {
        var _3 = this.creator, _4 = _1.event, _5 = this.eventWidth,
            _6 = this.eventHeight;
        ...
        var _9 = this.data.findIndex(this.eventTypeField,
            _4[this.eventTypeField]);
        var _10 = _9 * _6;
      ...
      ,
      isc.A.adjustDimensionsForOverlap = function isc_TimelineView_adjustDimensionsForOverlap(_1,
          _2, _3, _4, _5) {
        var _6 = _1.event.$646;
      ...
      , isc.A.$65t = function isc_TimelineView__positionIcon(_1, _2) {
        var _3 = this.creator, _4 = _1.$65e, _5 = _4.event, _6 = _1.type,
            _7 = this.eventWidth, _8 = _4.getVisibleHeight(), _9 = _4.getTop(),
            _10 = _4.getLeft();
        ...
        if (_6 == "trail") {
          if (this.compareDates(_5[_3.trailingDateField], this.endDate) < 0) {
            ...
            _11 = _3.getDayDiff(_5[_3.trailingDateField],
                _5[_3.startDateField]);
        ...
        if (_13 == false) {
          ...
          _17 = _10 + _7
              + _12 - Math.round(_16 / 2);
        } else {
          _17 = _10 - _12 - Math.round(
              _16 / 2);
        }
        _1.moveTo(_17, _9 + Math.round(_8 / 2) - Math.round(_16 / 2));
        _1.$647 = Math.round(_8 / 2) - Math.round(_16 / 2) + _15;
        _1.$648 = Math.round(_7 / 2) - Math.round(
            _16 / 2), _1.$65f = _3.getDayDiff(_5[_3.startDateField],
            this.startDate);
        return _13
      }
      , isc.A.$65s = function isc_TimelineView__makeIcon(_1, _2) {
        ...
        var _4 = isc.Img.create({
          ...
          autoDraw: false,
          _redrawWithParent: false,
          src: (_2 == "trail" ? this.trailingEndPointImage
          ...
          dragRepositionStop: function () {
            var _5 = this.$65f, _6 = this.$644,
                _7 = this.parentElement.getEventColumn(), _8 = _7 - _6,
                _9 = this.$65e.event, _10 = this.$65e.calendar,
                _11 = this.type == "trail" ? _7 - _5 : _5 - _7;
            if (_11 < 1) {
              return false;
            }
            var _12 = {};
            var _13 = this.type == "trail" ? _10.trailingDateField
                : _10.leadingDateField;
            var _14 = _9[_13].duplicate();
            _14.setDate(_14.getDate() + _8);
            _12[_13] = _14;
            _10.updateEvent(_9, _9[_10.startDateField], _9[_10.endDateField],
                _9[_10.nameField], _9[_10.descriptionField], _12, true);
            return true
          }
        });
        return _4
      ...
      isc.A.getNewEventWindow = function isc_TimelineView_getNewEventWindow(_1) {
        var _2 = _1[this.creator.eventWindowStyleField]
            || this.creator.eventWindowStyle;
        var _3, _4, _5 = true;
        if (this.creator.showDescription == false) {
          _5 = false
        }
        var _6 = (this.creator.canDragEvents == true
            && _1[this.creator.canDragEventField] != false);
        var _7 = {
          calendar: this.creator,
          _redrawWithParent: false,
          styleName: _2,
        ...
        if (!_5) {
          var _8 = isc.TimelineWindow.create(_7);
          var _9 = isc.Label.create(
              {autoDraw: false, styleName: _2, border: "0px", height: "*"});
          _8.addChild(_9);
          _8.header = _9;
          _8.$77n = true
        }
      ...
      isc.A.updateEventWindow = function isc_TimelineView_updateEventWindow(_1) {
        ...
        var _2 = this.creator, _3 = this.tagDataForOverlap(
            _2.data.getRange(0, _2.data.getLength()), _1[_2.eventTypeField]);
      ...
      , isc.A.resized = function isc_TimelineView_resized() {
        ...
        if (this.isDrawn() && this.creator.hasData()
  ...
  isc._moduleEnd = isc._Calendar_end = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) {
    isc.Log.logInfo(
        'Calendar module init time: ' + (isc._moduleEnd - isc._moduleStart)
        + 'ms', 'loadTime');
  }
  ...
  if (window.isc && isc.Log && isc.Log.logWarn) {
    isc.Log.logWarn(
        "Duplicate load of module 'Calendar'.");
  }
}
/*
 * Isomorphic SmartClient
