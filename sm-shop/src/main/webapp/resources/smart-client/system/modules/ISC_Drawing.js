...
if (window.isc && window.isc.module_Core && !window.isc.module_Drawing) {
  ...
  isc._moduleStart = isc._Drawing_start = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled(
      'loadTime')))) {
    isc._pTM = {
      message: 'Drawing load/parse time: ' + (isc._moduleStart - isc._moduleEnd)
  ...
  isc.Browser.hasCANVAS = isc.Browser.geckoVersion >= 20051107
      || isc.Browser.safariVersion >= 181 || ((isc.Browser.isIE
          && isc.Browser.version >= 9) && (typeof (document.createElement(
          'canvas').getContext) === 'function'));
  isc.Browser.hasSVG = isc.Browser.geckoVersion >= 20051107;
  isc.Browser.hasVML = isc.Browser.isIE && isc.Browser.version >= 5;
  isc.Browser.defaultDrawingType = isc.Browser.hasCANVAS ? "bitmap"
      : isc.Browser.hasVML ? "vml" : "none";
  ...
  isc.B.push(isc.A.createQuadTree = function isc_DrawPane_createQuadTree() {
        this.quadTree = isc.QuadTree.create(
            {depth: 0, maxDepth: 50, maxChildren: 1});
        ...
        this.quadTree.root = isc.QuadTreeNode.create(
            {depth: 0, maxDepth: 8, maxChildren: 4});
      ...
      , isc.A.getInnerHTML = function isc_DrawPane_getInnerHTML() {
        ...
        if (_1 == "vml") {
          return isc.Browser.isTransitional ? this.startTagVML('GROUP')
              + " ID='" + this.getID()
              + "$435' STYLE='position:absolute;left:5px;top:5px;width:"
              + (this.getInnerContentWidth()) + "px; height:"
              + (this.getInnerContentHeight()) + "px;rotation:"
              + (this.rotation) + ";' coordsize='"
              + (this.getInnerContentWidth()) + ", "
              + (this.getInnerContentHeight()) + "' coordorig='0 0'>"
              + this.endTagVML('GROUP') : this.startTagVML('GROUP') + " ID='"
              + this.getID() + "$435' STYLE='left:0px;top:0px;width:"
              + this.getInnerContentWidth() + "px; height:"
              + this.getInnerContentHeight() + "px;' coordsize='"
              + this.getInnerContentWidth() + ", "
              + this.getInnerContentHeight() + "' coordorig='0 0'>"
              + this.endTagVML('GROUP')
        } else if (_1 == "bitmap") {
          return "<CANVAS ID='" + this.getID() + "$436'" + " WIDTH='"
              + this.getWidth() + "' HEIGHT='" + this.getHeight()
              + "'></CANVAS>"
        } else if (_1 == "svg") {
          return "<IFRAME HEIGHT='100%' WIDTH='100%' SCROLLING='NO' FRAMEBORDER='0' SRC='"
              + isc.Page.getHelperDir() + "DrawPane.svg?isc_dp_id="
              + this.getID() + "'></IFRAME>"
        } else {
          this.logWarn("DrawPane getInnerHTML: '" + _1
              + "' is not a supported drawingType");
      ...
      , isc.A.getPrintHTML = function isc_DrawPane_getPrintHTML() {
        if (this.drawingType == "bitmap") {
          ...
          return "<img src='" + _1.toDataURL() + "' width='" + this.getWidth()
      ...
      , isc.A.drawing2screen = function isc_DrawPane_drawing2screen(_1) {
        return [Math.round((_1[0] - this.$431) * this.zoomLevel),
          Math.round((_1[1] - this.$432) * this.zoomLevel),
          Math.round(_1[2] * this.zoomLevel),
          Math.round(_1[3] * this.zoomLevel)]
      }
      , isc.A.screen2drawing = function (screenRect) {
        return [screenRect[0] / this.zoomLevel + this.$431,
          screenRect[1] / this.zoomLevel + this.$432,
          screenRect[2] / this.zoomLevel, screenRect[3] / this.zoomLevel]
      }
      , isc.A.$44a = function isc_DrawPane__setViewBox(_1, _2, _3, _4) {
        ...
        if (_5 == "vml") {
          ...
          if (!this.$44n) {
            ...
            this.$44n.setAttributeNS(null, "transform",
                "translate(" + -_1 + "," + -_2 + ")")
          }
        }
      }
      ...
      , isc.A.$85q = function isc_DrawPane__createSimpleGradientSVG(_1, _2) {
        ...
        if (!isc.Browser.isWebKit) {
          ...
          "' x1='" + _2.x1 + "' x2='" + _2.x2 + "' y1='" + _2.y1 + "' y2='"
          + _2.y2 + "'>";
          _5 = _2.startColor;
          _6 = 0.0;
          _7 = "1";
          _3 += "<stop stop-color='" + _5 + "' offset='" + _6
              + "' stop-opacity='" + _7 + "'/>";
          _5 = _2.endColor;
          _6 = 1.0;
          _7 = "1";
          ...
          _3 = this.$44m.createElementNS("http://www.w3.org/2000/svg",
              "linearGradient");
      ...
      , isc.A.$83q = function isc_DrawPane__createLinearGradientSVG(_1, _2) {
        var _3, i, _5, _6, _7, _8, _9;
        if (!isc.Browser.isWebKit) {
          _3 = "<linearGradient id='" + _1 + "' x1='" + _2.x1 + "' x2='" + _2.x2
              + "' y1='" + _2.y1 + "' y2='" + _2.y2 + "'>";
          ...
          _3.setAttributeNS(null, "y2", _2.y2);
          for (var i = 0; i < _2.colorStops.length; ++i) {
            _9 = this.$44m.createElementNS("http://www.w3.org/2000/svg",
                "stop");
            _9.setAttributeNS(null, "stop-color", _2.colorStops[i].color);
            _9.setAttributeNS(null, "offset", _2.colorStops[i].offset);
            _9.setAttributeNS(null, "stop-opacity",
                _2.colorStops[i].opacity || "1");
            _3.appendChild(_9)
          }
          this.$44o.appendChild(_3)
        }
      ...
      , isc.A.$83r = function isc_DrawPane__createRadialGradientSVG(_1, _2) {
        var _3, i, _5, _6, _7, _8, _9;
        if (!isc.Browser.isWebKit) {
          _3 = "<radialGradient id='" + _1 + "' cx='" + _2.cx + "' cy='" + _2.cy
              + "' r='" + _2.r + "' fx='" + _2.fx + "' fy='" + _2.fy + "'>";
          for (var i = 0; i < _2.colorStops.length; ++i) {
            _5 = _2.colorStops[i].color;
            _6 = _2.colorStops[i].offset;
            _7 = _2.colorStops[i].opacity || "1";
      ...
      , isc.A.$44i = function isc_DrawPane__updateCanvasItemToViewBox(_1) {
        ...
        if (_1.drawBorderSize) {
          _1.getStyleHandle().borderWidth = Math.max(1,
              _1.drawBorderSize * this.zoomLevel) + "px"
        }
      ...
      , isc.A.pan = function isc_DrawPane_pan(_1, _2) {
        this.$44a(this.$431 + _1 / this.zoomLevel,
            this.$432 + _2 / this.zoomLevel, this.$433, this.$434);
        if (this.drawingType === 'bitmap') {
      ...
      , isc.A.zoom = function isc_DrawPane_zoom(_1) {
        ...
        this.zoomLevel = _1;
        this.$44a(this.$431 + this.$433 / 2 - _3 / 2,
            this.$432 + this.$434 / 2 - _4 / 2, _3, _4);
        if (this.drawingType === 'bitmap') {
          var _5 = document.getElementById(this.getID() + "$436");
          if (_5) {
            _5.style['-webkit-transform'] = 'scale(' + this.zoomLevel + ','
                + this.zoomLevel + ')'
          }
        }
      }
      ...
      ,
      isc.A.createSimpleGradient = function isc_DrawPane_createSimpleGradient(_1,
          _2) {
      ...
      ,
      isc.A.createLinearGradient = function isc_DrawPane_createLinearGradient(_1,
          _2) {
        this.gradients[_1] = _2;
      ...
      ,
      isc.A.createRadialGradient = function isc_DrawPane_createRadialGradient(_1,
          _2) {
        this.gradients[_1] = _2;
        var _3 = this.drawingType;
        if (_3 == "svg") {
  ...
  isc.A.$44p = [];
  isc.B.push(
      isc.A.getDefaultDrawPane = function isc_c_DrawPane_getDefaultDrawPane(_1) {
        if (!_1) {
      ...
      , isc.A.addrgb = function isc_c_DrawPane_addrgb(_1, _2) {
        var _3 = Array(parseInt('0x' + _1.substring(1, 3), 16),
            parseInt('0x' + _1.substring(3, 5), 16),
            parseInt('0x' + _1.substring(5, 7), 16));
        var _4 = Array(parseInt('0x' + _2.substring(1, 3), 16),
            parseInt('0x' + _2.substring(3, 5), 16),
            parseInt('0x' + _2.substring(5, 7), 16));
        var _5 = _3[0] + _4[0];
      ...
      , isc.A.mixrgb = function isc_c_DrawPane_mixrgb(_1, _2) {
        return _2.charAt(0) === '+' ? isc.DrawPane.addrgb(_1, _2.substring(1))
            : _2.charAt(0) === '-' ? isc.DrawPane.subtractrgb(_1,
                _2.substring(1)) : _2
      }
      , isc.A.hex2rgb = function isc_c_DrawPane_hex2rgb(_1, _2) {
        ...
        var _11 = (typeof (_2) !== 'undefined') ? 'rgba(' + _8 + ',' + _9 + ','
            + _10 + ',' + _2 + ')' : 'rgb(' + _8 + ',' + _9 + ',' + _10 + ')';
        return _11
      }
  ...
  isc.defineClass("DrawItem").addProperties({
    ...
    draw: function () {
      ...
      if (this.drawGroup) {
        if (!this.drawGroup.$if) {
          this.logWarn(
              "Attempted draw into an undrawn group - calling draw() on the group now");
          this.drawGroup.draw();
          if (!this.drawGroup.$if) {
            return
          }
        ...
        if (!this.drawPane) {
          this.drawPane = isc.DrawPane.getDefaultDrawPane(
              this.drawingType)
        }
      }
      var _1 = this.drawPane, _2 = _1.getDrawnState();
      if (!_1.isDrawn() && _1.getDrawnState()
          != isc.Canvas.HANDLE_DRAWN) {
        return;
      }
      ...
      if (this.drawingVML) {
        ...
        isc.Element.insertAdjacentHTML(this.$44t,
            this.drawToBack ? "afterBegin" : "beforeEnd", this.$44v(_4));
        this.$44u = isc.Element.get(_4);
        if (!isc.isA.DrawGroup(this) && !isc.isA.DrawImage(this)
            && !isc.isA.DrawLabel(this)) {
        ...
        this.$44y = this.drawGroup ? this.drawGroup.$44z
            : this.$44m.getElementById("isc_svg_box");
        if (this.$44y == null) {
          this.logWarn(
              "DrawItem.draw() - Attempt to render into drawPane using svg unable to"
    ...
    $634: function (_1) {
      ...
      if (!this[_2]) {
        this.logWarn("DrawItem specfied with knobType:" + _1 + " but no " + _2
            + " function exists to show the knobs. Ignoring")
      } else {
        this[_2]()
      }
    },
    $635: function (_1) {
      ...
      if (!this[_2]) {
        this.logWarn("DrawItem specfied with knobType:" + _1 + " but no " + _2
            + " function exists to hide the knobs.")
      } else {
        this[_2]()
      }
    },
    ...
    $636: function (_1) {
      var x, y;
      x = _1.contains("L") ? this.left : (_1.contains("R") ? (this.left
          + this.width) : (this.left + Math.round(this.width / 2)));
      y = _1.contains("T") ? this.top : (_1.contains("B") ? (this.top
          + this.height) : (this.top + Math.round(this.height / 2)));
      return [x, y]
    },
      ...
      for (var i = 0; i < _1.length; i++) {
        ...
        _8.addProperties({
          updatePoints: function (_9, _10, _11, _12) {
            return this.targetShape.handleResizeKnobMove(this.point, _9, _10,
                _11, _12)
          }
        });
        if (!this.$638) {
    ...
    $44v: function (_1) {
      ...
      if (this.shadow) {
        _3 = " ON='true' COLOR='" + this.shadow.color + "' OFFSET='"
            + this.shadow.offset[0] + "pt," + this.shadow.offset[1] + "pt"
      }
      if (this.fillGradient) {
        var _10 = typeof (this.fillGradient) === 'string'
            ? this.drawPane.gradients[this.fillGradient] : this.fillGradient;
        if (typeof (_10.direction) === 'number' || _10.x1 || typeof (_10.x1)
            === 'number') {
          _4 = this.$830(_10, this.getBoundingBox());
          _5 = _10.direction || 180 * Math.atan2((_4[3] - _4[1]),
              (_4[2] - _4[0])) / Math.PI;
          _5 = (270 - _5) % 360;
          _8 = "' COLORS='";
          ...
          _2 = " TYPE='gradienttitle' OPACITY='1.0' FOCUS='100%' FOCUSSIZE='0,0' FOCUSPOSITION='0.5,0.5' METHOD='linear"
              + _8
        }
      } else if (this.fillColor && !isc.isAn.emptyString(this.fillColor)) {
        _2 = " COLOR='" + this.fillColor
      }
      var _13 = isc.SB.concat(this.drawPane.startTagVML(this.vmlElementName),
          " onmousedown='return ", this.drawPane.getID(), ".mouseDown();' ",
          " ID='", _1, "' ", this.getAttributesVML(), ">",
          this.drawPane.startTagVML('STROKE'),
          ((this.lineColor && this.lineColor != "") ? " COLOR='"
              + this.lineColor : " ON='false"), "' WEIGHT='",
          this.lineWidth * this.drawPane.zoomLevel, "px", "' OPACITY='",
          this.lineOpacity, "' DASHSTYLE='", this.linePattern,
          "' JOINSTYLE='miter' MITERLIMIT='8.0",
          "' ENDCAP='" + ((this.lineCap == "butt") ? "flat" : this.lineCap),
          (this.startArrow ? "' STARTARROW='" + this.startArrow
              + "' STARTARROWWIDTH='wide" : ""),
          (this.endArrow ? "' ENDARROW='" + this.endArrow
              + "' ENDARROWWIDTH='wide" : ""), "'/>",
          this.drawPane.startTagVML('FILL'), _2, "' OPACITY='",
          this.fillOpacity, "'/>", this.drawPane.startTagVML('SHADOW'), _3,
    ...
    $440: function (_1) {
      ...
      if (!isc.Browser.isWebKit) {
        _2 = "<" + this.svgElementName + " id='" + _1 + "' "
            + this.getAttributesSVG() + " stroke-width='" + this.lineWidth
            + "px" + "' stroke='" + ((this.lineColor && this.lineColor != "")
                ? this.lineColor : "none") + "' stroke-opacity='"
            + this.lineOpacity + "' stroke-dasharray='" + this.$441()
            + "' stroke-linecap='" + this.lineCap + (this.startArrow
            && !this.$63r() ? "' marker-start='url(#" + this.$442() + ")" : "")
            + (this.endArrow && !this.$63s() ? "' marker-end='url(#"
                + this.$443() + ")" : "") + ((this.rotation && _4 && _4.length
                === 2) ? "' transform='translate(" + _4[0] + "," + _4[1]
                + ") rotate(" + this.rotation + ") translate(" + -_4[0] + ","
                + -_4[1] + ")" : "") + "' fill='" + _3 + "' fill-opacity='"
            + this.fillOpacity + "'>" + (this.contents || "") + "</"
            + this.svgElementName + ">"
      } else {
        _2 = this.$44m.createElementNS("http://www.w3.org/2000/svg",
            this.svgElementName);
        ...
        if (this.rotation) {
          _2.setAttributeNS(null, "transform",
              "translate(" + _4[0] + "," + _4[1] + ") rotate(" + this.rotation
              + ") translate(" + -_4[0] + "," + -_4[1] + ")")
        }
    ...
    $831: function (_1, _2) {
      ...
      if (typeof (_1.r) === 'string' && isc.isA.Number(_2[0]) && isc.isA.Number(
          _2[1])) {
    ...
    drawBitmap: function (_1) {
      _1.save();
      try {
        if (this.drawPane && (this.drawPane.zoomLevel || this.drawPane.translate
            || this.drawPane.rotation)) {
        ...
        if (this.fillGradient) {
          _4 = typeof (this.fillGradient) === 'string'
              ? this.drawPane.gradients[this.fillGradient] : this.fillGradient;
          if (typeof (_4.direction) === 'number' || _4.x1 || typeof (_4.x1)
              === 'number') {
            _5 = this.$830(_4, this.getBoundingBox());
            _3 = _1.createLinearGradient(_5[0], _5[1], _5[2], _5[3])
          } else {
            _5 = this.$831(_4, this.getBoundingBox());
            _3 = _1.createRadialGradient(_5[0], _5[1], _5[2], _5[3], _5[4],
                _5[5])
          }
    ...
    $442: function () {
      if (this.$444) {
        ...
        if (this.$44m.getElementById(this.startArrow)) {
          ...
          this.logWarn(
              "SVG marker '" + this.startArrow + "' does not exist; ignoring")
        }
      } else {
        if (this.startArrow === "block" || !this.$44m.getElementById(
            this.startArrow)) {
          this.$444 = "isc_DrawItem_" + this.drawItemID + "$446";
          this.$445 = this.$447(this.$444, this.lineColor, this.lineOpacity,
              true)
        } else {
          this.$444 = this.startArrow
        }
    ...
    $443: function () {
      if (this.$448) {
        ...
        if (this.$44m.getElementById(this.endArrow)) {
          ...
          this.logWarn(
              "SVG marker '" + this.endArrow + "' does not exist; ignoring")
        }
      } else {
        if (this.endArrow == "block" || !this.$44m.getElementById(
            this.endArrow)) {
          this.$448 = "isc_DrawItem_" + this.drawItemID + "$45a";
          this.$449 = this.$447(this.$448, this.lineColor, this.lineOpacity,
              false)
        } else {
          this.$448 = this.endArrow
        }
    ...
    $447: function (_1, _2, _3, _4) {
      var _5;
      if (!isc.Browser.isWebKit) {
        _5 = "<marker id='" + _1 + "' viewBox='0 0 10 10' refY='5' refX='" + (_4
            ? "10" : "0")
            + "' orient='auto' markerUnits='strokeWidth' markerWidth='4' markerHeight='3'><path d='"
            + (_4 ? "M 10 0 L 0 5 L 10 10 z" : "M 0 0 L 10 5 L 0 10 z")
            + "' fill='" + ((_2 && _2 != "") ? _2 : "none") + "' fill-opacity='"
            + _3 + "' stroke-width='0px'/></marker>";
        var _6 = this.$44m.createRange();
        ...
        var _7 = this.$44m.createElementNS("http://www.w3.org/2000/svg",
            "path");
        _7.setAttributeNS(null, "d",
            (_4 ? "M 10 0 L 0 5 L 10 10 z" : "M 0 0 L 10 5 L 0 10 z"));
    ...
    setLineColor: function (_1) {
      ...
      if (this.drawingVML) {
        ...
        var _1 = (this.lineColor && this.lineColor != "") ? this.lineColor
            : "none"
    ...
    setStartArrow: function (_1) {
      ...
      if (this.drawingVML) {
        ...
        this.$44z.setAttributeNS(null, "marker-start",
            (_1 ? "url(#" + this.$442() + ")" : "none"))
      } else if (this.drawingBitmap) {
      }
    },
    setEndArrow: function (_1) {
      ...
      if (this.drawingVML) {
        ...
        this.$44z.setAttributeNS(null, "marker-end",
            (_1 ? "url(#" + this.$443() + ")" : "none"))
      } else if (this.drawingBitmap) {
      }
    },
    ...
    rotateBy: function (_1) {
      ...
      if (this.drawingVML) {
        ...
        this.$44z.setAttributeNS(null, "transform",
            "translate(" + _2[0] + "," + _2[1] + ") rotate(" + this.rotation
            + ") translate(" + -_2[0] + "," + -_2[1] + ")")
      } else if (this.drawingBitmap) {
        this.drawPane.redrawBitmap()
      }
    ...
    scaleBy: function (_1, _2) {
      ...
      if (this.drawingVML) {
        ...
        var _3 = "scale(" + this.scale[0] + "," + this.scale[1] + ") "
            + (this.$44z.getAttributeNS(null, "transform") || "");
    ...
    setFillColor: function (_1) {
      ...
      if (this.drawingVML) {
        ...
        this.$44z.setAttributeNS(null, "fill",
    ...
    bmMoveTo: function (_1, _2, _3) {
      ...
      var _4 = (this.autoOffset && (this.lineWidth == 0 || parseInt(
          this.lineWidth) % 2) == 1 ? 0.5 : 0);
      try {
        _3.moveTo(_1 + _4, _2 + _4)
      } catch (e) {
        this.logWarn("error on moveTo(): left: " + _1 + ", top: " + _2
            + (this.logIsInfoEnabled() ? this.getStackTrace() : ""))
      }
    },
    bmArc: function (_1, _2, _3, _4, _5, _6) {
      var _6 = _6 || this.drawPane.getBitmapContext();
      var _7 = (this.autoOffset && (this.lineWidth == 0 || parseInt(
          this.lineWidth) % 2) == 1 ? 0.5 : 0);
      try {
    ...
    bmLineTo: function (_1, _2, _3) {
      ...
      try {
        ...
        this.logWarn("error on lineTo(): left: " + _1 + ", top: " + _2
            + (this.logIsInfoEnabled() ? this.getStackTrace() : ""))
      }
    },
    bmQuadraticCurveTo: function (_1, _2, _3, _4) {
      var _5 = _5 || this.drawPane.getBitmapContext();
      var _6 = (this.autoOffset && (this.lineWidth == 0 || parseInt(
          this.lineWidth) % 2) == 1 ? 0.5 : 0);
      try {
        _5.quadraticCurveTo(_1 + _6, _2 + _6, _3 + _6, _4 + _6)
      } catch (e) {
        this.logWarn(
            "error on quadraticCurveTo(): left: " + left + ", top: " + top
            + (this.logIsInfoEnabled() ? this.getStackTrace() : ""))
      }
    },
    bmTranslate: function (_1, _2, _3) {
      ...
      try {
        ...
        this.logWarn("error on translate(): left: " + _1 + ", top: " + _2
            + (this.logIsInfoEnabled() ? this.getStackTrace() : ""))
      }
    },
    bmRotate: function (_1, _2) {
      ...
      try {
        ...
        this.logWarn(
            "error on translate(): angle: " + _1 + (this.logIsInfoEnabled()
            ? this.getStackTrace() : ""))
      }
    },
    bmFillText: function (_1, _2, _3, _4) {
      ...
      try {
        ...
        this.logWarn(
            "error on fillText(): text: " + _1 + ", left: " + _2 + ", top: "
            + _3 + (this.logIsInfoEnabled() ? this.getStackTrace() : ""))
      }
    },
  ...
  isc.B.push(
      isc.A.$632 = function isc_c_DrawItem__getShowKnobsFunctionName(_1, _2) {
        if (!this.$633) {
          this.$633 = {}
        }
        if (this.$633[_1] == null) {
          ...
          this.$630[1] = _1;
          this.$631[1] = _1;
          this.$633[_1] = [this.$630.join(isc.emptyString),
            this.$631.join(isc.emptyString)]
        }
  ...
  isc.B.push(isc.A.init = function isc_DrawGroup_init() {
      ...
      , isc.A.$44v = function isc_DrawGroup__getElementVML(_1) {
        return isc.SB.concat(this.drawPane.startTagVML('FOO'),
            " onmousedown='return ", this.drawPane.getID(), ".mouseDown();' ",
            " ID='", _1, "' ", this.getAttributesVML(), ">",
            this.drawPane.endTagVML(this.vmlElementName))
      }
      , isc.A.$440 = function isc_DrawGroup__getElementSVG(_1) {
        var _2;
        if (!isc.Browser.isWebKit) {
          return "<g id='" + _1 + "' transform='translate(" + this.left + ","
              + this.top + ")'></g>"
        } else {
      ...
      , isc.A.setLeft = function isc_DrawGroup_setLeft(_1) {
        ...
        if (this.drawingVML) {
          ...
          var _2 = "translate(" + this.left + "," + this.top + ") "
              + (this.$44z.getAttributeNS(null, "transform") || "");
      ...
      , isc.A.getBoundingBox = function isc_DrawGroup_getBoundingBox() {
        return [this.left, this.top, this.left + this.width,
  ...
  isc.B.push(isc.A.init = function isc_DrawLine_init() {
      ...
      , isc.A.$45b = function isc_DrawLine__getArrowAdjustedPoints() {
        if (this.startArrow || this.endArrow) {
          return isc.GraphMath.trimLineEnds(this.startLeft, this.startTop,
      ...
      , isc.A.getAttributesVML = function isc_DrawLine_getAttributesVML() {
        return isc.SB.concat("FROM='", this.startLeft, " ", this.startTop,
            "' TO='", this.endLeft, " ", this.endTop, "'")
      }
      , isc.A.getAttributesSVG = function isc_DrawLine_getAttributesSVG() {
        var _1 = this.$45b();
        return "x1='" + _1[0] + "' y1='" + _1[1] + "' x2='" + _1[2] + "' y2='"
            + _1[3] + "'"
      }
      , isc.A.drawBitmapPath = function isc_DrawLine_drawBitmapPath(_1) {
        var _2 = (this.lineWidth == 0 || parseInt(this.lineWidth) % 2) == 1
            ? 0.5 : 0, _3 = parseFloat(this.startLeft) + _2,
            _4 = parseFloat(this.startTop) + _2,
            _5 = parseFloat(this.endLeft) + _2,
            _6 = parseFloat(this.endTop) + _2;
      ...
      , isc.A.getCenter = function isc_DrawLine_getCenter() {
        return [this.startPoint[0] + Math.round(
            (this.endPoint[0] - this.startPoint[0]) / 2),
          this.startPoint[1] + Math.round(
      ...
      , isc.A.updateControlKnobs = function isc_DrawLine_updateControlKnobs() {
        ...
        if (this.$639) {
          var _1 = this.startLeft, _2 = this.startTop,
              _3 = this.drawPane.drawing2screen([_1, _2, 0, 0]);
          this.$639.setCenterPoint(_3[0], _3[1])
        }
        if (this.$64a) {
          var _1 = this.endLeft, _2 = this.endTop,
              _3 = this.drawPane.drawing2screen([_1, _2, 0, 0]);
  ...
  isc.B.push(isc.A.getAttributesVML = function isc_DrawRect_getAttributesVML() {
        return isc.SB.concat("STYLE='position:absolute; left:", this.left,
      ...
      , isc.A.getAttributesSVG = function isc_DrawRect_getAttributesSVG() {
        return "x='" + this.left + "' y='" + this.top + "' width='" + this.width
            + "' height='" + this.height + "'" + (this.rounding ? " rx='"
      ...
      , isc.A.drawBitmapPath = function isc_DrawRect_drawBitmapPath(_1) {
        if (this.rounding == 0) {
          ...
          this.bmQuadraticCurveTo(this.left + this.width, this.top,
              this.left + this.width, this.top + r);
          this.bmLineTo(this.left + this.width, this.top + this.height - r);
          this.bmQuadraticCurveTo(this.left + this.width,
              this.top + this.height, this.left + this.width - r,
              this.top + this.height);
          this.bmLineTo(this.left + r, this.top + this.height);
          this.bmQuadraticCurveTo(this.left, this.top + this.height, this.left,
      ...
      , isc.A.setRounding = function isc_DrawRect_setRounding(_1) {
        ...
        if (this.drawingVML) {
          ...
          this.$44z.setAttributeNS(null, "rx",
              (this.rounding ? (this.rounding * Math.min(this.width,
                  this.height) / 2) : null))
        } else if (this.drawingBitmap) {
          this.drawPane.redrawBitmap()
        }
  ...
  isc.B.push(isc.A.init = function isc_DrawOval_init() {
      ...
      , isc.A.getAttributesSVG = function isc_DrawOval_getAttributesSVG() {
        return "cx='" + this.centerPoint[0] + "' cy='" + this.centerPoint[1]
      ...
      , isc.A.drawBitmapPath = function isc_DrawOval_drawBitmapPath(_1) {
        ...
        _1.moveTo(_5, _6 - _4);
        _1.bezierCurveTo(_5 + (_2 * _3), _6 - _4, _5 + _3, _6 - (_2 * _4),
            _5 + _3, _6);
        _1.bezierCurveTo(_5 + _3, _6 + (_2 * _4), _5 + (_2 * _3), _6 + _4, _5,
            _6 + _4);
        _1.bezierCurveTo(_5 - (_2 * _3), _6 + _4, _5 - _3, _6 + (_2 * _4),
            _5 - _3, _6);
        _1.bezierCurveTo(_5 - _3, _6 - (_2 * _4), _5 - (_2 * _3), _6 - _4, _5,
  ...
  isc.B.push(isc.A.init = function isc_DrawSector_init() {
      ...
      , isc.A.getAttributesVML = function isc_DrawSector_getAttributesVML() {
        ...
        var _4 = "path='m" + Math.round(this.centerPoint[0]) + "," + Math.round(
            this.centerPoint[1]);
        _4 += " ae" + Math.round(this.centerPoint[0]) + "," + Math.round(
            this.centerPoint[1]);
      ...
      , isc.A.drawBitmapPath = function isc_DrawSector_drawBitmapPath(_1) {
        ...
        this.bmArc(this.centerPoint[0], this.centerPoint[1], this.radius, _4,
            _5, false);
      ...
      , isc.A.moveBy = function isc_DrawSector_moveBy(_1, _2) {
        ...
        this.centerPoint[1] += _2;
        if (this.drawingVML) {
          this.$44u.path = "m" + Math.round(this.centerPoint[0]) + ","
              + Math.round(this.centerPoint[1]) + " ae" + Math.round(
                  this.centerPoint[0]) + "," + Math.round(this.centerPoint[1])
              + " " + Math.round(this.radius) + "," + Math.round(this.radius)
              + " " + Math.round(-this.startAngle * 65535) + "," + Math.round(
                  -(this.endAngle - this.startAngle) * 65536) + " x e'"
        } else if (this.drawingSVG) {
          this.$44z.setAttributeNS(null, "transform",
              "translate(" + _1 + "," + _2 + ")")
        } else if (this.drawingBitmap) {
  ...
  isc.B.push(isc.A.init = function isc_DrawLabel_init() {
      ...
      , isc.A.$44v = function isc_DrawLabel__getElementVML(_1) {
        if (this.synchTextMove) {
          return isc.SB.concat(this.drawPane.startTagVML('RECT'), " ID='", _1,
              "' STYLE='position:absolute;left:", this.left, "px; top:",
              this.top, "px;'>", this.drawPane.startTagVML('TEXTBOX'),
              " INSET='0px, 0px, 0px, 0px' STYLE='overflow:visible",
              "; font-family:", this.fontFamily, "; font-size:",
              this.fontSize * this.drawPane.zoomLevel, "; font-weight:",
              this.fontWeight, "; font-style:", this.fontStyle, ";'><NOBR>",
              this.contents, "</NOBR>", this.drawPane.endTagVML('TEXTBOX'),
              this.drawPane.endTagVML('RECT'))
        } else {
          var _2 = this.drawPane.drawing2screen([this.left, this.top, 0, 0]);
          return isc.SB.concat("<DIV ID='", _1,
              "' STYLE='position:absolute; overflow:visible; width:1px; height:1px",
              "; left:", _2[0] + this.drawPane.getLeftPadding(), "px; top:",
              _2[1] + this.drawPane.getTopPadding(), "px",
              (this.rotation ? ";writing-mode: tb-rl" : ""), "; font-family:",
              this.fontFamily, "; font-size:",
              (this.fontSize * this.drawPane.zoomLevel) + "px",
              "; font-weight:", this.fontWeight, "; font-style:",
              this.fontStyle, ";color:", this.lineColor, ";'><NOBR>",
              this.contents, "</NOBR></DIV>")
        }
      }
      , isc.A.$440 = function isc_DrawLabel__getElementSVG(_1) {
        var _2;
        if (!isc.Browser.isWebKit) {
          _2 = "<text id='" + _1 + "' x='" + this.left + "' y='" + this.top
              + "' dominant-baseline='text-before-edge" + "' font-family='"
              + this.fontFamily + "' font-size='" + this.fontSize
              + "' font-weight='" + this.fontWeight + "' font-style='"
              + this.fontStyle + "'>" + this.contents + "</text>"
        } else {
      ...
      , isc.A.getCenter = function isc_DrawLabel_getCenter() {
        return [this.left + Math.round(this.getTextWidth() / 2),
          this.top + Math.round(this.getTextHeight() / 2)]
      }
      , isc.A.getBoundingBox = function isc_DrawLabel_getBoundingBox() {
        return [this.left, this.top, this.left + this.getTextWidth(),
          this.top + this.getTextHeight()]
      }
      , isc.A.makeHTMLText = function isc_DrawLabel_makeHTMLText() {
        var _1 = this.$45c = isc.HTMLFlow.create({
          ...
          contents: isc.SB.concat("<span style='font-family:", this.fontFamily,
              ";font-weight:", this.fontWeight, ";font-size:",
              Math.round(this.fontSize * this.drawPane.zoomLevel),
              ";font-style:", this.fontStyle, ";color:", this.lineColor,
              ";white-space:nowrap'>", this.contents, "</span>"),
          autoDraw: false
        });
      ...
      , isc.A.drawBitmapPath = function isc_DrawLabel_drawBitmapPath(_1) {
        ...
        if (this.backgroundColor) {
          ...
          _1.globalAlpha = this.fillOpacity;
          _1.beginPath();
          var _2 = 0, _3 = this.getTextWidth(), _4 = 0,
              _5 = this.getTextHeight();
          this.bmMoveTo(_2, _4);
          this.bmLineTo(_3, _4);
          this.bmLineTo(_3, _5);
          this.bmLineTo(_2, _5);
  ...
  isc.B.push(isc.A.getBoundingBox = function isc_DrawImage_getBoundingBox() {
      ...
      , isc.A.$44v = function isc_DrawImage__getElementVML(_1) {
        var _2 = isc.SB.concat(this.drawPane.startTagVML('IMAGE'), " ID='", _1,
            "' SRC='", this.getSrcURL(this.src),
            (this.title ? "' ALT='" + this.title : ""), "' STYLE='left:",
            this.left, "px; top:", this.top, "px; width:", this.width,
            "px; height:", this.height, "px;'>",
            this.drawPane.endTagVML("IMAGE"));
        return _2
      }
      , isc.A.$440 = function isc_DrawImage__getElementSVG(_1) {
        var _2, _3 = this.getCenter();
        if (!isc.Browser.isWebKit) {
          _2 = "<image id='" + _1 + ((this.rotation && _3 && _3.length === 2)
              ? "' transform='translate(" + _3[0] + "," + _3[1] + ") rotate("
              + this.rotation + ") translate(" + -_3[0] + "," + -_3[1] + ")"
              : "") + "' x='" + this.left + "' y='" + this.top + "' width='"
              + this.width + "px' height='" + this.height + "px' xlink:href='"
              + this.getSrcURL(this.src) + "'>" + (this.title ? "<title>"
          ...
          _2.setAttributeNS("http://www.w3.org/1999/xlink", "href",
              this.getSrcURL(this.src));
          if (this.rotation) {
            _2.setAttributeNS(null, "transform",
                "translate(" + _3[0] + "," + _3[1] + ") rotate(" + this.rotation
                + ") translate(" + -_3[0] + "," + -_3[1] + ")")
          }
          if (this.title) {
            var _4 = this.$44m.createElementNS("http://www.w3.org/2000/svg",
                "title");
      ...
      , isc.A.setSrc = function isc_DrawImage_setSrc(_1) {
        ...
        if (this.drawingVML) {
          ...
          this.$44z.setAttributeNS("http://www.w3.org/1999/xlink", "href",
              this.src)
        } else if (this.drawingBitmap) {
          this.drawPane.redrawBitmap()
        }
  ...
  isc.B.push(isc.A.init = function isc_DrawCurve_init() {
      ...
      , isc.A.getAttributesVML = function isc_DrawCurve_getAttributesVML() {
        return isc.SB.concat("FROM='", this.startPoint[0], " ",
            this.startPoint[1], "' TO='", this.endPoint[0], " ",
            this.endPoint[1], "' CONTROL1='", this.controlPoint1[0], " ",
            this.controlPoint1[1], "' CONTROL2='", this.controlPoint2[0], " ",
            this.controlPoint2[1], "'")
      }
      ...
      , isc.A.getPathSVG = function isc_DrawCurve_getPathSVG() {
        return "M" + this.startPoint[0] + " " + this.startPoint[1] + "C"
      ...
      , isc.A.drawBitmapPath = function isc_DrawCurve_drawBitmapPath(_1) {
        ...
        _1.bezierCurveTo(this.controlPoint1[0], this.controlPoint1[1],
            this.controlPoint2[0], this.controlPoint2[1], this.endPoint[0],
            this.endPoint[1])
      }
      ...
      isc.A.setControlPoint1 = function isc_DrawCurve_setControlPoint1(_1, _2) {
        ...
        if (this.drawingVML) {
          this.$44u.control1 = this.controlPoint1[0] + " "
              + this.controlPoint1[1]
        } else if (this.drawingSVG) {
          this.$44z.setAttributeNS(null, "d", this.getPathSVG())
        } else if (this.drawingBitmap) {
          this.drawPane.redrawBitmap()
      ...
      isc.A.setControlPoint2 = function isc_DrawCurve_setControlPoint2(_1, _2) {
        ...
        if (this.drawingVML) {
          this.$44u.control2 = this.controlPoint2[0] + " "
              + this.controlPoint2[1]
        } else if (this.drawingSVG) {
          this.$44z.setAttributeNS(null, "d", this.getPathSVG())
        } else if (this.drawingBitmap) {
      ...
      isc.A.showControlPoint1Knobs = function isc_DrawCurve_showControlPoint1Knobs() {
        ...
        this.observe(this.$64b, "updatePoints",
      ...
      isc.A.showControlPoint2Knobs = function isc_DrawCurve_showControlPoint2Knobs() {
        ...
        this.observe(this.$64d, "updatePoints",
            "observer.setControlPoint2(x,y)")
      }
      ,
  ...
  isc.B.push(isc.A.init = function isc_DrawBlockConnector_init() {
      ...
      , isc.A.setStartPoint = function isc_DrawBlockConnector_setStartPoint(_1,
          _2) {
        if (_1 != null) {
          this.startPoint[0] = _1;
        }
  ...
  isc.B.push(isc.A.getBoundingBox = function isc_DrawPath_getBoundingBox() {
      ...
      , isc.A.getAttributesVML = function isc_DrawPath_getAttributesVML() {
        return isc.SB.concat("STYLE='position:absolute; left:", this.left,
            "px; top:", this.top, "px; width:", this.width, "px; height:",
            this.height, "px;'", " POINTS='" + this.getPointsText() + "'")
      }
  ...
  isc.B.push(isc.A.init = function isc_DrawLinePath_init() {
      ...
      , isc.A.$45e = function isc_DrawLinePath__getSegmentPoints() {
        ...
        this.$45f = [];
        this.$45f.addList([[this.startLeft, this.startTop],
          [this.startLeft - _1, this.startTop],
          [this.endLeft + _1, this.endTop], [this.endLeft, this.endTop]]);
        return this.$45f
      }
  ...
  isc.GraphMath = {
    zeroPoint: [0, 0], polar2screen: function (_1, _2, _3, _4) {
      ...
      return [((Math.PI - Math.atan2(-_2, _1)) / Math.PI * 180 + 270) % 360,
        Math.sqrt(Math.pow(_1, 2) + Math.pow(_2, 2))]
    }, angleDifference: function (_1, _2) {
      var _3 = Math.max(_1, _2), _4 = Math.min(_1, _2), _5 = _3 - _4,
          _6 = _4 + 360 - _3;
      if (_6 < _5) {
        var _7 = _3 == _1 ? 1 : -1;
        return _7 * _6
      ...
      if (_5 + _6 > _7) {
        ...
        return [_8 + (_1 == _3 ? 0 : _1 > _3 ? 0.01 : -0.01),
          _9 + (_2 == _4 ? 0 : _2 > _4 ? 0.01 : -0.01),
          _8 + (_1 == _3 ? 0 : _1 > _3 ? -0.01 : 0.01),
          _9 + (_2 == _4 ? 0 : _2 > _4 ? -0.01 : 0.01)]
      }
      var _10 = Math.atan2(_2 - _4, _3 - _1);
      return [_1 + (_5 * Math.cos(_10)), _2 - (_5 * Math.sin(_10)),
        _3 - (_6 * Math.cos(_10)), _4 + (_6 * Math.sin(_10))]
    }
  }
  ...
  isc.B.push(isc.A.setCenter = function isc_Canvas_setCenter(_1, _2) {
        this.moveTo(_1 - this.getVisibleWidth() / 2,
            _2 - this.getVisibleHeight() / 2)
      }
      , isc.A.getCenter = function isc_Canvas_getCenter() {
        return [this.getLeft() + this.getVisibleWidth() / 2,
  ...
  isc.B.push(isc.A.init = function isc_QuadTreeNode_init() {
      ...
      , isc.A.subdivide = function isc_QuadTreeNode_subdivide() {
        ...
        var _6 = _2 + _4;
        var _7 = _3 + _5;
        this.nodes[isc.QuadTreeNode.TOP_LEFT] = isc.QuadTreeNode.create(
            {depth: _1});
        this.nodes[isc.QuadTreeNode.TOP_LEFT].bounds = {
          x: _2,
          y: _3,
          width: _4,
          height: _5
        };
        this.nodes[isc.QuadTreeNode.TOP_RIGHT] = isc.QuadTreeNode.create(
            {depth: _1});
        this.nodes[isc.QuadTreeNode.TOP_RIGHT].bounds = {
          x: _6,
          y: _3,
          width: _4,
          height: _5
        };
        this.nodes[isc.QuadTreeNode.BOTTOM_LEFT] = isc.QuadTreeNode.create(
            {depth: _1});
        this.nodes[isc.QuadTreeNode.BOTTOM_LEFT].bounds = {
          x: _2,
          y: _7,
          width: _4,
          height: _5
        };
        this.nodes[isc.QuadTreeNode.BOTTOM_RIGHT] = isc.QuadTreeNode.create(
            {depth: _1});
        this.nodes[isc.QuadTreeNode.BOTTOM_RIGHT].bounds = {
          x: _6,
          y: _7,
          width: _4,
          height: _5
  ...
  isc.B.push(isc.A.initWidget = function isc_DrawKnob_initWidget() {
      ...
      isc.A.setCenterPoint = function isc_DrawKnob_setCenterPoint(_1, _2, _3) {
        ...
        var _4, _5;
        if (_3) {
          var _6 = this.drawPane.drawing2screen(
              [_1 - this.$44g / 2, _2 - this.$44h / 2, 0, 0]);
          _4 = _6[0], _5 = _6[1]
        } else {
          _4 = _1 - this.width / 2;
          _5 = _2 - this.height / 2
      ...
      , isc.A.draw = function isc_DrawKnob_draw() {
        ...
        if (!this.knobShape) {
          this.knobShape = this.createAutoChild("knobShape",
              {drawPane: this.drawPane, centerPoint: [this.x, this.y]});
          this.$907 = true;
      ...
      , isc.A.$64f = function isc_DrawKnob__updatePoints() {
        var _1 = isc.EH.getX() -
            (this.drawPane.getPageLeft() + this.drawPane.getLeftMargin()
                + this.drawPane.getLeftBorderSize()), _2 = isc.EH.getY() -
        ...
        var _4 = _3[0], _5 = _3[1], _6 = _4 - (this.$44e + this.$44g / 2),
            _7 = _5 - (this.$44f + this.$44h / 2);
        this.updatePoints(_4, _5, _6, _7)
      }
      , isc.A.updateKnobShape = function isc_DrawKnob_updateKnobShape() {
        var _1 = this.drawPane.screen2drawing(
            [this.getLeft() + this.getWidth() / 2,
              this.getTop() + this.getHeight() / 2, 0, 0]);
        var x = _1[0], y = _1[1], _4 = x - this.$44g / 2,
            _5 = y - this.$44h / 2;
  ...
  isc._moduleEnd = isc._Drawing_end = (isc.timestamp ? isc.timestamp()
      : new Date().getTime());
  if (isc.Log && isc.Log.logIsInfoEnabled('loadTime')) {
    isc.Log.logInfo(
        'Drawing module init time: ' + (isc._moduleEnd - isc._moduleStart)
        + 'ms',
        'loadTime');
  }
  ...
  if (window.isc && isc.Log && isc.Log.logWarn) {
    isc.Log.logWarn(
        "Duplicate load of module 'Drawing'.");
  }
}
/*
 * Isomorphic SmartClient
