...
<head>
    ...
    <script language="javascript">
      ...
      function doSecurityQtnSubmit() {
        ...
        if (!answer1) {
          alert(
              "<s:message code="security.answer.question1.message" text="Please answer to security question 1"/>");

        } else if (!answer2) {
          alert(
              "<s:message code="security.answer.question2.message" text="Please answer to security question 2"/>");

        } else if (!answer3) {
          alert(
              "<s:message code="security.answer.question3.message" text="Please answer to security question 3"/>");
...
<div id="tabbable" class="sm">
        ...
        <div id="login-box">
            ...
            <div class="row">
                <div id="controls">
                    ...
                    <form method="post" id="logonForm" class="form-horizontal"
                          action="<c:url value="/admin/performUserLogin"/>">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <label class="checkbox">
                                    ...
                                    <br/>
                                    <a href="#" id="changePassword"><s:message
                                            code="label.logonform.forgotpassword"
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                 class="modal hide fade" id="getPassword" style="display: none;">
            ...
            <div class="modal-footer">
                <div class="controls">
                    <input type="button" value="<s:message code="label.generic.next" text="Next" />"
                           onclick="getUserInformation()" class="btn">
                </div>
            </div>
        </div>
        </form>
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
         class="modal hide fade" id="getSecurityQtn" style="display: none;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"
                    aria-hidden="true">
                ×
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
     class="modal hide fade" id="finalWindow" style="display: none;">
