...
<div class="sm">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span4"><a class="brand" href="#"><img
                    src="<c:url value="/resources/img/shopizer_small.jpg" />"/></a></div>
                        ...
                        <ul class="nav pull-right" style="z-index:500000;position:relative">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<c:url value="/admin/users/displayUser.html" />"><s:message
                                                code="label.my.profile" text="My profile"/></a></li>
                                    <li class="divider"></li>
                                    <li>
                                        <c:url value="/admin/logout" var="logoutUrl"/>
                                        <a href="${logoutUrl}"><s:message code="button.label.logout"
                                                                          text="Logout"/></a>
                                    </li>
                                </ul>
                        ...
                        <c:if test="${fn:length(requestScope.ADMIN_STORE.languages)>1}">
                            <ul class="nav pull-right" style="z-index:500000;position:relative">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <c:forEach items="${requestScope.ADMIN_STORE.languages}"
                                                   var="lang">
                                            <li>
                                                <a href="<c:url value="/admin?locale=${lang.code}" />"><s:message
                                                        code="${lang.code}"
                                                        text="${lang.code}"/></a></li>
                                        </c:forEach>
                                    </ul>
    ...
    <div class="container">
        ...
        <footer>
            <p>&copy; Shopizer 2010-<%=Calendar.getInstance().get(Calendar.YEAR)%>
            </p>
        </footer>
