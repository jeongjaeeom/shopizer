...
public class ServiceRequestCriteriaBuilderUtils {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(ServiceRequestCriteriaBuilderUtils.class);
   ...
   * @throws Exception
   */
  public static Criteria buildRequestCriterias(Criteria criteria, Map<String, String> mappingFields,
  ...
  private static void setValue(Criteria criteria, HttpServletRequest request, String parameterName,
      String setterValue) throws Exception {
    ...
    try {
      ...
      System.out.println(
          "Trying to do this binding " + setterName + "('" + parameterValue + "') on " + criteria
              .getClass());
   ...
   * deprecated
   **/
  public static Criteria buildRequest(Map<String, String> mappingFields,
