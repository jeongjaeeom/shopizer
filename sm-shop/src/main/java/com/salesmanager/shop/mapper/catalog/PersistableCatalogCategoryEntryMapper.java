...
@Component
public class PersistableCatalogCategoryEntryMapper implements
  ...
  @Override
  public CatalogCategoryEntry convert(PersistableCatalogCategoryEntry source, MerchantStore store,
      Language language) {
  ...
  @Override
  public CatalogCategoryEntry merge(PersistableCatalogCategoryEntry source,
      CatalogCategoryEntry destination, MerchantStore store,
      Language language) {
...
/*			Product productModel = productFacade.getProduct(source.getProductCode(), store);
      ...
      if (categoryModel == null) {
        throw new ConversionRuntimeException(
            "Error while converting CatalogEntry category [" + source.getCategoryCode()
                + "] not found");
      }
