...
@Component
public class ReadableProductOptionValueMapper implements
    Mapper<ProductOptionValue, ReadableProductOptionValueEntity> {
  ...
  @Override
  public ReadableProductOptionValueEntity merge(ProductOptionValue source,
    ...
    if (language == null) {
      ...
      for (ProductOptionValueDescription desc : source.getDescriptions()) {
        com.salesmanager.shop.model.catalog.product.attribute.ProductOptionValueDescription d = this
            .description(desc);
        descriptions.add(d);
      }
  ...
  @Override
  public ReadableProductOptionValueEntity convert(ProductOptionValue source, MerchantStore store,
      Language language) {
