...
@Component
public class ReadableProductVariationMapper implements
    Mapper<ProductVariation, ReadableProductVariation> {


  @Override
  public ReadableProductVariation convert(ProductVariation source, MerchantStore store,
      Language language) {
  ...
  @Override
  public ReadableProductVariation merge(ProductVariation source,
  ...
  private ReadableProductOptionValue optionValue(ProductOptionValue val, MerchantStore store,
      Language language) {
