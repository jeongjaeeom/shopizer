...
public class CredentialsServiceImpl implements CredentialsService {
  ...
  @Override
  public void validateCredentials(String password, String repeatPassword, MerchantStore store,
      Language language)
    ...
    if (!result.isValid()) {
      throw new CredentialsException(
          "Password validation failed [" + passwordValidator.getMessages(result) + "]");
    }

  }

  @Override
  public String generatePassword(MerchantStore store, Language language)
      throws CredentialsException {
