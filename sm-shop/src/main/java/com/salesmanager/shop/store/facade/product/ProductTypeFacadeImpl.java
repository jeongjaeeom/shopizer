...
public class ProductTypeFacadeImpl implements ProductTypeFacade {
  ...
  @Override
  public ReadableProductTypeList getByMerchant(MerchantStore store, Language language, int count,
      int page) {
  ...
  public ReadableProductType get(MerchantStore store, Long id, Language language) {
    ...
    try {
      ...
      throw new ServiceRuntimeException(
          "An exception occured while getting product type [" + id + "] not found for store ["
              + store.getCode() + "]", e);
    }
  ...
  public boolean exists(String code, MerchantStore store, Language language) {
    ...
    try {
      ...
      throw new RuntimeException(
          "An exception occured while getting product type [" + code + "] for merchant store ["
              + store.getCode() + "]", e);
    }
    if (t != null) {
      return true;
