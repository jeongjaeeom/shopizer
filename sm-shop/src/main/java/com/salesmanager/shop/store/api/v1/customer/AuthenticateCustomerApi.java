...
public class AuthenticateCustomerApi {
   ...
   */
  @RequestMapping(value = {"/customer/register"}, method = RequestMethod.POST, produces = {
      "application/json"})
   ...
   */
  @RequestMapping(value = "/customer/login", method = RequestMethod.POST, produces = {
      "application/json"})
  ...
  @RequestMapping(value = "/auth/customer/refresh", method = RequestMethod.GET, produces = {
      "application/json"})
  ...
  @RequestMapping(value = "/customer/password/reset", method = RequestMethod.PUT, produces = {
      "application/json"})
  ...
  @RequestMapping(value = "/auth/customer/password", method = RequestMethod.POST, produces = {
      "application/json"})
  ...
  public ResponseEntity<?> changePassword(@RequestBody @Valid PasswordRequest passwordRequest,
    ...
    try {
      ...
      Customer customer = customerFacade
          .getCustomerByUserName(passwordRequest.getUsername(), merchantStore);
