...
public class ProductOptionFacadeImpl implements ProductOptionFacade {
  ...
  @Override
  public ReadableProductOptionEntity saveOption(PersistableProductOptionEntity option,
      MerchantStore store,
      Language language) {
  ...
  public void deleteOption(Long optionId, MerchantStore store) {
    ...
    try {
      ...
      throw new ServiceRuntimeException(
          "An exception occured while deleting ProductOption [" + optionId + "]",
          e);
    }
  }
  ...
  @Override
  public ReadableProductOptionValueList optionValues(MerchantStore store, Language language,
      String name, int page,
      int count) {
    Validate.notNull(store, "MerchantStore should not be null");

    Page<ProductOptionValue> options = productOptionValueService
        .getByMerchant(store, null, name, page, count);
  ...
  @Override
  public ReadableProductOptionList options(MerchantStore store, Language language, String name,
      int page, int count) {
    Validate.notNull(store, "MerchantStore should not be null");

    Page<ProductOption> options = productOptionService
        .getByMerchant(store, null, name, page, count);
  ...
  @Override
  public ReadableProductOptionEntity getOption(Long optionId, MerchantStore store,
      Language language) {
  ...
  public ReadableProductOptionValueEntity saveOptionValue(
      PersistableProductOptionValueEntity optionValue,
    ...
    readableProductOptionValue = readableOptionValueMapper
        .merge(optValue, readableProductOptionValue, store,
            language);
  ...
  @Override
  public ReadableProductOptionValueEntity getOptionValue(Long optionValueId, MerchantStore store,
      Language language) {
  ...
  @Override
  public ReadableProductAttributeEntity saveAttribute(Long productId,
    ...
    ReadableProductAttributeEntity readable = readableProductAttributeMapper
  ...
  @Override
  public ReadableProductAttributeEntity getAttribute(Long productId, Long attributeId,
      MerchantStore store,
      Language language) {
    ...
    if (attr.getProduct().getMerchantStore().getId().intValue() != store.getId().intValue()) {
      throw new ResourceNotFoundException(
          "ProductAttribute not found for [" + attributeId + "] and product ["
  ...
  @Override
  public ReadableProductAttributeList getAttributesList(Long productId, MerchantStore store,
      Language language) {
    ...
    try {
      ...
      List<ProductAttribute> attributes = productAttributeService
          .getByProductId(store, product, language);
  ...
  public void removeOptionValueImage(Long optionValueId, MerchantStore store,
    ...
    try {
      ...
      contentService.removeFile(store.getCode(), FileContentType.PROPERTY,
          value.getProductOptionValueImage());
