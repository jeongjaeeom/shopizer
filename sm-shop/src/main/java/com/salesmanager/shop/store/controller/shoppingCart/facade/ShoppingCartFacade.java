...
public interface ShoppingCartFacade {
  ...
  ShoppingCartData updateCartItems(Optional<String> promoCode,
   ...
   * @throws Exception
   */
  ReadableShoppingCart modifyCart(String cartCode, PersistableShoppingCartItem item,
      MerchantStore store,
   ...
   * @throws Exception
   */
  ReadableShoppingCart modifyCartMulti(String cartCode, List<PersistableShoppingCartItem> items,
      MerchantStore store,
      Language language) throws Exception;
