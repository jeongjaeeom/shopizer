...
public class ShoppingCategoryController {
  ...
  private List<ReadableManufacturer> getManufacturersByProductAndCategory(MerchantStore store,
      Category category, List<Category> categories, Language language) throws Exception {
   ...
   * @throws Exception
   */
  private Map<Long, Long> getProductsByCategory(MerchantStore store, List<Category> categories)
      throws Exception {
    ...
    List<Object[]> countProductsByCategories = categoryService
        .countProductsByCategories(store, ids);
