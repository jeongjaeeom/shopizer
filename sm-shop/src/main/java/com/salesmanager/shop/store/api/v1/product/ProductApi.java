...
@RequestMapping("/api")
@Api(tags = {
    "Product display and management resource (Product display and Management Api. Serves api v1 and v2 with backward compatibility)"})
...
public class ProductApi {
  ...
  @RequestMapping(value = {"/v1/private/product/{id}",
      "/auth/product/{id}"}, method = RequestMethod.PUT)
  @ApiImplicitParams({
      @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
      @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @RequestMapping(value = {"/v1/private/product/{id}",
      "/auth/product/{id}"}, method = RequestMethod.DELETE)
  @ApiImplicitParams({
      @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
      @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")})
  ...
  @ApiOperation(httpMethod = "GET", value = "Get a product by friendlyUrl (slug)", notes =
  ...
  ReadableProduct addProductToCategory(@PathVariable Long productId,
      @PathVariable Long categoryId, @ApiIgnore MerchantStore merchantStore,
      @ApiIgnore Language language,
      HttpServletResponse response) throws Exception {
