...
public class CategoryApi {
  ...
  public ReadableCategory getByfriendlyUrl(
    ...
    ReadableCategory category = categoryFacade
        .getCategoryByFriendlyUrl(merchantStore, friendlyUrl, language);
    return category;
  }
  ...
  public ReadableCategoryList list(
    ...
    return categoryFacade
        .getCategoryHierarchy(merchantStore, criteria, DEFAULT_CATEGORY_DEPTH, language, filter,
            page, count);
  }
  ...
  public PersistableCategory create(
    ...
    userFacade.authorizedGroup(authenticatedUser, Stream
