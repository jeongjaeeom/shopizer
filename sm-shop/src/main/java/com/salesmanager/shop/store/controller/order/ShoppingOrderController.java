          ...
          for (ShippingOption shipOption : options) {
            ...
            if (!StringUtils.isBlank(shipOption.getOptionCode())) {
              ...
              try {
                ...
                LOGGER
                    .warn("commitOrder No shipping code found for " + optionCodeBuilder.toString());
              }
            }
...
/*		if(configs!=null && configs.containsKey(Constants.DEBUG_MODE)) {
    ...
    try {
      ...
      Set<com.salesmanager.core.model.shoppingcart.ShoppingCartItem> cartItems = cart
          .getLineItems();
            ...
            for (ShippingOption shipOption : options) {
              ...
              if (!StringUtils.isBlank(shipOption.getOptionCode())) {
                ...
                try {
                  ...
                  LOGGER.warn("calculateShipping No shipping code found for " + optionCodeBuilder
                      .toString());
                }
              }
          ...
          for (ShippingOption shipOption : options) {
            ...
            if (!StringUtils.isBlank(shipOption.getOptionCode())) {
              ...
              try {
                ...
                LOGGER.warn("calculateOrderTotal No shipping code found for " + optionCodeBuilder
                    .toString());
              }
            }
          }
