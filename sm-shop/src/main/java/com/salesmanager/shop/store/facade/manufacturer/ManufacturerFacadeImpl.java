...
public class ManufacturerFacadeImpl implements ManufacturerFacade {
  ...
  public List<ReadableManufacturer> getByProductInCategory(MerchantStore store, Language language,
    ...
    try {
      List<Manufacturer> manufacturers = manufacturerService
          .listByProductsInCategory(store, category, language);
  ...
  @Override
  public ReadableManufacturerList getAllManufacturers(MerchantStore store, Language language,
  ...
  @Override
  public ReadableManufacturerList listByStore(MerchantStore store, Language language,
      ListCriteria criteria, int page,
      int count) {
