...
public interface OrderFacade {
  ...
  ShippingQuote getShippingQuote(Customer customer, ShoppingCart cart,
      com.salesmanager.shop.model.order.v0.PersistableOrder order,
      MerchantStore store, Language language) throws Exception;
   ...
   * @throws Exception
   */
  com.salesmanager.shop.model.order.v0.ReadableOrder getReadableOrder(Long orderId,
  ...
  com.salesmanager.shop.model.order.v0.ReadableOrderList getReadableOrderList(MerchantStore store,
      Customer customer, int start,
  ...
  com.salesmanager.shop.model.order.v0.ReadableOrderList getReadableOrderList(
   ...
   * @throws Exception
   */
  com.salesmanager.shop.model.order.v0.ReadableOrderList getCapturableOrderList(MerchantStore store,
  ...
  /**
   * Updates order customer Only updates customer information from the order It won't update
   * customer object from Customer entity
   *
   * @param orderId
   * @param customer
   * @param store
