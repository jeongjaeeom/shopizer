...
public class ShoppingCartFacadeImpl implements ShoppingCartFacade {
  ...
  @Override
  public ReadableShoppingCart get(Optional<String> cart, Long customerId, MerchantStore store,
      Language language) {
    ...
    try {
      ...
      ReadableShoppingCart readableCart = shoppingCartFacade
          .readableCart(cartModel, store, language);
