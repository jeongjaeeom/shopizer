...
public class CategoryManagementAPIIntegrationTest extends ServicesTestSupport {
  ...
  public void getCategory() throws Exception {
    ...
    final ResponseEntity<ReadableCategoryList> response = testRestTemplate
        .exchange(String.format("/api/v1/category/"), HttpMethod.GET,
  ...
  public void postCategory() throws Exception {
    ...
    ResponseEntity response = testRestTemplate
        .postForEntity("/api/v1/private/category", entity, PersistableCategory.class);
  ...
  public void putCategory() throws Exception {
    ...
    //create category
    final ResponseEntity response = testRestTemplate
        .postForEntity("/api/v1/private/category", entity, PersistableCategory.class);
    ...
    final ResponseEntity<ReadableCategory> readableQuery = testRestTemplate
        .exchange(String.format("/api/v1/category/" + cat.getId()), HttpMethod.GET,
    ...
    ResponseEntity resp = testRestTemplate
        .exchange("/api/v1/private/category/" + cat.getId(), HttpMethod.PUT, requestUpdate,
            Void.class);
  ...
  public void postComplexCategory() throws Exception {
    ...
    final int sizeBefore = testRestTemplate
        .exchange(String.format("/api/v1/category"), HttpMethod.GET,
            new HttpEntity<>(getHeader()), ReadableCategoryList.class).getBody().getCategories()
        .size();
  ...
  public void deleteCategory() throws Exception {
    ...
    testRestTemplate
        .exchange("/services/DEFAULT/category/100", HttpMethod.DELETE, httpEntity, Category.class);
  }
  ...
  public void manufacturerForItemsInCategory() throws Exception {
    ...
    ResponseEntity response = testRestTemplate
        .postForEntity("/api/v1/private/manufacturer", entity, PersistableManufacturer.class);
    assertThat(response.getStatusCode(), is(CREATED));
    ...
    @SuppressWarnings("rawtypes")
    ResponseEntity categoryResponse = testRestTemplate
        .postForEntity("/api/v1/private/category", entity, PersistableCategory.class);
    ...
    @SuppressWarnings("rawtypes")
    ResponseEntity<List> manufacturers = testRestTemplate
        .exchange(String.format("/api/v1/category/" + id + "/manufacturers"), HttpMethod.GET,
            entity, List.class);
