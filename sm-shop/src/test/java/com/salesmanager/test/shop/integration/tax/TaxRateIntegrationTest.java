...
public class TaxRateIntegrationTest extends ServicesTestSupport {
  ...
  public void manageTaxClass() throws Exception {
    ...
    final ResponseEntity<Entity> response = testRestTemplate
        .postForEntity(String.format("/api/v1/private/tax/class/"), taxClassEntity, Entity.class);
    ...
    //tax class exists
    final ResponseEntity<EntityExists> exists = testRestTemplate
        .exchange(String.format("/api/v1/private/tax/class/unique?code=" + taxClass.getCode()),
            HttpMethod.GET,
    ...
    /**
     //list 1 taxClass
     @SuppressWarnings("rawtypes") final ResponseEntity<ReadableEntityList> listOfTaxClasses = testRestTemplate.exchange(String.format("/private/tax/class"), HttpMethod.GET,
  ...
  public void manageTaxRates() throws Exception {
    ...
    final ResponseEntity<Entity> response = testRestTemplate
        .postForEntity(String.format("/api/v1/private/tax/rate/"), taxClassEntity, Entity.class);
    ...
    //tax class exists
    final ResponseEntity<EntityExists> exists = testRestTemplate
        .exchange(String.format("/api/v1/private/tax/rate/unique?code=" + taxRate.getCode()),
            HttpMethod.GET,
            httpEntity, EntityExists.class);
