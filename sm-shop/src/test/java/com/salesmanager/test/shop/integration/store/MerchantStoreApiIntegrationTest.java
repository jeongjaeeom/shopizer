...
public class MerchantStoreApiIntegrationTest extends ServicesTestSupport {
  ...
  public void testGetDefaultStore() throws Exception {
    ...
    final ResponseEntity<ReadableMerchantStore> response = testRestTemplate
        .exchange(String.format("/api/v1/store/" + MerchantStore.DEFAULT_STORE), HttpMethod.GET,
  ...
  public void testCreateStore() throws Exception {
    ...
    final HttpEntity<PersistableMerchantStore> httpEntity = new HttpEntity<PersistableMerchantStore>(
        createdStore, getHeader());

    ResponseEntity<Void> response = testRestTemplate
        .exchange(String.format("/api/v1/private/store/"), HttpMethod.POST, httpEntity, Void.class);
  ...
  public void testAddAndDeleteStoreLogo() {
    ...
    ResponseEntity<Void> createResponse = testRestTemplate.exchange(
        String.format("/api/v1/private/store/" + MerchantStore.DEFAULT_STORE + "/marketing/logo"),
