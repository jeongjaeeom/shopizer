...
public class ProductRepositoryImpl implements ProductRepositoryCustom {
  ...
  public ProductList listByStore(MerchantStore store, Language language, ProductCriteria criteria) {
    ...
    if (CollectionUtils.isNotEmpty(criteria.getAttributeCriteria()) || CollectionUtils
        .isNotEmpty(criteria.getOptionValueIds())) {
      ...
      if (CollectionUtils.isNotEmpty(criteria.getAttributeCriteria())) {
        ...
        for (AttributeCriteria attributeCriteria : criteria.getAttributeCriteria()) {
          if (count == 0) {
            countBuilderWhere.append(" and po.code =:")
    ...
    Query countQ = this.em
        .createQuery(countBuilderSelect.toString() + countBuilderWhere.toString());
