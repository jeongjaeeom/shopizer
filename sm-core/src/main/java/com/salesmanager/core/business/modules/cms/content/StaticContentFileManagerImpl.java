...
public class StaticContentFileManagerImpl extends StaticContentFileManager {
  ...
  public void addFile(final String merchantStoreCode, Optional<String> path,
      final InputContentFile inputContentFile)
  ...
  @Override
  public OutputContentFile getFile(String merchantStoreCode, Optional<String> path,
  ...
  @Override
  public List<String> getFileNames(String merchantStoreCode, Optional<String> path,
  ...
  @Override
  public List<OutputContentFile> getFiles(String merchantStoreCode, Optional<String> path,
      FileContentType fileContentType)
      throws ServiceException {
