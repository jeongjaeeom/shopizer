...
public class CmsStaticContentFileManagerImpl
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(CmsStaticContentFileManagerImpl.class);
   ...
   */
  @Override
  public void addFile(final String merchantStoreCode, Optional<String> path,
      final InputContentFile inputStaticContentData)
      throws ServiceException {
    ...
    try {
      ...
      String nodePath = this
          .getNodePath(merchantStoreCode, inputStaticContentData.getFileContentType());
   ...
   */
  @Override
  public void addFiles(final String merchantStoreCode, Optional<String> path,
   ...
   */
  @Override
  public OutputContentFile getFile(final String merchantStoreCode, Optional<String> path,
  ...
  @Override
  public List<OutputContentFile> getFiles(final String merchantStoreCode, Optional<String> path,
  ...
  @Override
  public void removeFiles(final String merchantStoreCode, Optional<String> path)
      throws ServiceException {
...
/*		StringBuilder nodePath = new StringBuilder();
   ...
   */
  @Override
  public List<String> getFileNames(final String merchantStoreCode, Optional<String> path,
      final FileContentType staticContentType)
      throws ServiceException {
  ...
  @SuppressWarnings("unchecked")
  @Override
  public void addFolder(String merchantStoreCode, String folderName, Optional<String> path)
      throws ServiceException {
  ...
  @Override
  public void removeFolder(String merchantStoreCode, String folderName, Optional<String> path)
      throws ServiceException {
