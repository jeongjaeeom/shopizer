 ...
 * <p>
 * <p>
 * Linux/ Mac export GOOGLE_APPLICATION_CREDENTIALS="/path/to/file" For Windows set
...
public class GCPStaticContentAssetsManagerImpl implements ContentAssetsManager {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(GCPStaticContentAssetsManagerImpl.class);
  ...
  public OutputContentFile getFile(String merchantStoreCode, Optional<String> folderPath,
    ...
    try {
      ...
      Blob blob = storage
          .get(BlobId.of(bucketName, nodePath(merchantStoreCode, fileContentType) + contentName));
  ...
  public List<String> getFileNames(String merchantStoreCode, Optional<String> folderPath,
    ...
    try {
      ...
      Bucket bucket = storage
          .get(bucketName, BucketGetOption.metagenerationMatch(bucketMetaGeneration));
      Page<Blob> blobs = bucket
          .list(Storage.BlobListOption.prefix(nodePath(merchantStoreCode, fileContentType)),
  ...
  @Override
  public void addFile(String merchantStoreCode, Optional<String> folderPath,
      InputContentFile inputStaticContentData) throws ServiceException {
    ...
    try {
      ...
      BlobInfo blobInfo = BlobInfo.newBuilder(blobId)
          .setContentType(inputStaticContentData.getFileContentType().name())
          .build();
  ...
  public void removeFile(String merchantStoreCode, FileContentType staticContentType,
      String fileName, Optional<String> folderPath)
      throws ServiceException {
    try {
      String bucketName = bucketName();
      Storage storage = StorageOptions.getDefaultInstance().getService();
  ...
  @Override
  public List<String> listFolders(String merchantStoreCode, Optional<String> folderPath)
      throws ServiceException {
    // TODO Auto-generated method stub
    return null;
  }
