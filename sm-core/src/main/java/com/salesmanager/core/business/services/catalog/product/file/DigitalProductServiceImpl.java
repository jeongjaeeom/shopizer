...
public class DigitalProductServiceImpl extends SalesManagerEntityServiceImpl<Long, DigitalProduct>
  ...
  public void addProductFile(Product product, DigitalProduct digitalProduct,
    ...
    try {
      ...
      productDownloadsFileManager
          .addFile(product.getMerchantStore().getCode(), Optional.of(path), inputFile);
  ...
  public void delete(DigitalProduct digitalProduct) throws ServiceException {
    ...
    productDownloadsFileManager.removeFile(digitalProduct.getProduct().getMerchantStore().getCode(),
        FileContentType.PRODUCT, digitalProduct.getProductFileName(), Optional.of(path));
