 ...
 * <p>
 * Geocoding Distance Matrix Directions
 * <p>
 * Create new key for server application Copy API key https://console.developers.google.com
 * <p>
...
public class ShippingDistancePreProcessorImpl implements ShippingQuotePrePostProcessModule {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(ShippingDistancePreProcessorImpl.class);
