...
public class ProductImageCropUtils {
  ...
  private void determineCropArea(int width, int specificationsWidth,
    ...
    double factorWidth =
        Integer.valueOf(width).doubleValue() / Integer.valueOf(specificationsWidth).doubleValue();
    double factorHeight =
        Integer.valueOf(height).doubleValue() / Integer.valueOf(specificationsHeight).doubleValue();
