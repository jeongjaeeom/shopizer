...
public class MerchantStoreServiceImpl extends SalesManagerEntityServiceImpl<Integer, MerchantStore>
  ...
  public MerchantStore getParent(String code) throws ServiceException {
    ...
    if (storeModel.isRetailer() != null && storeModel.isRetailer()
   ...
   * <p>
   * This method from a store code is able to retrieve parent and childs. Method can also filter on
   * storeName
   */
  @Override
  public Page<MerchantStore> listByGroup(Optional<String> storeName, String code, int page,
