...
public interface PageableCatalogEntryRepository extends
    PagingAndSortingRepository<CatalogCategoryEntry, Long> {
  ...
  Page<CatalogCategoryEntry> listByCatalog(Long catalogId, Integer storeId, Integer languageId,
