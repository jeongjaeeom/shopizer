...
public class CategoryServiceImpl extends SalesManagerEntityServiceImpl<Long, Category> implements
  ...
  public void delete(Category category) throws ServiceException {
    ...
    List<Category> categories = this
        .getListByLineage(category.getMerchantStore(), lineage.toString());
  ...
  public void addChild(Category parent, Category child) throws ServiceException {
    ...
    try {
      ...
      if (parent == null) {
        ...
        child.setLineage(
            new StringBuilder().append(lineage).append(Constants.SLASH).append(child.getId())
      ...
      List<Category> subCategories = getListByLineage(child.getMerchantStore(),
  ...
  public Page<Category> getListByDepth(MerchantStore store, Language language, String name,
    ...
    return pageableCategoryRepository
        .listByStore(store.getId(), language.getId(), name, pageRequest);
  }
