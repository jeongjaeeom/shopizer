 ...
 * cart processing
 * <p>
 * 2 types of processors - functions processors Triggered during defined simple events - ex add to
 * cart checkout
 * <p>
 * - calculation processors Triggered during shopping cart and order total calculation
 *
 * @author carlsamson
 */
@Configuration
